...
// Adjust q_4_4_d9 in distractorsPart2 to match the exact keys from scratch_questions
// Wait, the question on line 234 is q_4_4_s9 (not d9 or s9). Wait, line 234 in scratch_questions.txt is:
// q_4_4_s9|What term describes the psychological reluctance of the US public and politicians to intervene militarily abroad after Vietnam?|Vietnam Syndrome
// Ah, let's see. In my distractorsPart2, I used q_4_4_d9. Let's fix that key to q_4_4_s9.
distractorsPart2["q_4_4_s9"] = [
  "Vietnam Reluctance",
  "Isolationist Complex",
  "Pentagon Hesitation"
];
delete distractorsPart2["q_4_4_d9"];

fs.writeFileSync(path.join(__dirname, 'scratch_distractors_part2.json'), JSON.stringify(distractorsPart2, null, 2), 'utf8');
console.log("Successfully wrote scratch_distractors_part2.json");
