...
const dataContent = fs.readFileSync(path.join('C:/Projects/meoncross-history.netlify.app/public/units/cme_new/data.js'), 'utf8');
...
const dataParserSrc = fs.readFileSync(path.join('C:/Projects/meoncross-history.netlify.app/src/data_parser.js'), 'utf8');
const dataParserCode = dataParserSrc.replace(/export /g, '');
eval(dataParserCode);

const examGuideSrc = fs.readFileSync(path.join('C:/Projects/meoncross-history.netlify.app/src/exam_guide_content.js'), 'utf8');
...
const periods = [
  { name: 'KT1', title: 'Key Topic 1: The establishment of the state of Israel', filter: l => l.title.startsWith('KT1') },
  { name: 'KT2', title: 'Key Topic 2: The crisis in the Middle East, 1967-1973', filter: l => l.title.startsWith('KT2') },
  { name: 'KT3', title: 'Key Topic 3: The search for peace, 1973-1995', filter: l => l.title.startsWith('KT3') }
];
...
<head>
  <meta charset="UTF-8">
  <title>Conflict in the Middle East - Printable Workbook</title>
...
html += `</body></html>`;
fs.writeFileSync(path.join('C:/Projects/meoncross-history.netlify.app/public/units/cme_new', `workbook_${periodName}.html`), html);
