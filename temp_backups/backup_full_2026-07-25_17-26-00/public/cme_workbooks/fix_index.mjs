...
// 1. Remove duplicate Collector's Binder from Key Individuals
const duplicateBinderRegex = /<!-- GARBAGE PAIL KIDS COLLECTOR'S BINDER -->[\s\S]*?<div id="gpk-binder-grid" class="card-binder-grid">\s*<!-- Dynamically populated locked\/unlocked cards -->\s*<\/div>\s*<\/div>/;
html = html.replace(duplicateBinderRegex, '');

// 2. Restore original Fareham chimney
