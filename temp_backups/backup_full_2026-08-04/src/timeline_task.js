  ...
  container.innerHTML = `
    <div style="max-width: 1100px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); border: 2px solid #3b82f6;">
      <div style="text-align: center; margin-bottom: 25px;">
        <h1 style="font-family: 'Playfair Display', serif; font-size: 2rem; color: #1e3a8a; margin-top: 0; margin-bottom: 5px;"><i class="fa-solid fa-hourglass-half"></i> Domino Flowcharts</h1>
        <p style="font-size: 0.95rem; margin-bottom: 5px; color: #475569;">Select a topic and drag the events into the correct chronological sequence to build your flowchart!</p>
      </div>

      <div style="margin-bottom: 15px; background: #f8fafc; padding: 10px; border-radius: 12px; border: 1px solid #e2e8f0; display: flex; align-items: flex-end; gap: 10px; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 250px;">
          <label style="display: block; font-weight: 700; margin-bottom: 5px; color: #334155; font-size: 0.95rem;"><i class="fa-solid fa-list-ul"></i> Select Timeline:</label>
          <select id="timeline-select" class="epz-select" style="width: 100%; padding: 8px; border-radius: 6px; border: 1px solid #cbd5e1; font-size: 0.95rem; background: #ffffff; color: #1e293b; cursor: pointer;">
        ...
        <button id="btn-focus" class="main-btn" style="background: #1e3a8a; color: white; padding: 8px 15px; height: 38px; border-radius: 6px; font-weight: 500; font-size: 0.95rem; display: flex; align-items: center; gap: 8px; border: none; cursor: pointer; white-space: nowrap;">
          <i class="fa-solid fa-expand"></i> Focus Mode
        </button>
      </div>

      <div id="timeline-container" style="display: flex; flex-direction: column; align-items: center; gap: 0; margin-bottom: 15px; padding: 5px 0;">
      ...
      <div style="text-align: center; display: flex; flex-direction: column; align-items: center; gap: 20px;">
        ...
        <div style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center;">
          <button id="btn-check" class="main-btn epz-btn" style="background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 10px 20px; font-size: 1rem; border: none; border-radius: 6px; font-weight: 600;"><i class="fa-solid fa-check-double"></i> Check Sequence</button>
          <button id="btn-reset" class="main-btn epz-btn" style="background: #f1f5f9; color: #475569; padding: 10px 20px; font-size: 1rem; border: 1px solid #cbd5e1; border-radius: 6px; font-weight: 600;"><i class="fa-solid fa-arrow-rotate-left"></i> Reset Shuffled</button>
        </div>
      </div>
    </div>
  `;
  ...
  function renderItems() {
    ...
    activeItems.forEach((item, index) => {
      ...
      el.innerHTML = `
        ...
        <div style="padding: 8px 12px; flex: 1; line-height: 1.3;">${item.text}</div>
      `;
