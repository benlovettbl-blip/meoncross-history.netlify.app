...
if (!quizData || !Array.isArray(quizData)) {
  console.error("Error: Could not load quizData array from data.js");
  process.exit(1);
}
...
async function run() {
  ...
  if (quizDataStartIdx === -1 || examDataStartIdx === -1) {
    console.error("Error: Could not locate quizData or examData indices in data.js. Aborting write to prevent data loss.");
  } else {
