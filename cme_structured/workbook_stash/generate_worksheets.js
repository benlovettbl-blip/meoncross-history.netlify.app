...
async function generateWorksheets() {
  ...
  // Node.js dynamic imports resolve relative to the script file (__dirname).
  // Copy JS chunks to __dirname so import('./chunk.js') works.
  for (const f of jsFiles) {
    fs.copyFileSync(path.join(assetsDir, f), path.join(__dirname, f));
  }
