...
<body>
        ...
        <div style="padding: 6px 10px 10px 10px; display: flex; flex-direction: column; justify-content: space-between; flex: 1;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 10px; font-family: 'Inter', sans-serif; font-size: 7.3pt; line-height: 1.34; color: #111;">
            ...
            <div style="border-right: 1.2px solid #cbd5e1; padding-right: 8px;">
              ...
              <div style="margin-bottom: 2.5px;">&bull; <strong>Oil crisis fallout:</strong> Western stagflation forces US intervention in Middle East diplomacy.</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>Kissinger's shuttle diplomacy:</strong> Sinai I (1974), Syrian disengagement &amp; Sinai II (1975).</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>Reopening of Suez Canal (1975)</strong> &amp; election of Likud's <strong>Menachem Begin</strong> (1977).</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>Sadat's Jerusalem visit (Nov 1977):</strong> Address to Israeli Knesset breaking psychological barrier.</div>
            ...
            <div style="border-right: 1.2px solid #cbd5e1; padding-right: 8px;">
              ...
              <div style="margin-bottom: 2.5px;">&bull; <strong>PLO international recognition:</strong> Rabat Summit &amp; Arafat's 1974 UN address ('olive branch').</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>Operation Peace for Galilee (1982):</strong> Israeli invasion of Lebanon; Siege of Beirut.</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>Sabra and Shatila massacres (Sep 1982):</strong> Phalangist militias &amp; Kahan Commission report.</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>First Intifada (1987–93):</strong> Civil disobedience in Gaza &amp; West Bank vs IDF 'Iron Fist'.</div>
            ...
            <div>
              ...
              <div style="margin-bottom: 2.5px;">&bull; <strong>Arafat's diplomatic pivot (1988):</strong> Renounces terrorism &amp; recognises Israel in Geneva.</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>Fall of Soviet Union</strong> &amp; Gulf War (1991): <strong>Madrid Peace Conference</strong>.</div>
              <div style="margin-bottom: 2.5px;">&bull; <strong>Oslo I Accords (1993):</strong> Secret Norwegian channel; historic White House handshake.</div>
  ...
  <div class="textbook-page">
    ...
    <div class="two-column-prose">
      ...
      <!-- Archival Dispatch: President Reagan's Beirut Ultimatum -->
      <div class="archival-source-box">
        <div class="archival-header">
          <div class="source-identity">
            <span class="source-badge">ARCHIVAL DISPATCH</span>
            <span class="source-type">White House Telephone Record</span>
          </div>
          <span class="source-date-micro">12 August 1982</span>
        </div>
        <div class="archival-title">President Ronald Reagan's Ultimatum to PM Menachem Begin</div>
        <div class="archival-body">
          "Menachem, this has got to stop! The symbol of this war is becoming a picture of a seven-month-old baby with its arms blown off. This endless barrage is destroying any chance of peace and destroying Israel's standing in America."
        </div>
        <div class="archival-footer">
          <span>White House Situation Room Declassified Memorandum</span>
          <span>Washington, 12 Aug 1982</span>
        </div>
      </div>
    </div>
  ...
  <div class="textbook-page">
    ...
    <div class="two-column-prose">
      ...
      <div class="section-banner">
        <span class="section-title">The Soviet Collapse, Gulf War &amp; The 1991 Madrid Conference</span>
      </div>
      <div class="numbered-para">
        <span class="para-ref-pill">[4.7]</span>
        Between 1989 and 1991, the global Cold War framework collapsed. The fall of the Berlin Wall and the dissolution of the <strong>Soviet Union</strong> deprived radical Arab states (Syria, Iraq) of their superpower patron, military subsidies, and modern weapons shipments. Simultaneously, over 400,000 Soviet Jews emigrated to Israel between 1989 and 1992, providing a massive demographic influx of engineers, scientists, and military reservists that dramatically bolstered Israel's economic vitality and national security posture.
      </div>
      <div class="numbered-para">
        <span class="para-ref-pill">[4.8]</span>
        In the 1991 Gulf War, a 34-nation US-led coalition crushed Saddam Hussein's Iraqi forces after Iraq fired 39 Scud missiles into Tel Aviv and Haifa in a failed attempt to fracture the coalition. Because Arafat made the disastrous strategic blunder of openly cheering Saddam's invasion of Kuwait, wealthy Gulf monarchies expelled 300,000 Palestinian expatriates and severed all financial subsidies to the PLO, leaving it diplomatically isolated and on the verge of bankruptcy. Exploiting this moment of undisputed American hegemony, US President George H.W. Bush and Secretary of State James Baker convened the <strong>Madrid Peace Conference (October 1991)</strong>, forcing Israeli Prime Minister Yitzhak Shamir and Arab delegations into direct face-to-face negotiations for the first time.
      </div>
      <div class="numbered-para">
      ...
      <!-- Concept Spotlight: The Madrid Formula & Bilateral Diplomacy -->
      <div class="concept-spotlight-box compact">
        <div class="csb-header">
          <span class="csb-tag">DIPLOMATIC CATALYST</span>
          <span class="csb-category">THE MADRID FORMULA &bull; OCT 1991</span>
        </div>
        <h4 class="csb-title">The Madrid Conference: Direct Talks Under Superpower Sponsorship</h4>
        <div class="csb-body">
          Convened by US President George H.W. Bush and Soviet President Mikhail Gorbachev, the 1991 Madrid Conference brought Israel, Syria, Lebanon, and a joint Jordanian-Palestinian delegation face-to-face for the first time in history. To bypass Israeli laws prohibiting official contact with the PLO, Palestinian delegates were officially presented as non-PLO West Bank residents. Although formal negotiations quickly stalled in public procedural disputes, Madrid shattered the psychological barrier against direct Israeli-Palestinian engagement and established the direct negotiating precedent that enabled the secret Oslo backchannel.
        </div>
        <div class="csb-takeaway">
          <strong>Strategic Turning Point:</strong> Normalized direct diplomacy and forced both Likud and PLO leadership to confront mutual political survival.
        </div>
      </div>
      ...
      <!-- Archival Dispatch: Secretary Baker's White House Phone Challenge -->
      <div class="archival-source-box">
        <div class="archival-header">
          <div class="source-identity">
            <span class="source-badge">ARCHIVAL DISPATCH</span>
            <span class="source-type">US Congressional Record</span>
          </div>
          <span class="source-date-micro">13 June 1990</span>
        </div>
        <div class="archival-title">Secretary of State James Baker's Challenge to the Parties</div>
        <div class="archival-body">
          "Everybody over there says, 'Peace, peace, peace.' Well, here is the telephone number of the White House: 202-456-1414. When you are serious about peace, call us!"
        </div>
        <div class="archival-footer">
          <span>US House Foreign Affairs Committee Testimony</span>
          <span>Washington DC, June 1990</span>
        </div>
      </div>
    </div>
  ...
  <div class="textbook-page">
    ...
    <div class="two-column-prose">
      ...
      <div class="section-banner">
        <span class="section-title">Rising Extremism, Assassination &amp; The Derailment of Oslo (1994–1996)</span>
      </div>
      <div class="numbered-para">
      ...
      <div class="numbered-para">
        ...
        Rabin's assassination dealt a fatal blow to the peace process. Following a wave of retaliatory Hamas bus bombings in early 1996 that killed 59 Israeli civilians, public faith in security evaporated. In May 1996, Likud's Benjamin Netanyahu narrowly defeated Shimon Peres on a hardline platform, slowing further troop redeployments and bringing the rapid momentum of the Oslo peace process to a permanent halt. In Rabin's jacket pocket, aides discovered a blood-soaked lyric sheet to 'Shir LaShalom' (Song of Peace), symbolizing the tragic snuffing out of the historic compromise.
      </div>
      ...
      <!-- Archival Dispatch: Prime Minister Yitzhak Rabin's Final Words -->
      <div class="archival-source-box">
        <div class="archival-header">
          <div class="source-identity">
            <span class="source-badge">ARCHIVAL DISPATCH</span>
            <span class="source-type">Final Peace Address</span>
          </div>
          <span class="source-date-micro">4 Nov 1995</span>
        </div>
        <div class="archival-title">Yitzhak Rabin's Final Address at Kings of Israel Square</div>
        <div class="archival-body">
          "I was a military man for 27 years. I waged war as long as there was no chance for peace. I believe there is now a chance for peace, a great chance, and we must seize it... Violence undermines the very foundation of Israeli democracy."
        </div>
        <div class="archival-footer">
          <span>Final Address Before Assassination, Tel Aviv</span>
          <span>4 November 1995</span>
        </div>
      </div>
    </div>
