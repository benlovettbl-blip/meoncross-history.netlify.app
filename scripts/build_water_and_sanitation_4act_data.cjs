    ...
    // ==========================================
    {
      ...
      narrative_blocks: [
        ...
        },
        {
          ...
          text: '<span class="para-ref">[2.1]</span> In the blazing summer of June 1858, London was gripped by an unprecedented heatwave, with temperatures exceeding thirty-five degrees in the sun. The intense heat cooked the hundreds of thousands of tons of raw human sewage fermenting along the exposed mudbanks of the Thames, triggering an all-consuming, suffocating stench that became known as <strong>The Great Stink</strong>. The noxious smell enveloped the entire city, but its epicenter was directly outside the magnificent, newly completed Palace of Westminster, where the Houses of Parliament stood proudly on the riverbank.<br><br><span class="para-ref">[2.2]</span> Convinced by miasma theory that inhaling the foul river stench would infect them with lethal cholera, Members of Parliament and peers were seized by naked panic. MPs fled the debating chamber with handkerchiefs pressed to their faces; committee hearings were suspended, and court trials at Westminster Hall were abandoned. In desperation, parliamentary staff soaked the heavy window curtains in carbolic acid (chloride of lime) to neutralize the smell, but the corrosive chemical fumes only caused MPs to choke. When politicians attempted to take a steamer boat downriver, the stench was so overwhelming that Prime Minister Lord Derby and his cabinet retreated inside after five minutes, clutching their throats.',
        },
        {
          act: 3,
          title:
    ...
    // ==========================================
    {
      ...
      narrative_blocks: [
        ...
        },
        {
          ...
          text: '<span class="para-ref">[2.1]</span> One London physician utterly rejected this miasma consensus: <strong>Dr. John Snow</strong>. Snow was a brilliant anesthetist who had administered chloroform to Queen Victoria during the birth of Prince Leopold in 1853. Snow applied rigorous scientific logic: if cholera were transmitted through inhaled air, the initial symptoms would manifest in the lungs and respiratory tract, such as coughing or chest pain. Instead, cholera attacked the digestive system, causing violent vomiting and watery diarrhea. Snow deduced that the unknown cholera poison must be swallowed through contaminated food or drinking water, multiplying within the human digestive tract before being expelled.<br><br><span class="para-ref">[2.2]</span> Snow rushed to Soho to conduct a forensic door-to-door epidemiological investigation. Armed with mortality records and a street directory, he interviewed grieving families and marked the precise location of every fatality. His enquiries led him directly to the popular public water pump on Broad Street, renowned among locals for producing sparkling, cold water. Snow tested water samples from the pump and detected white, flocculent organic particles. On 7 September 1854, Snow attended an emergency meeting of the St James Parish Board of Guardians; armed with his forensic data, he persuaded the reluctant vestrymen to remove the iron pump handle. The local epidemic collapsed almost immediately.',
        },
        {
          act: 3,
          title:
