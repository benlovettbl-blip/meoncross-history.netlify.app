...
const early_modern_lessons = [
  ...
  // ==========================================
  {
    ...
    narrative_blocks: [
      ...
      {
        act: 3,
        title: 'Act 3: Forensic Archival Evidence (Hakluyt’s Geopolitical Blueprint & The Armada)',
        source: {
          letter: 'B',
  ...
  {
    id: 'lesson_3',
    title: 'Trade or takeover: How did humble English trading posts turn into a corporate empire?',
    enquiry_question:
  ...
  // ==========================================
  {
    ...
    enquiry_task: {
      title: 'Master Disciplinary Enquiry Task',
      prompt: 'What was the true human cost and commercial scale of the Transatlantic Slave Trade?',
      type: 'extended_writing',
      scaffolding: {
        sentence_starters: [
          'The Transatlantic Slave Trade was organized through a ruthless commercial network known as...',
  ...
  {
    id: 'lesson_8',
    title: 'How did enslaved Africans fight back and dismantle the plantation system from within?',
    enquiry_question:
