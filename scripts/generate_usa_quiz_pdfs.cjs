...
const unitDir = path.join(ROOT_DIR, 'public', 'units', 'usa');
...
const QUIZ_FILES = [
  {
    ...
    pdfName: 'usa_recall_quiz_KT1.pdf',
    title: 'Key Topic 1 Recall Quiz (80 Questions & The Vault)',
  },
  {
    id: 'KT2',
    htmlFile: 'mastery_pack_KT2.html',
    pdfName: 'usa_recall_quiz_KT2.pdf',
    title: 'Key Topic 2 Recall Quiz (80 Questions & The Vault)',
  },
  {
    id: 'KT3',
    htmlFile: 'mastery_pack_KT3.html',
    pdfName: 'usa_recall_quiz_KT3.pdf',
    title: 'Key Topic 3 Recall Quiz (80 Questions & The Vault)',
  },
  {
    id: 'KT4',
    htmlFile: 'mastery_pack_KT4.html',
    pdfName: 'usa_recall_quiz_KT4.pdf',
    title: 'Key Topic 4 Recall Quiz (80 Questions & The Vault)',
  },
  {
    id: 'FULL',
    htmlFile: 'mastery_pack_full.html',
    pdfName: 'usa_recall_quiz_FULL.pdf',
    title: 'Complete Unit Master Recall Quiz (All 320 Questions & The Vault)',
  },
];

(async () => {
  console.log('🚀 Starting USA 1954–75 Recall Quiz PDF Generation...');
  ...
  const driveBase = 'G:\\My Drive\\AAMX\\Dep File\\02. GCSE (Years 10-11)\\Paper 3 - USA 1954-75';
  if (fs.existsSync('G:\\My Drive')) {
    ...
    try {
      ...
      console.log('✅ Google Drive Department File updated with USA Recall Quiz PDFs.');
    } catch (e) {
      console.warn(`   ⚠️ Could not sync to Google Drive: ${e.message}`);
    }
  }

  console.log('\n🎉 All USA Recall Quiz PDFs successfully generated!');
})();
