                ...
                <div class="printables-grid">
                    <div class="printable-card">
                        ...
                        <div class="printable-links">
                            <button type="button" class="print-link-btn preview" onclick="openPrintPreviewIframe('/units/cme_new/printables/cme_workout_${wb.id}.html', 'A4 Rapid Workout: ${wb.title}', '/pdfs/cme_new/cme_workout_${wb.id}.pdf')">🖨️ Preview</button>
                            <a href="/units/cme_new/printables/cme_workout_${wb.id}.html" target="_blank" class="print-link-btn web">🌐 Full Tab</a>
                            <a href="/pdfs/cme_new/cme_workout_${wb.id}.pdf" target="_blank" download class="print-link-btn pdf">📕 PDF</a>
                        </div>
                    </div>
                    <div class="printable-card">
                        ...
                        <div class="printable-links">
                            <button type="button" class="print-link-btn preview" onclick="openPrintPreviewIframe('/units/cme_new/printables/cme_placemat_${wb.id}.html', 'A3 Revision Placemat: ${wb.title}', '/pdfs/cme_new/cme_placemat_${wb.id}.pdf')">🖨️ Preview</button>
                            <a href="/units/cme_new/printables/cme_placemat_${wb.id}.html" target="_blank" class="print-link-btn web">🌐 Full Tab</a>
                            <a href="/pdfs/cme_new/cme_placemat_${wb.id}.pdf" target="_blank" download class="print-link-btn pdf">📕 PDF</a>
                        </div>
                    </div>
                    <div class="printable-card">
                        <div class="printable-card-icon">📰</div>
                        ...
                        <div class="printable-links">
                            <button type="button" class="print-link-btn preview" onclick="openPrintPreviewIframe('/units/cme_new/printables/cme_trifold_${wb.id}.html', 'Foldable Pocket Trifold Zine: ${wb.title}', '/pdfs/cme_new/cme_trifold_${wb.id}.pdf')">🖨️ Preview</button>
                            <a href="/units/cme_new/printables/cme_trifold_${wb.id}.html" target="_blank" class="print-link-btn web">🌐 Full Tab</a>
                            <a href="/pdfs/cme_new/cme_trifold_${wb.id}.pdf" target="_blank" download class="print-link-btn pdf">📕 PDF</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        if (e.changedTouches && e.changedTouches.length > 0) {
          ...
          if (elapsedTime < 550) {
            ...
            if (absX > 50 && absX > absY * 1.3) {
              if (deltaX > 0) {
                // Swiped Right -> Mastered (Box 3)
                rateCurrentCard(3);
              } else {
                // Swiped Left -> Needs Work (Box 1)
                rateCurrentCard(1);
              }
            } else if (deltaY < -45 && absY > absX * 1.3) {
              // Swiped Upwards -> Got It (Box 2)
              rateCurrentCard(2);
            }
          }
        }
