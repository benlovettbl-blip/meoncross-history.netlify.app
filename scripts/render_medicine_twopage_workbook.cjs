...
`;
  ...
  // ====================================================================
  // PAGE 14: OUTSIDE BACK COVER (Specification Audit, 96-Mark Exam Ledger & Feedback)
  // ====================================================================
  html += `
  <div class="page page-container" id="page-14" style="padding: 14px 18px; border: 1px solid #cbd5e1; outline: 3.5px double #0f172a; outline-offset: -8px; justify-content: space-between;">
    <div>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #1e3a8a; padding-bottom: 5px; margin-bottom: 8px;">
        <div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.5pt; font-weight: 800; color: #1e3a8a; text-transform: uppercase; letter-spacing: 1.2px; margin-bottom: 1px;">
            Pearson Edexcel GCSE (9–1) History &bull; Paper 1 (1HI0/11)
          </div>
          <h2 style="font-family: 'Playfair Display', serif; font-size: 13.5pt; color: #0f172a; margin: 0; text-transform: uppercase; letter-spacing: 0.5px;">
            Key Topic 2 &bull; Exam Progress Ledger &amp; Revision Matrix
          </h2>
        </div>
        <!-- Target Grade & Booklet Grade Badges -->
        <div style="display: flex; gap: 8px; align-items: center;">
          <div style="border: 1.5px solid #1e3a8a; border-radius: 4px; padding: 3px 8px; background: #eff6ff; text-align: center; min-width: 65px;">
            <div style="font-family: 'Inter', sans-serif; font-size: 6.2pt; font-weight: 800; text-transform: uppercase; color: #1e3a8a; letter-spacing: 0.5px;">Target Grade</div>
            <div style="font-family: 'Playfair Display', serif; font-size: 12pt; font-weight: 800; color: #0f172a; line-height: 1.1;">&nbsp;</div>
          </div>
          <div style="border: 1.5px solid #047857; border-radius: 4px; padding: 3px 8px; background: #ecfdf5; text-align: center; min-width: 65px;">
            <div style="font-family: 'Inter', sans-serif; font-size: 6.2pt; font-weight: 800; text-transform: uppercase; color: #047857; letter-spacing: 0.5px;">Booklet Grade</div>
            <div style="font-family: 'Playfair Display', serif; font-size: 12pt; font-weight: 800; color: #047857; line-height: 1.1;">&nbsp;</div>
          </div>
        </div>
      </div>

      <!-- Pupil Information Strip -->
      <div style="display: flex; justify-content: space-between; font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 3px; padding: 4px 8px; margin-bottom: 7px;">
      ...
      <!-- 96-Mark GCSE Exam Progress Ledger (No micro-ticking) -->
      <div style="margin-bottom: 7px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-family: 'Inter', sans-serif; font-size: 7.2pt; border: 1.2px solid #cbd5e1;">
          <thead>
            <tr style="background: #1e3a8a; color: #ffffff; text-align: left;">
              <th style="padding: 3px 6px; border: 1px solid #cbd5e1; width: 24%;">Lesson &amp; Core Focus</th>
              <th style="padding: 3px 6px; border: 1px solid #cbd5e1; width: 24%; text-align: center;">Q3 Similarity / Diff [4m]</th>
              <th style="padding: 3px 6px; border: 1px solid #cbd5e1; width: 34%;">Extended Exam Response</th>
              <th style="padding: 3px 6px; border: 1px solid #cbd5e1; width: 18%; text-align: center;">Lesson Total</th>
            </tr>
          </thead>
          <tbody>
            <tr style="background: #ffffff;">
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;"><strong>L1:</strong> Printing &amp; Royal Soc</td>
            ...
            <tr style="background: #f8fafc;">
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;"><strong>L2:</strong> Thomas Sydenham</td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center;">Q3 Similarity: &nbsp;<strong>/ 4</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;">Q4 Explain Why [12m]: &nbsp;<strong>/ 12</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center; font-weight: 700;">&nbsp; / 16</td>
            </tr>
            <tr style="background: #ffffff;">
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;"><strong>L3:</strong> Andreas Vesalius</td>
              ...
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center; font-weight: 700; color: #1e3a8a;">&nbsp; / 24</td>
            </tr>
            <tr style="background: #f8fafc;">
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;"><strong>L4:</strong> William Harvey</td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center;">Q3 Difference: &nbsp;<strong>/ 4</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;">Q4 Explain Why [12m]: &nbsp;<strong>/ 12</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center; font-weight: 700;">&nbsp; / 16</td>
            </tr>
            <tr style="background: #ffffff;">
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;"><strong>L5:</strong> Great Plague 1665</td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center;">Q3 Difference: &nbsp;<strong>/ 4</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1;">Q5/6 Essay [16+4 SPaG]: &nbsp;<strong>/ 20</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center; font-weight: 700; color: #1e3a8a;">&nbsp; / 24</td>
            </tr>
            <tr style="background: #f1f5f9; font-weight: 800; border-top: 1.5px solid #1e3a8a;">
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-transform: uppercase;">Cumulative Totals</td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center; color: #1e3a8a;">Q3 Total: &nbsp;<strong>/ 20</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; color: #1e3a8a;">Extended Total: &nbsp;<strong>/ 76</strong></td>
              <td style="padding: 3px 6px; border: 1px solid #cbd5e1; text-align: center; font-size: 8pt; background: #e0f2fe; color: #0369a1;">&nbsp; / 96</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div>
        <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 3px;">
          ...
          <span style="font-family: 'Inter', sans-serif; font-size: 6.8pt; color: #64748b;">
            [ R = Needs Work &bull; A = Secure &bull; G = Mastered ]
          </span>
        </div>
        <div style="display: flex; flex-direction: column; gap: 4px;">
          <div style="border: 1px solid #cbd5e1; border-radius: 3px; padding: 4px 7px; background: #ffffff; display: flex; justify-content: space-between; align-items: center;">
            <div style="font-family: 'Georgia', serif; font-size: 7.2pt; color: #1e293b; line-height: 1.25;">
              <strong>1. Causes &amp; Communication:</strong> Gutenberg movable type press (c1440/1476); Royal Society (1660/1662); <em>Nullius in Verba</em>; <em>Philosophical Transactions</em> (1665); Hooke\'s <em>Micrographia</em>.
            </div>
            <span style="font-family: 'Inter', sans-serif; font-size: 6.8pt; font-weight: 700; color: #64748b; white-space: nowrap; margin-left: 8px;">[ R &bull; A &bull; G ]</span>
          </div>
          <div style="border: 1px solid #cbd5e1; border-radius: 3px; padding: 4px 7px; background: #ffffff; display: flex; justify-content: space-between; align-items: center;">
            <div style="font-family: 'Georgia', serif; font-size: 7.2pt; color: #1e293b; line-height: 1.25;">
              <strong>2. Thomas Sydenham:</strong> Clinical bedside observation; <em>Observationes Medicae</em> (1676); classifying disease species; cinchona bark for ague; cooling regimes for smallpox.
            </div>
            <span style="font-family: 'Inter', sans-serif; font-size: 6.8pt; font-weight: 700; color: #64748b; white-space: nowrap; margin-left: 8px;">[ R &bull; A &bull; G ]</span>
          </div>
          <div style="border: 1px solid #cbd5e1; border-radius: 3px; padding: 4px 7px; background: #ffffff; display: flex; justify-content: space-between; align-items: center;">
            <div style="font-family: 'Georgia', serif; font-size: 7.2pt; color: #1e293b; line-height: 1.25;">
              <strong>3. Andreas Vesalius:</strong> Direct human cadaver dissection at Padua; correcting 300+ Galenic animal errors (jaw, heart septum); <em>De Humani Corporis Fabrica</em> (1543) woodcuts.
            </div>
            <span style="font-family: 'Inter', sans-serif; font-size: 6.8pt; font-weight: 700; color: #64748b; white-space: nowrap; margin-left: 8px;">[ R &bull; A &bull; G ]</span>
          </div>
          <div style="border: 1px solid #cbd5e1; border-radius: 3px; padding: 4px 7px; background: #ffffff; display: flex; justify-content: space-between; align-items: center;">
            <div style="font-family: 'Georgia', serif; font-size: 7.2pt; color: #1e293b; line-height: 1.25;">
              <strong>4. William Harvey:</strong> Heart as a mechanical pump (540 pints/hr); disproving Galen\'s liver-fuel theory; ligature vein experiments proving one-way circulation; <em>De Motu Cordis</em> (1628).
            </div>
            <span style="font-family: 'Inter', sans-serif; font-size: 6.8pt; font-weight: 700; color: #64748b; white-space: nowrap; margin-left: 8px;">[ R &bull; A &bull; G ]</span>
          </div>
          <div style="border: 1px solid #cbd5e1; border-radius: 3px; padding: 4px 7px; background: #ffffff; display: flex; justify-content: space-between; align-items: center;">
            <div style="font-family: 'Georgia', serif; font-size: 7.2pt; color: #1e293b; line-height: 1.25;">
              <strong>5. Great Plague (1665):</strong> Mayor\'s quarantine orders, searchers, mass pits; slaughter of 240,000 dogs/cats; continuity with 1348 (miasma, plague water, pomanders, no known microbes).
            </div>
            <span style="font-family: 'Inter', sans-serif; font-size: 6.8pt; font-weight: 700; color: #64748b; white-space: nowrap; margin-left: 8px;">[ R &bull; A &bull; G ]</span>
          </div>
        </div>
    ...
    <!-- Teacher Summative Feedback & D.I.R.T. Section -->
    <div>
      <div style="border: 1.2px solid #1e3a8a; border-radius: 4px; padding: 5px 8px; background: #f8fafc; margin-bottom: 4px;">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #cbd5e1; padding-bottom: 2px; margin-bottom: 4px; font-family: 'Inter', sans-serif; font-size: 7.2pt;">
          <strong style="color: #1e3a8a; text-transform: uppercase;">Teacher Summative Feedback &amp; D.I.R.T. Target</strong>
          <span style="color: #475569;">Effort: [ 1 &bull; 2 &bull; 3 &bull; 4 &bull; 5 ] &nbsp;|&nbsp; <strong>&square; D.I.R.T. Complete</strong></span>
        </div>
        <div style="font-family: 'Inter', sans-serif; font-size: 7.2pt; color: #1e293b; line-height: 1.35; margin-bottom: 3px;">
          <strong>WWW:</strong> <span class="line" style="display: inline-block; width: 92%; border-bottom: 1px solid #94a3b8; height: 11px;"></span>
        </div>
        <div style="font-family: 'Inter', sans-serif; font-size: 7.2pt; color: #1e293b; line-height: 1.35; margin-bottom: 4px;">
          <strong>EBI:</strong> &nbsp;&nbsp;<span class="line" style="display: inline-block; width: 92%; border-bottom: 1px solid #94a3b8; height: 11px;"></span>
        </div>
        <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px dashed #cbd5e1; padding-top: 2px; font-family: 'Inter', sans-serif; font-size: 6.8pt; color: #64748b;">
      ...
      <div style="display: flex; justify-content: space-between; font-family: 'Inter', sans-serif; font-size: 7.4pt; color: #94a3b8; border-top: 1px solid #e2e8f0; padding-top: 3px;">
