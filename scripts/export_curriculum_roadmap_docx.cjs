    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '🌟 6 Finished Master Gold Standards: ',
                bold: true,
                color: '15803D',
                size: 18,
                font: 'Segoe UI',
              ...
              new TextRun({
                text: 'Medicine in Britain (GCSE), Conflict in the Middle East (GCSE), Early Elizabethan England (GCSE), Industrialisation & Empire (KS3), The Early Modern World (KS3), and The Great War: Western Front (KS3).\n',
                size: 18,
                color: '334155',
                font: 'Segoe UI',
              }),
              ...
              new TextRun({
                text: 'KS3 Target: Medieval England 20p Universal Double-Page migration. • GCSE Target: Weimar and Nazi Germany 4-4-4-4 Visual Revision Guide authoring.',
                size: 18,
                color: '334155',
                font: 'Segoe UI',
              }),
