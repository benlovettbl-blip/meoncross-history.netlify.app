...
const UNITS_DATA = [
  ...
  },
  {
    ...
    textbook: 'Gold (3 KT Companion Textbooks)',
    ...
    statusLabel: '100% GOLD',
    guidance:
      'Complete & Production Ready. All 3 Key Topics consolidated into unified 16-page double-page booklets matching cme_new.',
  },
  {
    id: 'great_war_part2',
    year: 'Year 9 (KS3)',
    title: 'The Great War: Western Front & Aftermath (1914–1919)',
    fourAct: 'Complete (7 In-Depth Enquiries)',
    textbook: 'Gold (17p Companion Textbook)',
    workbook: 'Gold (20p Universal Declarative Engine with Capstone Spread & Living Timeline)',
    themes: 'Mapped (4 Strands on Cover & SOW)',
    skills: 'Active (7-Disciplinary Skill Cycle)',
    status: 'GREEN',
    statusLabel: '100% GOLD',
    guidance:
      'Production Ready. 20p Universal Engine workbook verified with 0px overflow and synced to Drive.',
  },
  {
    id: 'medieval_england',
    year: 'Year 7 (KS3)',
    ...
    skills: 'Partial',
    status: 'AMBER',
    statusLabel: 'TOP KS3 PRIORITY',
    guidance:
      'Immediate Next Project: Consolidate 38 sub-units into 8 core enquiries and compile standard 20p workbook & master textbook.',
  },
  {
    id: 'weimar_nazi_germany',
    year: 'Year 10/11 (GCSE)',
    title: 'Weimar and Nazi Germany, 1918–1939',
    fourAct: 'Complete (16 Enquiries in 4-Act Schema)',
    textbook: 'Gold (4x 10p Master Publisher Textbooks KT1–4, 40p Suite)',
    workbook: 'Gold (4x 16p Double-Page Pupil Workbooks KT1–4)',
    themes: 'Mapped (4 Strands)',
    skills: 'Active (Q1 Inference, Q2 Causation, Q3 Utility/Debate)',
    status: 'GREEN',
    statusLabel: '100% GOLD',
    guidance:
      'Complete & Production Ready. All 4 Key Topics verified with 0px overflow, enlarged typography, and authentic archival imagery.',
  },
  {
    id: 'the_shoah',
    year: 'Year 9 (KS3)',
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: '🌟 7 Finished Master Gold Standards: ',
                bold: true,
                color: '15803D',
                size: 18,
                font: 'Segoe UI',
              ...
              new TextRun({
                text: 'Medicine in Britain (GCSE), Conflict in the Middle East (GCSE), Early Elizabethan England (GCSE), Weimar and Nazi Germany (GCSE), Industrialisation & Empire (KS3), The Early Modern World (KS3), and The Great War: Western Front (KS3).\n',
                size: 18,
                color: '334155',
                font: 'Segoe UI',
              }),
              ...
              new TextRun({
                text: '🎯 Immediate Next Priority Action: ',
                bold: true,
                color: '1E3A8A',
                size: 18,
                font: 'Segoe UI',
              ...
              new TextRun({
                text: 'Top Departmental Target: Year 7 Medieval England & Power (1066–1485) 20-Page Universal Double-Page migration & 8 core enquiries refactor. All GCSE Edexcel units are now 100% Complete & Production Ready.',
                size: 18,
                color: '334155',
                font: 'Segoe UI',
              }),
