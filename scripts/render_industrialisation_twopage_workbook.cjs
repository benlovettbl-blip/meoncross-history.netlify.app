...
`;
  ...
  // ==========================================
  html += `
  <div class="page page-container" id="page-1" style="padding: 16px 18px; border: 1px solid #cbd5e1; outline: 3.5px double #0f172a; outline-offset: -8px;">
    <!-- Top Block -->
    <div>
      <!-- Institutional Header -->
      <div style="text-align: center; margin-top: 3px; margin-bottom: 7px;">
        <div style="font-family: 'Inter', sans-serif; font-size: 8.5pt; text-transform: uppercase; letter-spacing: 2.5px; color: #64748b; font-weight: 600;">
          Meoncross School &bull; Department of History
        </div>
        <div style="font-family: 'Inter', sans-serif; font-size: 7.5pt; text-transform: uppercase; letter-spacing: 1.8px; color: #1e3a8a; font-weight: 700; margin-top: 2px;">
          Key Stage 3 Historical Enquiry Series &bull; Year 8
        </div>
      </div>

      <!-- Main Title Block -->
      <div style="text-align: center; border-top: 2px solid #0f172a; border-bottom: 1px solid #cbd5e1; padding: 10px 0 9px 0; margin-bottom: 10px;">
        <h1 style="font-family: 'Playfair Display', serif; font-size: 24pt; color: #0f172a; margin: 0 0 4px 0; text-transform: uppercase; letter-spacing: 1.5px; line-height: 1.15;">
          Industrialisation, Empire &amp; Power
        </h1>
        <div style="font-family: 'Inter', sans-serif; font-size: 9.5pt; color: #334155; font-weight: 500; letter-spacing: 0.5px;">
          Britain’s Transformation from Agrarian Kingdom to Global Workshop (1750–1901)
        </div>
      </div>

      <!-- Overarching Enquiry Callout Box -->
      <div style="border: 1.2px solid #cbd5e1; border-left: 4.5px solid #1e3a8a; border-radius: 4px; padding: 8px 14px; background: #f8fafc; margin-bottom: 11px; display: flex; justify-content: space-between; align-items: center;">
        <div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.5pt; text-transform: uppercase; letter-spacing: 1.2px; color: #1e3a8a; font-weight: 700; margin-bottom: 2px;">
            Overarching Historical Enquiry
          </div>
          <div style="font-family: 'Playfair Display', serif; font-size: 12pt; color: #0f172a; font-style: italic; font-weight: 600; line-height: 1.25;">
            “How did 19th-century Britain transform at home and abroad?”
          </div>
        </div>
        <span class="archival-badge" style="flex-shrink: 0; margin-left: 14px;">8 Core Enquiries</span>
      </div>

      <!-- Hero Primary Source Presentation (Maximized) -->
      <div style="border: 1.2px solid #cbd5e1; border-radius: 6px; padding: 7px; background: #ffffff; box-shadow: 0 2px 6px rgba(0,0,0,0.04); margin-bottom: 9px;">
        <div style="width: 100%; height: 350px; border-radius: 4px; overflow: hidden; border: 1px solid #e2e8f0; background: #f8fafc;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 6px; padding: 0 4px; font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #64748b;">
      ...
      <div style="border: 1.2px solid #e2e8f0; border-radius: 5px; padding: 9px 13px; background: #fafaf9; margin-bottom: 10px;">
      ...
      <div style="border: 1px solid #cbd5e1; border-radius: 5px; padding: 7px 10px; background: #f8fafc; margin-bottom: 8px;">
        <div style="font-family: 'Inter', sans-serif; font-size: 7.2pt; text-transform: uppercase; letter-spacing: 1px; color: #1e3a8a; font-weight: 700; margin-bottom: 5px;">
          The 8 Disciplinary Enquiries:
        </div>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 5px;">
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L1:</strong> Energy, Steam &amp; Henry Cort</div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L5:</strong> Empire &amp; 1857 Indian Rebellion</div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L2:</strong> Factory Labour &amp; Discipline</div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L6:</strong> Peterloo &amp; Working-Class Protest</div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L3:</strong> Town Slums &amp; Chadwick (1842)</div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L7:</strong> The 1832 Great Reform Act</div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L4:</strong> Navy &amp; Expansion of Empire</div>
          <div style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #334155; padding: 3px 6px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 3px; display: flex; align-items: center;"><strong style="color: #1e3a8a; margin-right: 5px; white-space: nowrap;">L8:</strong> The Standard of Living Debate</div>
        </div>
      </div>
    </div>

    <!-- Bottom Block: Pupil Identity Box & Colophon -->
    <div>
      <div style="border: 1.5px solid #0f172a; border-radius: 5px; padding: 9px 16px; background: #ffffff; margin-bottom: 6px;">
        <div style="display: grid; grid-template-columns: 2.2fr 1fr; gap: 24px; align-items: center;">
          <div style="display: flex; align-items: baseline;">
            <strong style="font-family: 'Inter', sans-serif; font-size: 9pt; color: #0f172a; text-transform: uppercase; letter-spacing: 0.5px; white-space: nowrap; margin-right: 10px;">Pupil Name:</strong>
            <div style="flex: 1; border-bottom: 1.5px solid #334155; height: 16px;"></div>
          </div>
          <div style="display: flex; align-items: baseline;">
            <strong style="font-family: 'Inter', sans-serif; font-size: 9pt; color: #0f172a; text-transform: uppercase; letter-spacing: 0.5px; white-space: nowrap; margin-right: 10px;">Class:</strong>
            <div style="flex: 1; border-bottom: 1.5px solid #334155; height: 16px;"></div>
          </div>
        </div>
      </div>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #cbd5e1; padding-top: 4px; font-family: 'Inter', sans-serif; font-size: 7.5pt; color: #94a3b8;">
        ...
        <span>A4 Pupil Enquiry Workbook &bull; 20-Page Saddle-Stitch Edition</span>
      </div>
    </div>
  </div>
  `;
