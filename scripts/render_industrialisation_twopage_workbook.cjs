...
`;
      ...
      <table style="width: 100%; border-collapse: collapse; text-align: left; font-family: 'Inter', sans-serif; font-size: 7.2pt; line-height: 1.2; margin-bottom: 6px;">
        <tbody>
          <tr>
            ...
            <td style="border: 1px solid #cbd5e1; padding: 3px 6px; width: 22.5%; background: #f8fafc;"><strong style="color: #0f172a;">Emerging (1–2):</strong> Recalls isolated facts; basic descriptive narrative.</td>
            ...
            <td style="border: 1px solid #cbd5e1; padding: 3px 6px; width: 22.5%; background: #f8fafc;"><strong style="color: #0f172a;">Expected (4–5):</strong> Structured PEEL arguments; supports claims with evidence.</td>
            <td style="border: 1px solid #cbd5e1; padding: 3px 6px; width: 22.5%; background: #ffffff;"><strong style="color: #0f172a;">Greater Depth (6–9):</strong> Analytical balance; nuanced historical judgements.</td>
          </tr>
          <tr>
            ...
            <td style="border: 1px solid #cbd5e1; padding: 2.5px 6px; background: #ffffff;"><strong style="color: #0f172a;">4 • Good / 5 • Exemplary:</strong> Proactive focus; voluntary extension.</td>
          </tr>
        </tbody>
      </table>
    </div>
      ...
      <table style="page-break-inside: avoid; width: 100%; height: 100%; border-collapse: collapse; text-align: left; font-family: 'Inter', sans-serif; font-size: 7.8pt; line-height: 1.25; background-color: #ffffff; table-layout: fixed;">
        <thead>
          <tr style="background-color: #1e3a8a; color: #ffffff;">
            ...
            <th style="border: 1px solid rgba(255,255,255,0.35); padding: 6px 3px; width: 6.5%; text-align: center; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; font-size: 7.5pt;">Effort (1–5)</th>
            ...
            <th style="border: 1px solid rgba(255,255,255,0.35); padding: 6px 10px; width: 64%; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; font-size: 7.5pt;">Teacher Formative Feedback &amp; Next Steps</th>
          </tr>
        </thead>
        <tbody>
  `;
  ...
  <div class="page page-container" id="page-20" style="padding: 14px 18px; display: flex; flex-direction: column; height: 260mm; justify-content: space-between; border: 1px solid #cbd5e1; outline: 3.5px double #0f172a; outline-offset: -8px;">
    <div>
      ...
      <!-- 3. Next Unit Target & Focus Area -->
      <div style="margin-bottom: 12px;">
        <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 3px;">
          <h3 style="margin: 0; font-family: 'Inter', sans-serif; font-size: 9.5pt; color: #1e3a8a; text-transform: uppercase; font-weight: 700; letter-spacing: 0.5px;">
            3. Next Unit Target &amp; Focus Area
          </h3>
          <span style="font-family: 'Inter', sans-serif; font-size: 7.5pt; color: #64748b;">Actionable Pupil Target</span>
        </div>
        <p style="font-family: 'Inter', sans-serif; font-size: 8pt; color: #475569; margin: 0 0 4px 0;">
          What is one specific historical skill, enquiry concept, or study habit you want to focus on improving in our next unit?
        </p>
        <div style="border: 1.2px solid #cbd5e1; border-radius: 4px; height: 55px; background: #f8fafc;"></div>
      </div>

      <!-- 4. Teacher Feedback & Coaching Dialogue (Enlarged to use rest of page) -->
      <div style="border: 1.5px solid #fcd34d; border-radius: 5px; padding: 10px 14px; background: #fffbeb;">
        <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 4px;">
          <h3 style="margin: 0; font-family: 'Inter', sans-serif; font-size: 10pt; color: #92400e; text-transform: uppercase; font-weight: 700; letter-spacing: 0.5px;">
            Teacher Feedback &amp; Coaching Dialogue
          </h3>
          <span style="font-family: 'Inter', sans-serif; font-size: 7.8pt; color: #b45309; font-style: italic;">Completed during post-assessment feedback</span>
        </div>
        <p style="font-family: 'Inter', sans-serif; font-size: 8pt; color: #78350f; margin: 0 0 8px 0;">
          Teacher comments validating pupil reflection, confirming final grade, and setting forward coaching targets:
        </p>
        <div style="height: 250px; border-radius: 4px; background: #ffffff; border: 1.2px solid #fde68a;"></div>
      </div>
    </div>
