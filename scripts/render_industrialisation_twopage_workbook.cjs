...
`;
  ...
  // ==========================================
  html += `
  <div class="page page-container" id="page-1" style="padding: 14px 16px; border: 1px solid #cbd5e1; outline: 3.5px double #0f172a; outline-offset: -8px;">
    <!-- Top Content Block -->
    <div>
      <!-- Institutional Header & Pupil Registration Strip -->
      <div style="border-bottom: 1.5px solid #0f172a; padding-bottom: 7px; margin-bottom: 8px;">
      ...
      <!-- Main Title Block -->
      <div style="text-align: center; border-bottom: 1px solid #cbd5e1; padding: 4px 0 8px 0; margin-bottom: 8px;">
      ...
      <div style="border: 1.2px solid #cbd5e1; border-radius: 6px; padding: 7px; background: #ffffff; box-shadow: 0 2px 6px rgba(0,0,0,0.04); margin-bottom: 8px;">
        <div style="width: 100%; height: 355px; border-radius: 4px; overflow: hidden; border: 1px solid #e2e8f0; background: #f8fafc;">
      ...
      <div style="border: 1.2px solid #e2e8f0; border-radius: 5px; padding: 8px 12px; background: #fafaf9; margin-bottom: 8px;">
      ...
      <div style="border: 1px solid #cbd5e1; border-radius: 5px; padding: 7px 10px; background: #f8fafc; margin-bottom: 6px;">
    ...
    <!-- Bottom Block: Colophon Only (Nothing Cut Off!) -->
    <div>
      <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #cbd5e1; padding-top: 5px; font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #94a3b8;">
