...
console.log('Generating Departmental Research Dossier & AI Case Study...');
...
async function buildDocx() {
  const doc = new Document({
    ...
    description:
      'A technical record of primary archival discovery, AI research capabilities, identified errors, root cause analysis, and verification protocols.',
    sections: [
      {
        headers: {
          default: new Header({
          ...
          default: new Footer({
            children: [
              new Paragraph({
                ...
                children: [
                  new TextRun({
                    text: '2nd Lt Ernest Edward Crummack MC DCM · Archival Reconstruction & AI Analysis',
                    size: 16,
                    color: '94A3B8',
                    font: 'Segoe UI',
                  }),
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: 'The Archival Reconstruction of 2nd Lieutenant Ernest Edward Crummack MC, DCM:\nPrimary Discovery, AI Capabilities, Research Errors, Root Cause Analysis, and Verification Protocols',
                italic: true,
                size: 21,
                color: '475569',
                font: 'Georgia',
              ...
              new TableRow({
                children: [
                  ...
                  new TableCell({
                    ...
                    margins: { top: 80, bottom: 80, left: 120, right: 120 },
                    children: [
                      p('Departmental Research Record & AI Historiographical Case Study', {
                        size: 18,
                        bold: true,
                      }),
                    ],
          ...
          // SECTION 1: EXECUTIVE SUMMARY & RESEARCH OBJECTIVES
          h1('1. Executive Summary & Research Mission'),
          p(
          ...
          p(
            'The purpose of this document is to record transparently what worked, what failed, and why. It provides an objective assessment of AI capabilities in military history—highlighting dramatic successes in state paper extraction and manuscript paleography, while conducting a rigorous root-cause autopsy of severe AI errors in family genealogy, occupational attribution, and geographic placement.',
          ),

          // SECTION 2: THE HUMAN FOUNDATION
          h1('2. Phase 1: Foundational Primary Clues (The Human Baseline)'),
          p(
          ...
          // SECTION 3: ARCHIVAL DISCOVERY SUCCESSES
          h1('3. Phase 2: Archival Discovery Successes (The "Good Things" & How They Were Found)'),
          p(
            'Guided by these foundational anchors, digital tools and targeted database mining unlocked authentic primary documents that had remained unlinked for over a century:',
          ),

          h2('1. The 1916 London Gazette DCM State Paper Extraction'),
          p(
            'Standard queries for "Ernest Crummack" in online archives yielded zero results due to the War Office spelling error. By utilizing Boolean operators targeting his service number and regiment—query: ("2423" AND "York and Lanc") within September 1916—the system instantly located the original wartime gazetting:',
          ),
          createCallout([
            p(
          ...
          h2('2. The 1919 Military Cross Citation Extraction'),
          p(
          ...
          h2('3. Forensic Triangulation: Proving the Identity of Marcus Goodall'),
          p(
          ...
          // SECTION 4: THE ERRORS AUTOPSY
          h1('4. Phase 3: The Errors Made (The "Bad Things", Root Causes & Corrections)'),
          p(
            'While AI accelerated digital retrieval, it simultaneously introduced severe errors that threatened the historical integrity of the dossier. These errors fall into two distinct analytical categories:',
          ),

          h2('Category A: Family History & Biographical Hallucinations'),
          p(
            'Large Language Models operate through probabilistic token prediction. When faced with gaps in primary family records, models do not report an absence of information; instead, they synthesize plausible-sounding fictions based on regional generalities.',
          ),

          h3('Error 1: The Kinship & Marriage Hallucination ("Clara Senior")'),
          createCallout(
            [
              ...
              p(
                'The AI scraped regional marriage indexes, matched an unrelated individual with a similar surname, or fabricated a common South Yorkshire surname ("Senior") and parish ("Brampton Bierlow") to satisfy the narrative pattern of a pre-war marriage.',
              ),
          ...
          h3('Error 2: Vital Statistics & Demographic Drift (Birth & Death Dates)'),
          createCallout(
            [
              p('AI INVENTED CLAIM:', { bold: true, color: 'B45309' }),
              p(
          ...
          h3('Error 3: The Regional Occupational Stereotype ("Yorkshire Coal Miner")'),
          createCallout(
            [
              p('AI INVENTED CLAIM:', { bold: true, color: 'B45309' }),
              p(
              ...
              p('DOCUMENTED HISTORICAL REALITY:', { bold: true, color: '15803D' }),
              p(
                'Ernest came from heavy iron metallurgy, not coal mining. His father, Charles Crummack, was a skilled Shingler and Puddler at the Parkgate Iron and Steel Plant in Rotherham.',
              ),
              p('ROOT CAUSE ANALYSIS:', { bold: true, color: '1E3A8A' }),
              p(
          ...
          h3('Error 4: Regimental Service Number & Unit Muddle'),
          createCallout(
            [
              p('AI INVENTED CLAIM:', { bold: true, color: 'B45309' }),
              p(
              ...
              p('ROOT CAUSE ANALYSIS:', { bold: true, color: '1E3A8A' }),
              p(
                'The AI merged records of multiple men named Crummack/Crummock in the regimental rolls and confused administrative depot postings with active frontline attachments.',
              ),
              p('HOW IT WAS FIXED:', { bold: true, color: '0F172A' }),
              p(
          ...
          h3('Error 5: Omission of the Broader Family War Effort'),
          createCallout(
            [
              p('AI DEFICIENCY:', { bold: true, color: 'B45309' }),
              p(
          ...
          h2('Category B: Operational, Geographic & Narrative Errors'),
          p(
            'Beyond genealogical hallucinations, the AI introduced significant distortions in battlefield geography, evidence handling, and narrative register:',
          ),

          h3('Error 6: Oral Memory vs. Physical Artifact Conflation'),
          createCallout(
            [
              p('AI INVENTED CLAIM:', { bold: true, color: 'B45309' }),
              p(
              ...
              p('ROOT CAUSE ANALYSIS:', { bold: true, color: '1E3A8A' }),
              p(
                'Narrative gluing. Language models strive for continuous prose; presented with two disconnected facts, the AI artificially fused them into a single fictional monologue.',
              ),
              p('HOW IT WAS FIXED:', { bold: true, color: '0F172A' }),
              p(
                'Separated Ted’s witnessed oral testimony from physical artifact analysis into distinct, boxed containers.',
              ),
            ],
            warningCalloutBorders,
            'FFFBEB',
          ...
          h3('Error 7: Dramatic Combat Embellishment ("Hollywood Fluff")'),
          createCallout(
            [
              p('AI INVENTED CLAIM:', { bold: true, color: 'B45309' }),
              p(
              ...
              p('ROOT CAUSE ANALYSIS:', { bold: true, color: '1E3A8A' }),
              p(
                'Sensationalist training bias. AI defaults to cinematic and dramatic adjectives when drafting military narratives unless restrained.',
              ),
              p('HOW IT WAS FIXED:', { bold: true, color: '0F172A' }),
              p(
                'Enforced an Archival Juridical Register, stripping all unevidenced adjectives and restricting text strictly to dispatch records.',
              ),
            ],
            warningCalloutBorders,
            'FFFBEB',
          ...
          h3('Error 8: Macro-Map Sector Drift (Canadian Sector vs. 11th Division)'),
          createCallout(
            [
              p('AI INVENTED CLAIM:', { bold: true, color: 'B45309' }),
              p(
              ...
              p('ROOT CAUSE ANALYSIS:', { bold: true, color: '1E3A8A' }),
              p(
                'Statistical gravity. The Battle of Canal du Nord is overwhelmingly celebrated for the Canadian Corps assault; the AI defaulted to the most famous sector, ignoring unit Order of Battle.',
              ),
              p('HOW IT WAS FIXED:', { bold: true, color: '0F172A' }),
              p(
                'Realigned map coordinates and interactive radar pins to Epinoy and the XVII Corps sector.',
              ),
            ],
            warningCalloutBorders,
            'FFFBEB',
          ...
          // SECTION 5: VERIFICATION PROTOCOLS & PROMPTS
          h1('5. Phase 4: Methodological Protocols & Prompting Framework'),
          p(
          ...
          h3('Template 1: Strict Archival Fact-Extraction (Anti-Hallucination)'),
          createCallout(
            [
              p(
          ...
          h3('Template 2: Kinship & Census Cross-Verification'),
          createCallout(
            [
              p(
          ...
          h3('Template 3: Order of Battle (ORBAT) Sector Verifier'),
          createCallout(
            [
              p(
          ...
          h1('6. Conclusion & Pedagogical Value'),
          p(
...
<body>
  ...
  <div class="header-block">
    ...
    <div class="doc-subtitle">The Archival Reconstruction of 2nd Lieutenant Ernest Edward Crummack MC, DCM:<br>Primary Discovery, AI Capabilities, Research Errors, Root Cause Analysis, and Verification Protocols</div>
  </div>

  <table class="meta-table">
    <tr>
      <td class="meta-label">Document Classification:</td>
      <td><strong>Departmental Research Record &amp; AI Historiographical Case Study</strong></td>
    </tr>
    <tr>
  ...
  <h2 class="section-title">1. Executive Summary &amp; Research Mission</h2>
  ...
  <p>The purpose of this document is to record transparently what worked, what failed, and why. It provides an objective assessment of AI capabilities in military history—highlighting dramatic successes in state paper extraction and manuscript paleography, while conducting a rigorous root-cause autopsy of severe AI errors in family genealogy, occupational attribution, and geographic placement.</p>

  <h2 class="section-title">2. Phase 1: Foundational Primary Clues (The Human Baseline)</h2>
  ...
  <ul>
    ...
    <li><strong>First Marriage &amp; Family Loss:</strong> Ernest married Maud Coxon in Rawmarsh on 20 August 1906. They had two children: Edward ("Ted", born 1908) and Hilda. Maud tragically died of tuberculosis in April 1914, leaving Ernest a widower prior to mobilization.</li>
    <li><strong>Witnessed Enlistment Record:</strong> Enlisted on 2 September 1914 at Rotherham Drill Hall as Private #2423 in the 1/5th Battalion, York &amp; Lancaster Regiment (148th Bde, 49th West Riding Div), an event witnessed in person by his 6-year-old son Ted.</li>
    <li><strong>Somme Gallantry Decorations:</strong> Awarded the Distinguished Conduct Medal (DCM) for rescuing a wounded officer in No Man’s Land on the Somme in July 1916, alongside the Imperial Russian Order of St George (3rd Class).</li>
    <li><strong>The Clerical Typo Clue:</strong> War Office clerks misprinted his surname as "Crummock" with an ‘o’ in the London Gazette, causing search engines to miss his entry for decades.</li>
    <li><strong>The Goodall &amp; Sassoon Nexus:</strong> The rescued officer was 2nd Lt Marcus Goodall, son of the Canon of Rotherham and intimate friend of famed war poet Siegfried Sassoon. Canon Goodall visited Ernest after the war to express gratitude.</li>
    <li><strong>Wider Family War Effort:</strong> Elder brother Frank Crummack served in the 1/5th York &amp; Lancasters and was invalided out following the Boesinghe gas attack; sisters worked in munitions factories, notably Jessica Alma Crummack, Captain and Goalkeeper of a wartime women’s football team.</li>
    <li><strong>Second Marriage &amp; Lineage:</strong> Ernest married Elizabeth Hall (Edward Pearson’s grandmother) in 1916 at Worksop.</li>
    <li><strong>Officer Commissioning &amp; 1918 MC:</strong> Commissioned on 30 January 1918 into the 1/4th (Territorial) Bn, but attached in operational service to the 6th (Service) Battalion, winning the Military Cross at the Canal du Nord in September 1918.</li>
    <li><strong>Interwar Legacy &amp; Passing:</strong> Surviving interwar postcards confirm Ernest visited the Menin Gate, stayed at the Hôtel Ypriana in Ypres, and visited Albert on the Somme, before passing away peacefully in Dinnington in 1958 at age 73.</li>
  </ul>

  <h2 class="section-title">3. Phase 2: Archival Discovery Successes (The "Good Things" &amp; How They Were Found)</h2>
  <p>Guided by these foundational anchors, digital tools and targeted database mining unlocked authentic primary documents that had remained unlinked for over a century:</p>

  <h3 class="sub-section-title">1. The 1916 London Gazette DCM State Paper Extraction</h3>
  <p>Standard queries for "Ernest Crummack" in online archives yielded zero results due to the War Office spelling error. By utilizing Boolean operators targeting his service number and regiment—query: <code>"2423" AND "York and Lanc"</code> within September 1916—the system instantly located the original wartime gazetting:</p>
  <div class="callout">
  ...
  <h3 class="sub-section-title">2. The 1919 Military Cross Citation Extraction</h3>
  ...
  <h3 class="sub-section-title">3. Forensic Triangulation: Proving the Identity of Marcus Goodall</h3>
  ...
  <h2 class="section-title">4. Phase 3: The Errors Made (The "Bad Things", Root Causes &amp; Corrections)</h2>
  <p>While AI accelerated digital retrieval, it simultaneously introduced severe errors that threatened the historical integrity of the dossier. These errors fall into two distinct analytical categories:</p>

  <h3 class="sub-section-title">Category A: Family History &amp; Biographical Hallucinations</h3>
  <p>Large Language Models operate through probabilistic token prediction. When faced with gaps in primary family records, models do not report an absence of information; instead, they synthesize plausible-sounding fictions based on regional generalities.</p>

  <div class="callout warning">
    <span class="callout-title">Error 1: The Kinship &amp; Marriage Hallucination ("Clara Senior")</span>
    <p><strong>AI Invented Claim:</strong> <em>“On 22 May 1910, Ernest married Clara Senior at Christ Church, Brampton Bierlow. The young couple made their home in the pit village of Dinnington...”</em></p>
    ...
    <p><strong>Root Cause Analysis:</strong> The AI scraped regional marriage indexes, matched an unrelated individual with a similar surname, or fabricated a common South Yorkshire surname ("Senior") and parish ("Brampton Bierlow") to satisfy the narrative pattern of a pre-war marriage.</p>
  ...
  <div class="callout warning">
    <span class="callout-title">Error 2: Vital Statistics &amp; Demographic Drift (Birth &amp; Death Dates)</span>
    <p><strong>AI Invented Claim:</strong> Asserted that Ernest was born on <em>“11 January 1888 in Barnsley”</em> and <em>“passed away peacefully in 1968 at the age of 80”</em>.</p>
  ...
  <div class="callout warning">
    <span class="callout-title">Error 3: The Regional Occupational Stereotype ("Yorkshire Coal Miner")</span>
    <p><strong>AI Invented Claim:</strong> Generated an entire chapter titled <em>“Chapter 1: The Miner from the Yorkshire Coalfields”</em>, claiming Ernest began life as <em>“a teenage coal miner—specifically a 'ripper', cutting rock and blasting tunnel headings at Dinnington Main Colliery”</em>.</p>
    <p><strong>Documented Historical Reality:</strong> Ernest came from heavy iron metallurgy, not coal mining. His father, Charles Crummack, was a skilled Shingler and Puddler at the Parkgate Iron and Steel Plant in Rotherham.</p>
  ...
  <div class="callout warning">
    <span class="callout-title">Error 4: Regimental Service Number &amp; Unit Muddle</span>
    ...
    <p><strong>Root Cause Analysis:</strong> The AI merged records of multiple men named Crummack/Crummock in the regimental rolls and confused administrative depot postings with active frontline attachments.</p>
  ...
  <div class="callout warning">
    <span class="callout-title">Error 5: Omission of the Broader Family War Effort</span>
    <p><strong>AI Deficiency:</strong> Treated Ernest in complete isolation, omitting all family context, siblings, and home front contributions.</p>
  ...
  <h3 class="sub-section-title">Category B: Operational, Geographic &amp; Narrative Errors</h3>
  <p>Beyond genealogical hallucinations, the AI introduced significant distortions in battlefield geography, evidence handling, and narrative register:</p>

  <div class="callout warning">
    <span class="callout-title">Error 6: Oral Memory vs. Physical Artifact Conflation</span>
    ...
    <p><strong>Root Cause Analysis:</strong> Narrative gluing. Language models strive for continuous prose; presented with two disconnected facts, the AI artificially fused them into a single fictional monologue.</p>
    <p><strong>How It Was Fixed:</strong> Separated Ted’s witnessed oral testimony from physical artifact analysis into distinct, boxed containers.</p>
  </div>

  <div class="callout warning">
    <span class="callout-title">Error 7: Dramatic Combat Embellishment ("Hollywood Fluff")</span>
    ...
    <p><strong>Root Cause Analysis:</strong> Sensationalist training bias. AI defaults to cinematic and dramatic adjectives when drafting military narratives unless restrained.</p>
    <p><strong>How It Was Fixed:</strong> Enforced an Archival Juridical Register, stripping all unevidenced adjectives and restricting text strictly to dispatch records.</p>
  </div>

  <div class="callout warning">
    <span class="callout-title">Error 8: Macro-Map Sector Drift (Canadian Sector vs. 11th Division)</span>
    ...
    <p><strong>Root Cause Analysis:</strong> Statistical gravity. The Battle of Canal du Nord is overwhelmingly celebrated for the Canadian Corps assault; the AI defaulted to the most famous sector, ignoring unit Order of Battle.</p>
    <p><strong>How It Was Fixed:</strong> Realigned map coordinates and interactive radar pins to Epinoy and the XVII Corps sector.</p>
  </div>

  <h2 class="section-title">5. Phase 4: Methodological Protocols &amp; Prompting Framework</h2>
...
Provide citations to official British military histories or war diaries.</div>
  ...
  <h2 class="section-title">6. Conclusion &amp; Pedagogical Value</h2>
  ...
  await page.pdf({
    ...
    footerTemplate:
      '<div style="font-size: 7.5pt; color: #94a3b8; width: 100%; display: flex; justify-content: space-between; padding-left: 13mm; padding-right: 13mm; font-family: sans-serif;"><span>2nd Lt Ernest Crummack MC DCM · Archival Reconstruction & AI Analysis</span><span>Page <span class="pageNumber"></span> of <span class="totalPages"></span></span></div>',
  });
