    ...
    <div class="page-body-full" style="display: flex; flex-direction: column; justify-content: space-between; height: 100%;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-family: 'Inter', sans-serif;">
          <thead>
            <tr style="border-bottom: 1.5px solid #000000; background: #ffffff;">
              <th style="padding: 4px; width: 24px; text-align: center; font-size: 8.2pt; font-weight: 900; border-right: 1px solid #000000;">#</th>
              <th style="padding: 4px 6px; text-align: left; font-size: 8.0pt; font-weight: 900; text-transform: uppercase; border-right: 1px solid #000000;">Enquiry / Lesson Assessment</th>
              <th style="padding: 4px; width: 75px; text-align: center; font-size: 7.8pt; font-weight: 900; text-transform: uppercase; border-right: 1px solid #000000;">Do Now (10m)</th>
              <th style="padding: 4px; width: 72px; text-align: center; font-size: 7.8pt; font-weight: 900; text-transform: uppercase; border-right: 1px solid #000000;">Q1(a) (2m)</th>
              <th style="padding: 4px; width: 72px; text-align: center; font-size: 7.8pt; font-weight: 900; text-transform: uppercase; border-right: 1px solid #000000;">Q1(b) (2m)</th>
              <th style="padding: 4px; width: 78px; text-align: center; font-size: 7.8pt; font-weight: 900; text-transform: uppercase; border-right: 1px solid #000000;">Ext (12/16m)</th>
              <th style="padding: 4px 6px; width: 80px; text-align: center; font-size: 8.2pt; font-weight: 900; text-transform: uppercase;">Lesson Total</th>
            </tr>
          </thead>
          <tbody>
            ${enquiriesRowsHtml}
            <tr style="background: #ffffff; font-weight: 900; border-top: 2px solid #000000;">
              <td colspan="2" style="padding: 4px 6px; border-right: 1px solid #000000; text-transform: uppercase; font-size: 7.8pt;">Key Topic ${data.keyTopicNum} Cumulative Assessment Totals</td>
              <td style="padding: 4px; border-right: 1px solid #000000; text-align: center; white-space: nowrap; font-size: 7.6pt;">Do Now: [ <strong>/ 40</strong> ]</td>
              <td style="padding: 4px; border-right: 1px solid #000000; text-align: center; white-space: nowrap; font-size: 7.6pt;">Q1(a): [ <strong>/ 8</strong> ]</td>
              <td style="padding: 4px; border-right: 1px solid #000000; text-align: center; white-space: nowrap; font-size: 7.6pt;">Q1(b): [ <strong>/ 8</strong> ]</td>
              <td style="padding: 4px; border-right: 1px solid #000000; text-align: center; white-space: nowrap; font-size: 7.6pt;">Ext: [ <strong>/ 56</strong> ]</td>
              <td style="padding: 4px 6px; text-align: center; font-size: 9.5pt; font-weight: 900;">[ &nbsp;&nbsp;&nbsp; <strong>/ 112</strong> ]</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div style="border: 1.5px solid #000000; border-radius: 4px; padding: 4px 10px; background: #ffffff; margin-bottom: 4px;">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #000000; padding-bottom: 2px; margin-bottom: 2px;">
          ...
          <span style="font-family: 'Inter', sans-serif; font-size: 7.6pt; color: #222222; font-weight: 700;">
            Effort Grade: [ &nbsp;&nbsp;&nbsp;&nbsp; ]
          </span>
        </div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #000000; padding-top: 2px; margin-top: 2px; font-family: 'Inter', sans-serif; font-size: 7.6pt;">
