...
`;
  ...
  <div class="page page-container" id="page-1" style="padding: 14px 16px; border: 1px solid #cbd5e1; outline: 3.5px double #0f172a; outline-offset: -8px; justify-content: space-between;">
    ...
    <div style="border: 1.5px solid #0f172a; border-radius: 4px; overflow: hidden; background: #ffffff; flex: 1; display: flex; flex-direction: column; margin-bottom: 3px;">
      ...
      <div style="background: #f8fafc; border-top: 1px dashed #cbd5e1; padding: 2.5px 10px; font-family: 'Inter', sans-serif; font-size: 6.8pt; color: #475569; display: flex; justify-content: space-between; align-items: center;">
        <span><strong>Culminating Enquiry 9:</strong> <em>'How far had Britain transformed into a modern superpower by 1750, and at what human cost?'</em> is completed on the standalone 2-page Synoptic Assessment Sheet at the end of term.</span>
        <span style="font-weight: 700; color: #1e3a8a; white-space: nowrap; margin-left: 8px;">Standalone Portfolio Pack &rarr;</span>
      </div>
    </div>
  ...
  lessonConfigs.forEach((cfg, lIdx) => {
    ...
    const leftTextbookPage = lessonNum * 2;
    const rightTextbookPage = lessonNum * 2 + 1;
    const lessonUrl = `https://the-history-revision-hub.netlify.app/?view=lessons&unit=early_modern_world&lesson=${lessonNum}`;
    const microQrSvg = generateQrSvg(lessonUrl);
      ...
      <div>
        ...
        <div style="border-bottom: 2px solid #1e3a8a; padding-bottom: 3px; margin-bottom: 4px; display: flex; justify-content: space-between; align-items: center;">
          <div style="flex: 1; min-width: 0; padding-right: 8px;">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 2px;">
              <span style="font-family: 'Inter', sans-serif; font-size: 7.4pt; text-transform: uppercase; letter-spacing: 0.8px; color: #64748b; font-weight: 700;">
                KS3 Early Modern World &bull; Lesson ${lessonNum}
              </span>
              <span style="background: #eff6ff; color: #1e3a8a; border: 1px solid #bfdbfe; border-radius: 3px; padding: 1px 6px; font-family: 'Inter', sans-serif; font-size: 6.8pt; font-weight: 700; display: inline-flex; align-items: center; gap: 4px;">
                📖 Master Textbook: Pages ${leftTextbookPage}–${rightTextbookPage}
              </span>
            </div>
            <h2 style="font-family: 'Playfair Display', serif; font-size: 11.8pt; color: #0f172a; margin: 0; line-height: 1.18; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
              L${lessonNum}: ${cfg.enquiryQuestion.replace(/^Enquiry:\s*/i, '')}
            </h2>
          </div>
          <div style="display: flex; align-items: center; gap: 6px; flex-shrink: 0;">
            <span class="archival-badge" style="background: #f8fafc; color: #1e3a8a; border-color: #cbd5e1; font-size: 6.8pt; padding: 2px 6px; white-space: nowrap;">${cfg.genre}</span>
            <div style="display: flex; align-items: center; gap: 4px; background: #ffffff; border: 1px solid #cbd5e1; border-radius: 3px; padding: 2px 4px; height: 13.5mm; box-sizing: border-box;">
              <div style="width: 11.5mm; height: 11.5mm; flex-shrink: 0;">
                ${microQrSvg}
              </div>
              <div style="display: flex; flex-direction: column; font-family: 'Inter', sans-serif; font-size: 5.6pt; line-height: 1.1; color: #475569; white-space: nowrap;">
                <strong style="color: #0f172a; text-transform: uppercase; font-size: 5.8pt;">Interactive Hub</strong>
                <span>Scan for Audio</span>
