export const unitData = {
  ...
  "lessons": [
    {
      ...
      "sources": [
        {
          "title": "Reference Map: Alsace-Lorraine Border Region (1871)",
      ...
      "extended": {
        "title": "Bismarck vs. Wilhelm: A Clash of Strategy",
        "paragraphs": [
          "Following the crushing defeat of France in 1871, German Chancellor Otto von Bismarck understood that France would never forgive the loss of Alsace-Lorraine. His greatest fear was that France would form an alliance with another major European power\"specifically Russia\"which would force Germany to fight a devastating \"two-front war\" if conflict ever broke out.",
          "To prevent this, Bismarck spent the next twenty years weaving a complex, dizzying web of alliances and secret treaties designed entirely to keep France diplomatically isolated. He formed the Triple Alliance with Austria-Hungary and Italy, and signed a secret Reinsurance Treaty with Russia. Bismarck's diplomatic genius lay in his ability to juggle these competing empires, ensuring that Germany always had more friends than enemies.",
          "However, when a young, ambitious Kaiser Wilhelm II took the throne in 1888, he dismissed Bismarck and foolishly allowed the treaty with Russia to expire. Within years, Bismarck's nightmare became a reality: France and Russia signed a military alliance. The brilliant diplomatic safety net that Bismarck had built was gone, leaving Germany surrounded and forcing the German military to start planning for the exact scenario Bismarck had dreaded."
    ...
    {
      "id": "lesson_2",
      "title": "Lesson 2: Why did the scramble for colonies turn empires into rivals?",
      "narrative": [
        "By the turn of the 20th century, the Great Powers of Europe were locked in a fierce, competitive race to conquer and maintain overseas empires. Colonies had become vital status symbols of industrial wealth and global importance. Each territory provided cheap raw materials to feed the factories of the ruling nation, while simultaneously serving as locked-down markets to purchase the home country's manufactured goods. This race had been formalized at the <strong></strong>, where European leaders partitioned Africa among themselves without consulting any Africans. Among the territories partitioned, the <strong></strong> stood out as a site of extreme exploitation, owned personally by King Leopold II of Belgium.<br><br>Great Britain possessed the vastest overseas empire in human history. Because Great Britain was an island nation, its entire imperial network relied heavily on open sea routes. Thousands of British merchant ships sailed the oceans daily, and the Royal Navy was given absolute priority to keep these global sea lanes clear of foreign rivals. Crucially, Britain controlled the <strong></strong> in Egypt to secure its vital shipping lanes to India. Any challenge to this naval dominance was viewed by British politicians as a direct threat to the survival of the British Empire. France held the second-largest empire, focusing heavily on territories in North and West Africa. Having suffered the bitter humiliation of losing Alsace-Lorraine to Germany in 1871, French politicians fiercely guarded their colonies to protect their remaining international reputation. However, imperial expansion was fraught with danger; in 1898, Britain and France nearly went to war during the <strong></strong>, a tense military standoff over control of the Upper Nile in Sudan.<br><br>The entire geopolitical landscape destabilized when Germany entered the race. Having only unified in 1871, Germany was a new nation right in the middle of Europe, but its industry was growing rapidly. The ambitious German Kaiser Wilhelm II and his politicians wanted Germany to match the global influence of Britain and France. In a fiery speech to the German parliament on 6 December 1897, Foreign Secretary Bernhard von Bülow announced that Germany would no longer stand aside, famously demanding Germany’s own \"place in the sun\".<br><br>Germany rapidly seized territories across the globe, including the Cameroons, East Africa, Togo, and the Pacific colony of <strong></strong> in Papua New Guinea. This aggressive push led to direct clashes. In 1911, the <strong></strong> erupted when Germany sent a gunboat, the <strong></strong>, to the Moroccan port of <strong></strong> in an attempt to challenge French influence. The standoff ended when Germany recognized <strong></strong> as the protector of Morocco in exchange for minor territories in the Congo. To hold and defend this new empire, German politicians announced plans to construct a massive battle fleet. This move deeply alarmed Great Britain. British politicians regarded Germany’s colonial and naval ambitions as an aggressive attempt to undermine the British Empire, while German leaders increasingly viewed Britain as a hostile obstacle standing in the way of Germany’s legitimate right to historical greatness.",
      ...
      "extended": {
        "title": "The Gamble of Weltpolitik",
        "paragraphs": [
          "In 1905, the Kaiser arrived in Tangier, Morocco, declaring his support for Moroccan independence against French influence. He expected the Entente Cordiale to fracture under pressure. Instead, the exact opposite happened: at the Algeciras Conference in 1906, Britain firmly backed France, leaving Germany diplomatically humiliated and isolated, supported only by Austria-Hungary.",
          "The Kaiser repeated this dangerous gamble in 1911 (the Agadir Crisis) by sending the gunboat SMS Panther to the Moroccan coast. Once again, Britain stood by France, and the British navy was even placed on a war footing. Wilhelm’s clumsy attempts at 'gunboat diplomacy' completely backfired. Rather than breaking the Entente Cordiale, his aggression convinced Britain and France that Germany was an unpredictable threat, pushing the two nations into a much tighter military partnership."
        ],
      ...
      "primary_source": {
        ...
        "tasks": [
          ...
          {
            "type": "draw",
            "text": "Q5: Contrast how British politicians and German politicians viewed Germany's right to acquire an empire. Use the word \"obstacle\" or \"encirclement\" in your answer.",
            "model": "A detailed historical explanation using specific chronology and evidence from the lesson."
          }
        ],
        "teacher_note": "This cartoon references the 1884-85 Berlin Conference where Bismarck helped orchestrate the \"Scramble for Africa\". Britain, long the dominant global empire, felt deeply threatened by Germany's sudden, aggressive expansion into Africa and the Pacific (Weltpolitik), fearing it would disrupt their economic dominance."
      },
      "flashcards": [
        {
    ...
    {
      "id": "lesson_3",
      "title": "Lesson 3: Whose Navy Was Biggest and Best? The Arms Race",
      "narrative": [
        "For nearly a century following the Battle of Trafalgar in 1805, Great Britain had ruled the world's oceans without any major international challenge, possessing the most powerful navy on earth. As an island nation with a massive global empire, Britain relied on its naval supremacy to protect its trade routes, secure resource lifelines, and defend its home shores from European threats. To maintain this supremacy, Britain adhered to the <strong></strong>, a strict naval policy stating that the Royal Navy must always be at least equal to or larger than the next two most powerful navies in the world combined.<br><br>Everything changed fundamentally in 1898 when Germany's new emperor, Kaiser Wilhelm II, announced his clear intention to build a powerful German navy. The Kaiser believed that if Germany was ever to become a true world power, it had to explicitly challenge the global dominance of the British fleet. In 1898 and 1900, the German government passed the historic German Navy Laws, which ordered the rapid construction of a massive fleet, including 19 battleships in the first law and an additional 38 in the second. To back this policy, the German naval chief, Admiral Tirpitz, established the Navy League. This massive organization arranged civilian tours of industrial shipyards and delivered public lectures across Germany to stimulate intense public interest and build a fierce sense of patriotism among ordinary citizens.<br><br>British politicians were profoundly alarmed by Germany's actions. They believed that Germany's expanding High Seas Fleet was being designed specifically for a future military conflict with the British Grand Fleet. To explain the danger, British politicians pointed out the fundamental difference in each nation's security needs:",
        "Britain's defensive response was to design and construct the most powerful warship ever created: HMS <em>Dreadnought</em>. Launched in 1906, this vessel was so advanced in its speed, armor plating, and long-range rotating turrets that every existing battleship on earth was rendered instantly obsolete overnight. Rather than stopping the competition, HMS <em>Dreadnought</em> inadvertently reset the score to zero, giving Germany a chance to compete on equal terms. Germany immediately responded by manufacturing its own version of the battleship, the <em>SMS Rheinland</em>. The naval arms race was officially underway, with both nations building more and more of these massive, expensive weapons. By 1914, Germany had successfully doubled the size of its navy to become the second-largest naval power in the world, leaving Britain deeply suspicious of its motives.<br><br>This competitive race culminated in a highly strategic naval standoff. The British Grand Fleet was stationed at its primary home base at <strong></strong> in Scotland, while the German High Seas Fleet was based at <strong></strong> on the North Sea coast. Both fleets expected a massive, decisive battle in the <strong></strong>. To facilitate the rapid movement of its massive new dreadnoughts between the Baltic Sea and the North Sea, Germany widened the <strong></strong>, completing the project in 1914 just before the outbreak of war.",
      ...
      "sources": [
        {
          "title": "MAP SUITE PLATE 4: The North Sea & Naval Chokepoints",
      ...
      "extended": {
        "title": "The Naval Race: A Self-Fulfilling Prophecy?",
        "paragraphs": [
          "The HMS Dreadnought was a technological marvel. It was faster, heavily armored, and carried ten massive 12-inch guns, making every other battleship on earth instantly obsolete. While the Dreadnought was a triumph of British engineering, it contained a fatal strategic flaw: because all older ships were now worthless, Britain's massive head start in naval numbers was suddenly wiped out.",
          "Germany recognized the opportunity immediately. The naval race was no longer about total ships, but about who could build the most 'Dreadnought-class' vessels. By revolutionizing naval warfare, Britain had essentially hit the reset button on the arms race, giving Germany a realistic chance to challenge British naval supremacy from scratch. The ensuing desperate scramble to build Dreadnoughts consumed the budgets and political rhetoric of both nations up until 1914."
        ],
    ...
    },
    {
      ...
      "extended": {
        "title": "The Powder Keg: Nationalism vs. Empire",
        "paragraphs": [
          "This 'Blank Check' is one of the most debated actions in modern history. Some historians argue the Kaiser was acting out of impulsive loyalty to his murdered friend, not expecting the crisis to escalate beyond a localized Balkan war. They point to the fact that Wilhelm went on a sailing cruise immediately after giving the promise, suggesting he did not believe a global conflict was imminent.",
          "However, other historians argue that the German High Command deliberately used the 'Blank Check' to push Austria into war. Knowing that Russia's military was rapidly modernizing and would soon be too powerful to defeat, German generals believed that if a European war was inevitable, it was better to fight it in 1914 rather than wait. By giving Austria unconditional support, Germany ensured the crisis would explode into a continental conflict."
        ],
      ...
      "primary_source": {
        ...
        "teacher_note": "This cartoon perfectly illustrates how the alliance system functioned as a 'doomsday machine'. A localized dispute in the Balkans quickly cascaded into a global conflict because each nation was bound to protect its ally."
      },
      "flashcards": [
        {
          "term": "The Balkans",
    ...
    },
    {
      ...
      "narrative": [
        ...
        "\"Analyze the role of military mobilization timetables in the July Crisis. Why were diplomatic efforts like the 'Willy-Nicky Telegrams' ultimately powerless to stop the outbreak of war?\"",
      ...
      "sources": [
        ...
        {
          "title": "",
          "src": "assets/map_postwar_europe.jpg",
          "caption": ""
        }
      ],
      "tasks": [
        {
          "type": "written",
          "text": "Q1: Explain why the rise of independent Balkan states and Serbian nationalism represented a catastrophic nightmare for the Austro-Hungarian Empire. (P2)",
          "model": "A detailed historical explanation using specific chronology and evidence from the lesson."
        },
        {
          "type": "written",
          "text": "Q2: Detail how the structural failure of the first bomb plot inadvertently led to the exact scenario where Gavrilo Princip was able to shoot the Archduke. (P3)",
          "model": "The first assassin threw a bomb that bounced off the Archduke's car and exploded behind them. Because of this, the Archduke's driver later changed the route to visit the injured in the hospital. However, the driver wasn't informed of the route change, took a wrong turn, and stalled the car right in front of a cafe where Gavrilo Princip was standing, giving him a point-blank shot."
        },
        {
          "type": "written",
          "text": "Q3: Outline the chronological sequence of events from July 23 to August 4, 1914, that transformed a local Balkan assassination into a total European war between alliances. (P4)",
          "model": "Austria-Hungary issued a harsh ultimatum to Serbia (July 23). When Serbia refused one term, Austria declared war (July 28). Russia mobilized its army to defend Serbia (July 30). In response, Germany declared war on Russia (Aug 1) and France (Aug 3). To attack France quickly, Germany invaded neutral Belgium, forcing Britain to declare war on Germany (Aug 4)."
        },
        {
          "type": "written",
          "text": "Q4: Contrast the historical argument of Tony Howarth (Interpretation 3), who blames competing nationalist ideologies, with Germany's military leaders who blame external threats. (P5)",
          "model": "A detailed historical explanation using specific chronology and evidence from the lesson."
        },
        {
          "type": "written",
          "text": "Q5: Explain why the assassination in Sarajevo acted merely as a contributory trigger to set off a general explosion, rather than being the lone necessary cause of the war. (P7)",
          "model": "The assassination was merely the spark that ignited the 'powder keg'. The true, necessary causes were the decades of deep-rooted, structural tensions: the aggressive imperialism (Weltpolitik), the paranoid arms race (Dreadnoughts), the inflexible alliance systems dividing Europe into two armed camps, and the inflexible military mobilization timetables."
        },
        {
          "type": "written",
          "text": "Question 3a: How useful are Source A and Source B together to a historian researching why the European alliance system failed to maintain peace in July 1914? (P8)",
          "model": "Source A (Boiling Point) is highly useful for showing the extreme tension in the Balkans and how all Great Powers were precariously trying to keep the peace. However, it doesn't show the alliance treaties. Source B (Senegalese troops) is not useful for understanding the failure of diplomacy in July 1914, as it shows colonial troops fighting much later during the actual trench warfare phase."
        },
        {
          "type": "written",
          "text": "Question 3b: What is the main difference between Interpretation 1 and Interpretation 2 regarding who or what was to blame for starting the First World War? (P9)",
          "model": "Interpretation 1 places the blame squarely on the shoulders of the German leadership, accusing them of launching a deliberate war of aggression. Interpretation 2 argues against blaming a single nation, instead claiming that the rigidly structured alliance system and military timetables caused a systemic failure where everyone blundered into war."
        },
        {
          "type": "written",
          "text": "Question 3c: Suggest why Interpretation 1 and Interpretation 2 give different views on the causes of the war. (P10)",
          "model": "They give different views because they emphasize different historical factors. Interpretation 1 focuses on the deliberate political decisions of individuals (like the Kaiser issuing the 'blank cheque'). Interpretation 2 focuses on structural, long-term factors (like the alliance networks and the inflexible Schlieffen Plan) that forced the hands of the politicians."
        },
        {
          "type": "written",
          "text": "Enquiry Task: Explain how the creation of Poland and Czechoslovakia in 1919 acted as a strategic boundary buffer between Germany and the newly formed Soviet Union. (P11)",
      ...
      "extended": {
        "title": "The July Crisis: Inevitable or Preventable?",
        "paragraphs": []
      },
      "do_now": {
        "type": "questions",
      ...
      "primary_source": {
        ...
        "teacher_note": "The Balkans was known as the \"Powder Keg of Europe\" because of explosive nationalist movements, particularly Slavic groups seeking independence from the Austro-Hungarian Empire. The \"Great Powers\" (Britain, France, Germany, Russia, Austria-Hungary) are shown desperately trying to keep a lid on the tension, which finally exploded with the Archduke's assassination."
      },
      "flashcards": [
        {
  ...
  "quizPack": [
    ...
    {
      "q": "Which major power's entry into the Entente definitively forced Germany to rethink its strategy?",
      "a": "Russia (or Britain)"
    }
  ]
};
