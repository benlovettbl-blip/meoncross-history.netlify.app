      ...
      vocab: [
        {
          term: 'Miasma',
          definition:
            "The belief that bad, smelly air filled with harmful fumes from rotting organic matter or swamps could corrupt the body's humours and cause disease.",
        },
        {
          term: 'Four Humours',
          definition:
            'The ancient medical theory created by Hippocrates stating that the body was made of four vital liquids (blood, phlegm, yellow bile, and black bile) which had to be perfectly balanced to maintain good health.',
        },
        {
      ...
      vocab: [
        {
          term: 'Phlebotomy',
          definition:
            'The medical term for bloodletting, which was the most common medieval treatment used to rebalance the humours by cutting a vein, using leeches, or cupping.',
        },
        {
    ...
    },
    {
      ...
      vocab: [
        ...
        },
        {
          ...
          definition:
            'The popular pre-1860s theory that microbes were the natural product, rather than the cause, of decay and decomposing matter.',
        },
        {
          term: 'Bacteriology',
          definition:
      ...
      vocab: [
        {
          term: 'Laissez-faire',
          definition:
            'The pre-19th century government attitude of minimal interference in the day-to-day lives of the population, based on the belief that public health and living conditions were not the responsibility of the state.',
        },
        {
    ...
    },
    {
      ...
      vocab: [
        ...
        },
        {
          term: 'Vaccination',
          definition:
            "The safer, scientific preventative technique pioneered by Edward Jenner in 1796 using mild cowpox matter to provide immunity against smallpox, named after 'vacca', the Latin word for cow.",
        },
        {
          term: 'Spot Map',
          definition:
            'A detailed mapping technique created by John Snow during the 1854 Soho outbreak, where he drew marks on a street map to represent cholera deaths and visually trace the source of contamination to the Broad Street water pump.',
        },
      ],
      vocab_cloze_text:
        'Before the late eighteenth century, wealthy Britons often paid for a risky [Inoculation] to protect themselves from smallpox, despite the danger of spreading a full-strength infection. In 1796, Edward Jenner transformed medicine by proving that a safer, cowpox-based [Vaccination] successfully provided immunity, even though he could not scientifically explain why it worked. Decades later, John Snow tackled a different epidemic by creating a detailed [Spot Map] of cholera fatalities, providing physical proof that clean water, rather than purifying bad air, was the key to preventing the disease.',
      pair_share: {
        prompt:
    ...
    },
    {
      ...
      vocab: [
        ...
        },
        {
          ...
          definition:
            'A massive international scientific collaboration launched in 1990 and essentially complete by 2003, which successfully mapped and decoded all three billion DNA pairs in the human body.',
        },
        {
          term: 'Biopsy',
          definition:
      ...
      vocab: [
        {
          term: 'Antibiotic',
          definition:
            'A drug made from microorganisms, such as mould, that can destroy or inhibit the growth of harmful bacteria inside the body to cure infections.',
        },
        {
          term: 'Culture Medium',
          definition:
      ...
      vocab: [
        {
          term: 'Aseptic surgery',
          definition:
            'A surgical method pioneered by c1900 where infection is prevented by ensuring the entire operating environment is completely free of bacteria through steam-sterilising all instruments, washing hands, and wearing sterile gowns and rubber gloves.',
        },
        {
      ...
      vocab: [
        {
          term: 'Thomas Splint',
          definition:
            'A metal leg splint designed before the war but introduced to the Western Front in 1916, which kept a broken leg rigid during evacuation, reducing the death rate from compound fractures from 80% to just 18%.',
        },
        {
          term: 'Carrel-Dakin Method',
          definition:
