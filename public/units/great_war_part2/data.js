  ...
  "lessons": [
    {
      ...
      "narrative_blocks": [
        ...
        },
        {
          ...
          "image_alt": "Arrest of Gavrilo Princip in Sarajevo"
        },
        {
    ...
    },
    {
      ...
      "narrative_blocks": [
        ...
        },
        {
          ...
          "image_alt": "Diagram of a typical First World War trench system"
        },
        {
      ...
      "narrative_blocks": [
        ...
        },
        {
          ...
          "tasks": [
            {
              "type": "text",
              "text": "<strong>Part B: Edexcel Source Utility</strong><br>Study Source A (the photograph of the Munitionettes above) and Interpretation A (Arthur Marwick's text).<br><br>How useful are Source A and Interpretation A for an inquiry into the impact of the war on women? (8 marks)",
              "model": "Source A is highly useful as contemporary evidence showing women taking on heavy industrial roles in munitions factories, proving a significant shift in female employment. However, it might be a staged propaganda photograph. Interpretation A is useful because Marwick provides a historian's overview, arguing the war permanently liberated women. However, this interpretation is limited, as we know many women were forced to give up these jobs when men returned in 1919."
            },
            {
              "type": "text",
          ...
          "image_alt": "Female Munitionettes working in a factory"
        }
      ],
      "quiz": [
        {
