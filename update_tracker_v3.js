...
files.forEach(file => {
  ...
  const oldHeaders = `<th style="border: 1px solid #333; padding: 6px; width: 5%; text-align: center;">Lsn</th>
  ...
  const newHeaders = `<th style="border: 1px solid #333; padding: 6px; width: 30%;">Progress & Assessment Tracker</th>
            ...
            <th style="border: 1px solid #333; padding: 6px; width: 25%;">WWW (What Went Well)</th>
            <th style="border: 1px solid #333; padding: 6px; width: 25%;">EBI (Even Better If)</th>`;
  ...
  const oldAssess = `trackerRows += \`<tr><td style="border:1px solid #333; padding:4px; text-align:center; font-weight:bold;">A</td><td style="border:1px solid #333; padding:4px;">\${a.title}</td><td style="border:1px solid #333; padding:4px; text-align:center; background:#eee;">N/A</td><td style="border:1px solid #333; padding:4px; text-align:center; color:#ccc;">〇</td><td style="border:1px solid #333; padding:4px;"></td><td style="border:1px solid #333; padding:4px;"></td><td style="border:1px solid #333; padding:4px;"></td><td style="border:1px solid #333; padding:4px;"></td></tr>\`;`;
  const newAssess = `trackerRows += \`<tr><td style="border:1px solid #333; padding:4px; font-weight:bold; background:#e2e8f0;">Assessment: \${a.title}</td><td style="border:1px solid #333; padding:4px;"></td><td style="border:1px solid #333; padding:4px;"></td><td style="border:1px solid #333; padding:4px;"></td><td style="border:1px solid #333; padding:4px;"></td></tr>\`;`;
