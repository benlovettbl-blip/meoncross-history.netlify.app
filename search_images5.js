...
(async () => {
    await search("Triangular trade map");
    await search("Slave ship Brookes diagram");
    await search("Olaudah Equiano portrait 1789");
    await search("Jamaica Maroon map 18th century");
})();
