...
const guidedReadingData = [
  {
    lesson_index: 0,
    book_title: 'Changle Inscription',
    author: 'Admiral Zheng He',
    cover_image: '',
  ...
  {
    lesson_index: 1,
    book_title: 'A Discourse Concerning Western Planting',
  ...
  {
    lesson_index: 2,
    book_title: 'A Briefe and True Report of the New Found Land of Virginia',
  ...
  {
    lesson_index: 3,
    book_title: 'Anonymous Warning Letter',
    author: 'Unknown',
    cover_image: '',
  ...
  {
    lesson_index: 4,
    book_title: 'Speech to Parliament, 21 March 1610',
    author: 'King James I',
    cover_image: '',
  ...
  {
    lesson_index: 5,
    book_title: 'England\'s Treasure by Forraign Trade',
    author: 'Thomas Mun',
    cover_image: '',
  ...
  {
    lesson_index: 7,
    book_title: 'A New Account of Some Parts of Guinea',
    author: 'Captain William Snelgrave',
    cover_image: '',
...
if (insertIdx !== -1) {
    const newData = data.slice(0, insertIdx) + '"guided_reading": ' + JSON.stringify(guidedReadingData, null, 2) + ',\n  ' + data.slice(insertIdx);
    ...
    console.log('Could not find lessons: [');
}
