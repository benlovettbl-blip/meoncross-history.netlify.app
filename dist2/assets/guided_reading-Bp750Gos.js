import{t as e}from"./unit-L4YILPA-.js";function t(t,n,r){let i=r?r.currentLessonIndex:0,a=n.find(e=>e.lesson_index===i);if(!a&&n.length>0&&(a=n[0]),!a){t.innerHTML=`<div style="padding: 2rem; text-align: center; color: #64748b;">No guided reading extract available for this lesson.</div>`;return}t.innerHTML=`
