      ...
      `,r+=`<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px; text-align: left;">`;let n=!1;e.lessons.forEach((i,a)=>{(i.id&&i.id.startsWith(t.prefix)||i.title&&i.title.startsWith(t.prefix))&&(n=!0,r+=`
        ...
        `}),r+=`</div>`,i.length>0&&(r+=`<h2 style="margin-top: 40px; text-align: left; color: #991b1b; border-bottom: 2px solid #fecaca; padding-bottom: 10px;"><i class="fa-solid fa-ribbon"></i> The Fallen</h2>`,r+=`<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-top: 20px; text-align: left;">`,i.forEach(e=>{r+=`
            <div class="homepage-lesson-card" data-index="${e.index}" style="background: #fff; border: 1px solid #fecaca; border-left: 5px solid #ef4444; border-radius: 8px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;" onclick="window.renderLessonByIndex(${e.index})">
              <h3 style="margin-top: 0; color: #7f1d1d; font-size: 1.1rem; margin-bottom: 0px; font-family: 'Playfair Display', serif;">${e.lesson.title}</h3>
            </div>
          `}),r+=`</div>`),e.extended&&(r+=`<h2 style="margin-top: 40px; text-align: left; color: #991b1b; border-bottom: 2px solid #fecaca; padding-bottom: 10px;"><i class="fa-solid fa-pen-nib"></i> Assessment Practice</h2>`,r+=`
        <div style="background: #fff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); margin-top: 20px; text-align: left;">
          <h3 style="margin-top: 0; color: #1e3a8a; font-size: 1.1rem; margin-bottom: 15px;">${e.extended.question}</h3>
          
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
            ${e.extended.source_a?`
              <div>
                <p style="font-size: 0.9rem; color: #475569; margin-bottom: 5px;"><strong>Source A:</strong> ${e.extended.source_a.provenance}</p>
                ${e.extended.source_a.content}
              </div>
            `:``}
            ${e.extended.source_b?`
              <div>
                <p style="font-size: 0.9rem; color: #475569; margin-bottom: 5px;"><strong>Source B:</strong> ${e.extended.source_b.provenance}</p>
                ${e.extended.source_b.content}
              </div>
            `:``}
          </div>

          ${e.extended.provenance_clue?`
            <div style="background: #fdf2f8; border: 1px solid #fbcfe8; border-left: 4px solid #ec4899; padding: 15px; border-radius: 4px; margin-top: 20px;">
              <p style="margin: 0; font-size: 0.95rem; color: #831843;"><i class="fa-solid fa-lightbulb" style="margin-right: 8px;"></i><strong>Provenance Clue:</strong> ${e.extended.provenance_clue}</p>
            </div>
          `:``}
          
          ${e.extended.scaffolding&&e.extended.scaffolding.length>0?`
...
$1
    ...
    `;let O={};t.vocab&&t.vocab.forEach(e=>{let t=e.definition||e.def||e.desc||``;t&&(O[e.term.toLowerCase()]=t)});let k=new Set,A=e=>{if(!e||typeof e!=`string`)return e||``;if(Object.keys(O).length===0)return e;let t=e,n=Object.keys(O).sort((e,t)=>t.length-e.length);for(let e of n){let n=O[e];if(!(!n||typeof n!=`string`)&&!k.has(e)){let r=RegExp(`(<[^>]+>)|\\b(${e})\\b`,`gi`),i=!1;t=t.replace(r,(e,t,r)=>t||(r?(i=!0,`<span class="vocab-word" data-definition="${n.replace(/"/g,`&quot;`)}">${r}</span>`):e)),i&&k.add(e)}}return t};if(t.teacher_notes){let e=``;if(t.teacher_notes&&!Array.isArray(t.teacher_notes)&&typeof t.teacher_notes==`object`){let n=t.teacher_notes.primer?`<div style="font-size: 1.05rem; margin-bottom: 20px;">${t.teacher_notes.primer}</div>`:``,r=t.teacher_notes.source_context?`<div style="font-size: 0.95rem; margin-bottom: 20px; background: rgba(2, 132, 199, 0.2); padding: 15px; border-left: 4px solid #38bdf8; border-radius: 4px;"><strong><i class="fa-solid fa-image"></i> Source Context:</strong><br/>${t.teacher_notes.source_context}</div>`:``,i=(t.teacher_notes.objectives||[]).map(e=>`
      ...
      `,t.narrative_blocks.forEach((t,r)=>{if(t.type===`interactive_map`){s+=`
          ...
          `;return}if(t.type===`photo_slider`){s+=`
            <div class="photo-slider-container" style="margin: 30px 0; background: #f8fafc; border: 2px solid #cbd5e1; border-radius: 12px; padding: 20px; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
              ...
              <div style="position: relative; width: 100%; max-width: 800px; margin: 0 auto; height: 400px; overflow: hidden; border-radius: 8px; border: 1px solid #e2e8f0; background: #e2e8f0;">
                <!-- After (Bottom) Image -->
                <img src="${y(t.after_image)}" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; pointer-events: none;" alt="${t.after_label||`After`}">
                ...
                <div class="slider-before-wrapper" style="position: absolute; top: 0; left: 0; width: 50%; height: 100%; overflow: hidden; border-right: 3px solid white; box-shadow: 2px 0 10px rgba(0,0,0,0.3);">
                  <img src="${y(t.before_image)}" style="position: absolute; top: 0; left: 0; width: 100vw; max-width: 800px; height: 100%; object-fit: cover; pointer-events: none;" alt="${t.before_label||`Before`}">
                </div>
              ...
              <div style="display: flex; justify-content: space-between; max-width: 800px; margin: 10px auto 0 auto; color: #64748b; font-weight: bold;">
                <span>${t.before_label||`Before`}</span>
                <span>${t.after_label||`After`}</span>
              </div>
            </div>
          `;return}if(t.type===`flip_card_gallery`){let e=`search-cards-`+Math.random().toString(36).substr(2,9);s+=`
            <div class="flip-card-gallery-wrapper" style="margin: 40px 0; background: #1e293b; border: 2px solid #0f172a; border-radius: 12px; padding: 25px; box-shadow: inset 0 2px 10px rgba(0,0,0,0.5);">
              ...
              ${t.cards&&t.cards.length>10?`
              <div style="text-align: center; margin-bottom: 30px;">
                <input type="text" id="${e}" placeholder="Search names..." onkeyup="
          ...
          `,t.cards&&Array.isArray(t.cards)&&t.cards.forEach(e=>{s+=`
                <div class="flip-card-wrapper" data-name="${e.name.replace(/"/g,`&quot;`)}" style="background-color: transparent; height: 350px; perspective: 1000px; cursor: pointer;" onclick="this.querySelector('.flip-card-inner').style.transform = this.querySelector('.flip-card-inner').style.transform === 'rotateY(180deg)' ? 'rotateY(0deg)' : 'rotateY(180deg)';">
                  <div class="flip-card-inner" style="position: relative; width: 100%; height: 100%; text-align: center; transition: transform 0.8s; transform-style: preserve-3d;">
                    ...
                    <div class="flip-card-front" style="position: absolute; width: 100%; height: 100%; backface-visibility: hidden; background-color: #334155; color: white; border-radius: 10px; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.4); border: 1px solid #475569;">
                      <h4 style="margin: 0 0 15px 0; font-size: 1.4rem; font-family: 'Playfair Display', serif; color: #f8fafc; border-bottom: 2px solid #1e293b; padding-bottom: 10px; width: 100%;">${e.name}</h4>
                      <p style="font-size: 1.05rem; font-style: italic; color: #cbd5e1; margin: 0;">${e.background}</p>
                    ...
                    <div class="flip-card-back" style="position: absolute; width: 100%; height: 100%; backface-visibility: hidden; background-color: #0f172a; color: white; transform: rotateY(180deg); border-radius: 10px; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.5); border: 2px solid #065f46; overflow-y: auto;">
                      ...
                      <p style="font-size: 1rem; line-height: 1.5; color: #e2e8f0; margin: 0;">${e.story}</p>
                    </div>
          ...
          `}t.tasks&&t.tasks.length>0&&(g+=`<div class="embedded-tasks-container" style="margin-left: 40px; margin-bottom: 25px; margin-top: -5px; padding: 15px; background: #fffbeb; border: 2px dashed #fcd34d; border-radius: 6px;">`,t.tasks.forEach((e,t)=>{if(e.type===`convict_game`){let i=`convict-game-emb-${r}-${t}`;g+=`<div id="${i}" style="margin-bottom: 20px;"></div>`,window.postRenderHooks.push(()=>{n(()=>import(`./convict_game-CSHi6PUA.js`).then(t=>{t.initConvictGame(document.getElementById(i),e)}),[])});return}if(e.type===`physician_game`){let i=`physician-game-emb-${r}-${t}`;g+=`<div id="${i}" style="margin-bottom: 20px;"></div>`,window.postRenderHooks.push(()=>{n(()=>import(`./physician_game-Cmy3CF6h.js`).then(t=>{t.initPhysicianGame(document.getElementById(i),e)}),[])});return}if(e.type===`drag_drop_timeline`){let i=`dd-timeline-emb-${r}-${t}`;g+=`<div id="${i}" style="margin-bottom: 20px;"></div>`,window.postRenderHooks.push(()=>{n(()=>import(`./drag_drop_timeline-anmBODpi.js`).then(t=>{t.initDragDropTimeline(document.getElementById(i),e)}),[])});return}if(e.type===`interactive_map`){let i=`interactive-map-emb-${r}-${t}`;g+=`<div id="${i}" style="margin-bottom: 20px;"></div>`,window.postRenderHooks.push(()=>{n(()=>import(`./interactive_map-Dvk9CYCB.js`).then(t=>{t.initInteractiveMap(document.getElementById(i),e)}),[])});return}if(e.type===`spectrum_mapper`){let i=`spectrum-emb-${r}-${t}`;g+=`<div id="${i}" style="margin-bottom: 20px;"></div>`,window.postRenderHooks.push(()=>{n(()=>import(`./spectrum_mapper-DzDMqsTS.js`).then(t=>{t.initSpectrumMapper(document.getElementById(i),e)}),[])});return}if(e.type===`multiple_choice`){g+=`<div style="margin-bottom: 20px; background: #f8fafc; padding: 15px; border-radius: 8px; border: 1px solid #e2e8f0;">
             ...
             `}),g+=`</div>`,t.flashcards&&t.flashcards.length>0&&(g+=`<div style="margin-top: 20px; padding: 20px; background: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.2); border-radius: 8px;"><div class="flashcard-deck">`,t.flashcards.forEach(e=>{let t=e.term||e.word||e.title||``,n=e.definition||e.meaning||e.desc||``;g+=`
              ...
              `}),g+=`</div></div>`)),l.includes(`</details>`)&&t.title&&t.title.includes(`Side Quest`)&&(l=l.replace(`</details>`,g+`</details>`),g=``),s+=g});let r=!1;if(t.tasks&&(r=t.tasks.some(e=>!!e.model)),t.historians_corner&&t.historians_corner.stretch_model&&(r=!0),d+=`
        <div class="phase-card">
      ...
      `;if(t.debate_prep){let n=t.debate_prep,r=[...n.arguments_for.map(e=>({t:e,s:`for`})),...n.arguments_against.map(e=>({t:e,s:`against`}))].sort(()=>Math.random()-.5).map((e,n)=>`<div class="debate-card" draggable="true" ondragstart="window.dragDebate(event)" id="debate-arg-${t.id}-${n}" data-side="${e.s}" style="background: #f8fafc; border: 1px solid #cbd5e1; padding: 10px; margin-bottom: 8px; border-radius: 6px; cursor: grab;">${e.t}</div>`).join(``);e+=`
        ...
        `}t.extended&&t.extended.paragraphs&&(t.extended.title&&(e+=`<h3 style="color: #0f172a;">${t.extended.title}</h3>`),t.extended.paragraphs.forEach(t=>{e+=`<p style="color: #334155; font-size: 1.05rem; line-height: 1.6;">${f(t)}</p>`})),e+=`</div>`,(t.debate_prep||t.extended&&t.extended.paragraphs)&&(l+=e)}let N=(window.currentUnitData||{}).id||new URLSearchParams(window.location.search).get(`id`),P=N===`early_modern_world`,F=N===`weimar_nazi_germany`||N===`cme_new`;if(_?C+=s+r+a+o+l+u+d:P?C+=r+a+(F?``:o)+s+l+u+d:C+=(F?``:o)+a+r+s+d+u+l,F&&(C+=o),t.gcse_task||t.extended&&t.extended.question||h.length>0){let e=`
        <div class="phase-card">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
