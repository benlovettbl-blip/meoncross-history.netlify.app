...
const sIdx1 = content.indexOf('          html += `\n            <div class="standard-narrative-container">');
const sIdx2 = content.indexOf('          html += `\r\n            <div class="standard-narrative-container">');

const startIndex = sIdx1 !== -1 ? sIdx1 : sIdx2;

const endMarker = '          });\n          html += `</div>`;\n        }';
const endMarker2 = '          });\r\n          html += `</div>`;\r\n        }';

let endIndex = content.indexOf(endMarker, startIndex);
if (endIndex === -1) endIndex = content.indexOf(endMarker2, startIndex);

if (startIndex === -1 || endIndex === -1) {
    console.log("Still failing!", startIndex, endIndex);
    process.exit(1);
}
...
const newContent = content.substring(0, startIndex) + replacementStr + content.substring(endIndex);
fs.writeFileSync('src/core_app.js', newContent);
console.log('Successfully patched core_app.js via robust marker search');
