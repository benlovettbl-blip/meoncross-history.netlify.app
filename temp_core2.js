...
export function initializeApp(unitData) {
  ...
  function renderHomepage() {
    ...
    `;
    if ((window.currentUnitId === 'edexcel_medicine' || (window.currentUnitData && window.currentUnitData.title && window.currentUnitData.title.includes('Medicine')))) {
      const periods = [
      ...
      const periods = [
        ...
        { id: 'KT3', title: "Key Topic 3: Nazi Control and Dictatorship", prefix: 'lesson_3_', gradient: 'linear-gradient(135deg, #4b5563, #1f2937)', border: '#1f2937', image: 'kt3_weimar_banner.png', enquiry: 'From chains to absolute control' },
        { id: 'KT4', title: "Key Topic 4: Life in Nazi Germany, 1933-39", prefix: 'lesson_4_', gradient: 'linear-gradient(135deg, #4d7c0f, #65a30d)', border: '#65a30d', image: 'kt4_weimar_banner.png', enquiry: 'Did life improve under the Nazis?' }
      ];
      periods.forEach(p => {
        lessonsHTML += `
          <div class="premium-banner">
    ...
    } else if ((window.currentUnitId === 'eee' || (window.currentUnitData && window.currentUnitData.title && window.currentUnitData.title.includes('Elizabethan')))) {
      const periods = [
        { id: 'KT1', title: 'Key Topic 1: Queen, government and religion, 1558-69', prefix: 'lesson_1_', gradient: 'linear-gradient(135deg, #4c1d95, #7c3aed)', border: '#7c3aed', image: 'kt1_eee_banner.png', enquiry: 'How did a young Queen secure a divided England?' }
      ];
      periods.forEach(p => {
        lessonsHTML += `
          <div class="premium-banner">
    ...
    if (window.currentUnitId !== 'edexcel_medicine' && window.currentUnitId !== 'cme_new' && window.currentUnitId !== 'weimar_nazi_germany') {
      ...
      `;
    } else if ((window.currentUnitId === 'edexcel_medicine' || (window.currentUnitData && window.currentUnitData.title && window.currentUnitData.title.includes('Medicine')))) {
      const pWorkbooks = [
  ...
  function renderSidebar() {
    ...
    revisionLink.innerHTML = '­ƒÄ« Revision Zone';
    ...
    examPracticeLink.innerHTML = 'Ô£ì´©Å Assessments & Exam Practice';
    ...
    quizPackLink.innerHTML = '­ƒôØ Knowledge Quiz Zone';
    ...
    const isMedicine = (window.currentUnitId === 'edexcel_medicine' || (window.currentUnitData && window.currentUnitData.title && window.currentUnitData.title.includes('Medicine')));
    ...
    // Add Quiz Pack Link for ALL units
    const qpLink = document.createElement('a');
    qpLink.className = 'lesson-link';
    qpLink.innerHTML = '<i class="fa-solid fa-file-pdf"></i> Quiz Master Pack';
    qpLink.href = window.currentUnitId ? `/${window.currentUnitId}/quiz_pack.html` : 'quiz_pack.html';
    qpLink.target = '_blank';
    qpLink.style.marginTop = '8px';
    qpLink.style.border = '2px dashed #cbd5e1';
    qpLink.style.background = '#f0fdf4';
    qpLink.style.color = '#166534';
    navContainer.appendChild(qpLink);
  }
