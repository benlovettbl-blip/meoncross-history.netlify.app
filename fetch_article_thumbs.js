...
async function getArticleThumbnail(searchTerm) {
  return new Promise((resolve) => {
    // Search for an article matching the term, get its page image
...
const lessonStarters = {
  'lesson_1_1': ["Zodiac man", "Urine wheel"],
  'lesson_1_2': ["Bloodletting", "Hôtel-Dieu de Paris"],
  'lesson_1_3': ["Black Death", "Flagellant"],
  'lesson_2_1': ["De humani corporis fabrica", "Leonardo da Vinci anatomy"],
  'lesson_2_2': ["Quackery", "Nicholas Culpeper"],
  ...
  'lesson_4_3': ["Alexander Fleming", "Penicillin"],
