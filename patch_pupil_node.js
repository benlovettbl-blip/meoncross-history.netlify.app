...
let end_loop = c.indexOf('  const filename =');
if (end_loop !== -1) {
    let before_end = c.lastIndexOf('html += `    </div>`;', end_loop);
...
console.log('Patched safely via Node block indexes.');
