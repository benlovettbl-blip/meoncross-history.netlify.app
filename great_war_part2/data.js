      ...
      "narrative_blocks": [
        ...
        },
        {
          ...
          "tasks": [
            {
              "type": "text",
              "text": "<strong>Part D: Source Analysis:</strong><br>Study Source A and Source B. Which method of recruitment do you think was more effective in convincing a 16-year-old boy to lie about his age and enlist: the official government poster, or the threat of a white feather? Explain your reasoning.",
            ...
            {
              "type": "text",
              "text": "<strong>Part F: Historical Interpretations</strong><br>1. How does historian Catriona Pennell's view of WWI volunteers differ from the traditional view?<br>2. Explain what historian Gary Sheffield means when he suggests volunteers were motivated by \"economic pragmatism.\"",
      ...
      "narrative_blocks": [
        ...
        },
        {
          ...
          "tasks": [
            {
              "type": "text",
              "text": "<strong>Part D: Task</strong><br>**Part C: Contemporary Source Analysis** 8. Study Source A. Why should a historian exercise caution when using the memoirs of a former politician like David Lloyd George to evaluate General Haig's competence?",
            ...
            {
              "type": "text",
              "text": "<strong>Part E: Source Analysis (Utility):</strong><br>How useful is Source C for a historian studying the physical conditions of trench warfare? Use the source's content and its provenance (who wrote it and when) in your answer.",
    ...
    },
    {
      ...
      "narrative_blocks": [
        ...
        },
        {
          ...
          "tasks": [
            {
              "text": "<strong>Part C: Source Utility</strong><br>Study Source A (the photograph of the British Indian Army).<br><br>How useful is Source A for an inquiry into the global nature of the First World War? (8 marks)",
            ...
            {
              "type": "text",
              "text": "<strong>Part F: Source Analysis:</strong><br>1. Why might mid-20th-century textbooks (Interpretation A) have ignored the story of Khudadad Khan and the Taranto Mutiny?<br>2. According to Interpretation B, why did the British Empire deliberately construct the narrative of a 'white man's war'?",
    ...
    },
    {
      ...
      "narrative_blocks": [
        ...
        },
        {
          ...
          "tasks": [
            {
              "text": "<strong>Part C: Evaluating Interpretations</strong><br>Study Interpretation 1 (Arthur Marwick's text arguing that the war permanently liberated women).<br><br>How far do you agree with Interpretation 1 about the impact of the war on women? Explain your answer. (16 marks + 4 SPaG)",
            ...
            {
              "type": "text",
              "text": "<strong>Part E: Source Analysis:</strong><br>Looking at Source D, why did the British government use DORA to mandate the strict censorship of soldiers' letters home? (Give two specific reasons).",
