...
| `water_and_sanitation` | KS3 (Year 7) | Water and Sanitation Through Time | 🟩 **GREEN**<br>(100% Complete — 6 Enquiries 4-Act) | 🟩 **GREEN**<br>(Mastery Pack & Workbook 0px Overflow) | Production Ready / Modernised | **COMPLETE:** Christine Counsell 4-Act disciplinary architecture, single Act 4 scaffolded enquiry, and 0px overflow verified. |
| `early_modern_world` | KS3 (Year 8) | Early Modern World & Global Encounters (1450–1750) | 🟩 **GREEN**<br>(100% Complete — 9 Enquiries 4-Act) | 🟩 **GREEN**<br>(Mastery Pack & Workbook 0px Overflow) | Modernised & Production Ready | **COMPLETE:** Christine Counsell 4-Act architecture, single Act 4 scaffolded enquiry (0 treadmill tasks), duplicate lesson_4 resolved, and 0px overflow verified. |
| `great_war` | KS3 (Year 9) | Causes of the Great War (1870–1914) | 🟩 **GREEN**<br>(100% Complete — 6 Enquiries 4-Act) | 🟩 **GREEN**<br>(14-Page Publisher Textbook 0px Overflow) | Production Ready / Modernised | **COMPLETE:** Christine Counsell 4-Act disciplinary architecture, single Act 4 scaffolded enquiry, and 14-page publisher textbook compiled with 0px overflow. |
