  ...
  "lessons": [
    ...
    },
    {
      ...
      "narrative": [
        ...
        "To keep towns from drowning in filth, councils employed specialized laborers called 'gongfermers.' Working strictly under the cover of night, these workers climbed into filthy, barrel-lined cesspits to shovel out human waste and cart it outside the town walls.",
        "In 1357, King Edward III sent a letter to the Mayor of London warning that the filth lying in the streets was infecting the air and causing deadly sickness, ordering immediate removal of waste to preserve public health."
      ],
      "tasks": [
        {
    ...
    },
    {
      ...
      "narrative": [
        ...
        "By 1700, London's population had exploded, yet municipal systems did not match this growth. Poorer townspeople still had to buy river water from water sellers who hauled large wooden barrels on horseback through the streets, or gather water from public conduits."
      ],
      "tasks": [
        {
    ...
    },
    {
      ...
      "sources": [],
      "narrative": [
        "Between 1750 and 1850, Britain's population skyrocketed from 6 million to 21 million. Thousands of rural families flooded into expanding cities to work in steam-powered factories and coal mines, resulting in rapid urbanization and intense crowding.",
        "Landlords built cheap, back-to-back terraced brick housing blocks with shared yards. Poorer families did not have indoor running water, relying on shared street pumps which only supplied water for a few hours a day, which was often brown and polluted.",
        "Cholera, a terrifying waterborne disease, struck Britain for the first time in 1831, causing rapid dehydration and death. Over 31,000 people died in the first epidemic, triggering national panic and highlighting the failure of municipal public health.",
        "Poor Law Commissioner Edwin Chadwick published his landmark Report on the Sanitary Condition of the Labouring Population, documenting the filth, damp, and overcrowded conditions of the working class and advocating for drainage and clean water."
      ],
      "tasks": [
        {
    ...
    },
    {
      ...
      "sources": [],
      "narrative": [
        "During the 1854 cholera outbreak in Soho, Dr. John Snow mapped locations of deaths and traced the infection directly to the Broad Street pump, proving cholera was waterborne rather than spread by miasma (bad air). Removing the pump handle stopped the Soho outbreak.",
        "A hot summer in 1858 caused the raw sewage in the River Thames to smell so overpowering that it disrupted parliamentary meetings, forcing politicians to finally fund rebuilds of the capital's sanitation networks.",
        "Between 1858 and 1865, engineer Joseph Bazalgette designed and constructed a spectacular network of 1,300 miles of brick sewers beneath London. This diverted waste away from the River Thames, saving thousands of working-class lives.",
        "French scientist Louis Pasteur proved Germ Theory in 1860, showing that microscopic organisms cause disease rather than bad smells, providing definitive scientific backing for sanitation and hygiene.",
        "Parliament passed the Public Health Act, forcing local councils to take legal responsibility for ensuring every citizen had clean piped water and home sewer connections, ending laissez-faire sanitation."
      ],
      "tasks": [
        {
