    ...
    "lessons": [
        {
            ...
            "vocab": [
                {
                    ...
                    "def": "A rigid social hierarchy where inequality was accepted and everyone 'knew their place', with the monarch at the top appointed by God."
                },
                {
                    "term": "Patronage",
                    "def": "A system where the monarch maintained control and secured loyalty by rewarding followers with land, titles, or monopolies."
                },
                {
                    "term": "Privy Council",
                    "def": "A group of roughly 19 trusted nobles and advisers responsible for the day-to-day administration of the country."
                },
                {
                    "term": "Queen Regnant",
                    "def": "A queen who rules in her own right with actual power, rather than just being the wife of a king."
                },
                {
                    "term": "Legitimacy",
                    "def": "The lawful and rightful claim of a monarch to rule. Catholics rejected Elizabeth's legitimacy as they did not recognise her parents' marriage."
                },
                {
                    "term": "Debasement",
                    "def": "The process of reducing the amount of precious metal (like silver) in a coin to mint more money, which causes massive inflation."
                },
                {
                    "term": "Auld Alliance",
                    "def": "The traditional, historical military alliance between France and Scotland, posing a direct threat to England's northern border."
                }
            ],
            "narrative": [
                {
                    "title": "The Structure of Society and Government",
                    ...
                    "caption": "Queen Elizabeth I ascended to the throne in 1558 at the age of 21, inheriting a divided and vulnerable England."
                },
                {
                    "title": "The Virgin Queen: Legitimacy, Gender, and Marriage",
                    ...
                    "caption": "A depiction of the Tudor court. Elizabeth faced immense pressure to marry, but doing so risked surrendering her hard-won authority."
                },
                {
                    "title": "Advanced Analysis: Financial Weaknesses at Home",
                    ...
                    "image": "/assets/placeholder_cover.jpg",
                    "caption": "The debasement of coinage during the 1540s had caused rampant inflation, compounding the immense £300,000 debt Elizabeth inherited."
                },
                {
                    "title": "The Threat from Abroad: France and Scotland",
                    "text": "England was isolated and surrounded by Catholic superpowers. Elizabeth inherited a war with France from Mary I, which ended in the Treaty of Cateau-Cambrésis in 1559, formally surrendering Calais. France remained a dangerous enemy with a larger population and greater wealth.\n\nCrucially, France was allied with England's northern neighbour, Scotland, through the \"Auld Alliance\". Scotland was ruled by Mary of Guise on behalf of her daughter, Mary, Queen of Scots. French troops were stationed in Scotland, placing a hostile force directly on England's border and creating the threat of a joint invasion. To defuse the immediate French threat, Elizabeth eventually signed the Peace of Troyes in 1564, definitively recognising the French claim to Calais to avoid further war.",
                    "image": "/assets/placeholder_cover.jpg",
                    "caption": "The 'Auld Alliance' between France and Scotland placed Catholic French troops on England's northern border, presenting a two-front threat."
                }
            ],
            "tasks": [
                {
                    "type": "drag_drop",
                    "question": "Categorise these Tudor groups into the correct social sphere.",
                    "categories": ["Rural Hierarchy", "Town Hierarchy"],
                    "items": [
                        { "text": "Nobility", "category": "Rural Hierarchy" },
                        { "text": "Yeomen", "category": "Rural Hierarchy" },
                        { "text": "Tenant farmers", "category": "Rural Hierarchy" },
                        { "text": "Wealthy merchants", "category": "Town Hierarchy" },
                        { "text": "Professionals", "category": "Town Hierarchy" },
                        { "text": "Craftsmen", "category": "Town Hierarchy" }
                    ]
                },
                {
                    "type": "comprehension",
                    "questions": [
                        "How old was Elizabeth when she ascended to the throne in 1558?",
                        ...
                        "Roughly how many trusted nobles and advisers made up the Privy Council?",
                        "Who was Elizabeth's most important minister and Secretary of State?",
                        "How many times was Parliament called during Elizabeth's entire reign?",
                        "Why did the Pope view Elizabeth as illegitimate?",
                        ...
                        "What was the Crown's annual revenue when Elizabeth became queen?",
                        "How much money was owed to the Antwerp Exchange?",
                        ...
                        "How did Elizabeth remarkably clear the Crown's debt by 1574?",
                        "What 1559 treaty ended the war with France and surrendered Calais?",
                        "What was the name of the traditional alliance between France and Scotland?",
            ...
            "exam_practice": {
                "question": "Describe two features of Elizabeth’s financial problems in 1558. (4 marks)",
