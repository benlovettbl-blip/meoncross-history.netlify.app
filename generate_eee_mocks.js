...
<body>
  ...
  <div class="page">
    ...
    <div class="exam-header">
      <div class="exam-header-left">
        ...
        <div class="booklet-title">BOOKLET B4: Early Elizabethan England, 1558-88</div>
      </div>
      <div class="exam-header-right">
        <div class="paper-ref-label">Paper<br>reference</div>
        <div class="paper-ref-val">` + mock.paper_reference + `</div>
      </div>
    </div>
    ...
    <div class="instructions-section">
      ...
      <ul>
        ...
        <li>There are two booklets in this question paper. <strong>This is booklet B.</strong></li>
        <li>Answer questions 1(a), 1(b), 2 and <strong>either 3 or 4</strong> in this booklet.</li>
        <li>Check you have the corresponding booklet P.</li>
    ...
    <div class="instructions-section">
      ...
      <ul>
        ...
        <li><strong>Do not forget to complete booklet P.</strong></li>
      </ul>
    </div>
    ...
    <div class="footer">
      <div>&copy;2026 Pearson Education Ltd.</div>
  ...
  <!-- End of booklet -->
  <div class="page">
    <div class="page-inner" style="display:flex; justify-content:center; align-items:center;">
       <div style="text-align:center; font-weight:bold; font-size: 16px;">
           PLEASE ENSURE YOU ALSO COMPLETE BOOKLET P.
       </div>
    </div>
  </div>
  <div class="page">
    <div class="page-inner" style="display:flex; flex-direction:column; justify-content:center; align-items:center;">
       <div style="text-align:center; font-weight:bold; font-size: 16px;">BLANK PAGE</div>
       <div style="text-align:center; font-weight:bold; font-size: 16px; margin-top:20px;">DO NOT WRITE ON THIS PAGE</div>
    </div>
  </div>
...
function generateQuestions(mock, isMarkScheme = false) {
  ...
  html += '<div class="inner-header">Early Elizabethan England, 1558-88<br><br>Answer Question 1(a), Question 1(b), Question 2 and EITHER Question 3 OR Question 4.</div>';
  
  const q1a = mock.questions[0];
  html += '<div class="question-block">';
  html += '  <div class="question-text">';
  html += '    <div class="question-num">1</div>';
  html += '    <div style="width: 100%;">';
  html += '      (a) ' + q1a.text.replace(/\n/g, '<br>');
  html += '      <span style="float: right; font-weight: 400; color: #444;">(' + q1a.marks + ')</span>';
  html += '    </div>';
  html += '  </div>';
  html += '</div>';
  ...
  const q1b = mock.questions[1];
  html += '<div class="question-block">';
  html += '  <div class="question-text">';
  html += '    <div class="question-num"></div>';
  html += '    <div style="width: 100%;">';
  html += '      (b) ' + q1b.text.replace(/\n/g, '<br>');
  html += '      <span style="float: right; font-weight: 400; color: #444;">(' + q1b.marks + ')</span>';
  html += '    </div>';
  html += '  </div>';
  html += '</div>';
  ...
  html += '</div><div class="footer"><div></div><div></div></div></div>'; // No turn over on page 2 according to PDF


  // Page 3, 4, 5: Question 2 (12 marks)
  const q2 = mock.questions[2];
  html += '<div class="page"><div class="page-inner">';
  html += '<div class="question-block">';
  html += '  <div class="question-text">';
  html += '    <div class="question-num">2</div>';
  html += '    <div style="width: 100%;">';
  html += '      ' + q2.text.replace(/\n/g, '<br>');
  html += '      <span style="float: right; font-weight: 400; color: #444;">(' + q2.marks + ')</span>';
  html += '    </div>';
  html += '  </div>';
  html += '  <div class="bullet-point-box">';
  html += '    <em>You <strong>may</strong> use the following in your answer:</em>';
  html += '    <ul>';
  html += q2.bullet_points.map(bp => '<li>' + bp + '</li>').join('');
  html += '    </ul>';
  html += '    <em style="display:block; margin-top:10px;">You <strong>must</strong> also use information of your own.</em>';
  html += '  </div>';
  html += '</div>';
  ...
  const q3 = q34.options[0];
  const q4 = q34.options[1];

  html += '<div class="page"><div class="page-inner">';
  html += '<div style="text-align:center; font-weight:bold; margin-bottom: 20px;">Answer EITHER Question 3 OR Question 4.</div>';
  
  html += '<div style="font-weight:bold; margin-bottom:10px;">EITHER</div>';
  html += '<div class="question-block">';
  html += '  <div class="question-text">';
  html += '    <div class="question-num">3</div>';
  html += '    <div style="width: 100%;">';
  html += '      ' + q3.text.replace(/\n/g, '<br><br>');
  html += '    </div>';
  html += '  </div>';
  html += '  <div class="bullet-point-box">';
  html += '    <em>You <strong>may</strong> use the following in your answer:</em>';
  html += '    <ul>';
  html += q3.bullet_points.map(bp => '<li>' + bp + '</li>').join('');
  html += '    </ul>';
  html += '    <em style="display:block; margin-top:10px;">You <strong>must</strong> also use information of your own.</em>';
  html += '  </div>';
  html += '</div>';
  html += '<div style="border-top: 1px solid #ccc; margin-top: 20px; padding-top: 10px; text-align: right; font-weight: bold;">(Total for Question 3 = 16 marks)</div>';

  html += '<div style="font-weight:bold; margin:20px 0 10px 0;">OR</div>';
  
  html += '<div class="question-block">';
  html += '  <div class="question-text">';
  html += '    <div class="question-num">4</div>';
  html += '    <div style="width: 100%;">';
  html += '      ' + q4.text.replace(/\n/g, '<br><br>');
  html += '    </div>';
  html += '  </div>';
  html += '  <div class="bullet-point-box">';
  html += '    <em>You <strong>may</strong> use the following in your answer:</em>';
  html += '    <ul>';
  html += q4.bullet_points.map(bp => '<li>' + bp + '</li>').join('');
  html += '    </ul>';
  html += '    <em style="display:block; margin-top:10px;">You <strong>must</strong> also use information of your own.</em>';
  html += '  </div>';
  html += '</div>';
  html += '<div style="border-top: 1px solid #ccc; margin-top: 20px; padding-top: 10px; text-align: right; font-weight: bold;">(Total for Question 4 = 16 marks)</div>';
  
  html += '</div><div class="footer"><div></div><div></div></div></div>'; // No turn over on page 6


  // Page 7: Checkbox and writing start
  html += '<div class="page"><div class="page-inner">';
  html += '<div class="indicate-choice">';
  html += '  Indicate which question you are answering by marking a cross in the box <span style="font-weight:900;">&#9746;</span>. If you change your mind, put a line through the box <span style="font-weight:900;">&#9746;</span> and then indicate your new question with a cross <span style="font-weight:900;">&#9746;</span>.<br><br>';
  html += '  Chosen question number: ';
  html += '  <span style="margin-left: 10px;">Question 3</span> <div class="checkbox-inline"></div>';
  html += '  Question 4 <div class="checkbox-inline"></div>';
  html += '</div>';
...
if (!fs.existsSync('public/units/eee')) {
  fs.mkdirSync('public/units/eee', { recursive: true });
}
