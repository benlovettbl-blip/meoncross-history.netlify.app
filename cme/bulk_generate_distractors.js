...
async function run() {
  ...
  if (examSkillsIdx === -1) {
    console.error("Error: Could not locate EXAM_SKILLS_DATA in questions.js. Writing full file instead.");
    fs.writeFileSync(filePath, `const QUIZ_DATA = ${JSON.stringify(QUIZ_DATA, null, 2)};\n`, 'utf8');
  } else {
