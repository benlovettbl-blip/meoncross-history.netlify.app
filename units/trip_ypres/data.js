...
export const unitData = {
  ...
  local_heroes: [
    ...
    },
    {
      ...
      connection:
        'Great-great-grandfather of Aby (Year 10, Meoncross School). Middle name Ernest given in his honour. Family archive researched by grandfather John Pearson and preserved by the Pearson family.',
      ...
      story:
        'Born at Rawmarsh, Rotherham, son of a puddler at Parkgate Ironworks. Enlisted in 1914 in the 1/5th York & Lancs, fought at Festubert (1915), held the Yser Canal at Boesinghe facing the first phosgene gas attack (1915), and was awarded the DCM and Russian Medal of St George on the Somme (1916) for rescuing 2nd Lt Marcus Goodall (friend of Siegfried Sassoon). Commissioned from the ranks into the 1/4th (attd. 6th) Battalion and awarded the Military Cross at Canal du Nord (1918). Survived to become a revered community leader in Dinnington, passing away in 1958 at age 73.',
  ...
  <div style="background: #f1f5f9; border-radius: 6px; padding: 14px 18px; border: 1px dashed #94a3b8;">
    ...
    },
    {
      ...
      tasks: [
        ...
        "The Human Reality Behind War Poetry: Grandfather John Pearson's research proved that 2nd Lt Marcus Goodall—rescued under fire by Sergeant Crummack in Thiepval Wood—was the close friend of poet Siegfried Sassoon. Read Sassoon's elegy for Goodall. Explain why personal acts of courage like Crummack's provide a vital counterweight to the bitter disillusionment often depicted in Great War poetry.",
        ...
        "Family Archives as Primary Evidence: Reflect on how Aby's family preserved Ernest's memory through five generations, culminating in his grandfather John Pearson's historical research dossier. Why are pupil family archives uniquely powerful in keeping the reality of the First World War alive for 21st-century students?",
      ],
    },
  ],
