...
export const unitData = {
  ...
  local_heroes: [
    ...
    },
    {
      ...
      connection:
        'Ancestor of a Year 10 Meoncross pupil. Family archive researched by family historian John Pearson and preserved by the family.',
...
<div style="background: #f8fafc; border: 1.5px solid #cbd5e1; border-radius: 8px; padding: 22px; margin-bottom: 25px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
  ...
  <div style="background: #f1f5f9; border-radius: 6px; padding: 14px 18px; border: 1px dashed #94a3b8;">
    ...
    {
      id: 'hero_crummack',
      title: '2nd Lieutenant E. E. Crummack MC, DCM (Pupil Family Hero · Year 10 Family)',
      enquiry:
      ...
      tasks: [
        ...
        "The Human Reality Behind War Poetry: Family historian John Pearson's research proved that 2nd Lt Marcus Goodall—rescued under fire by Sergeant Crummack in Thiepval Wood—was the close friend of poet Siegfried Sassoon. Read Sassoon's elegy for Goodall. Explain why personal acts of courage like Crummack's provide a vital counterweight to the bitter disillusionment often depicted in Great War poetry.",
        ...
        "Family Archives as Primary Evidence: Reflect on how a pupil's family preserved Ernest's memory through generations, culminating in family historian John Pearson's research dossier. Why are pupil family archives uniquely powerful in keeping the reality of the First World War alive for 21st-century students?",
      ],
    },
  ],
