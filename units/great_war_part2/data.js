  ...
  lessons: [
      ...
      vocab: [
        {
          term: 'Stalemate',
          definition:
            'A deadlocked military situation in which neither side can make progress or defeat the other.',
        },
        {
          term: "No Man's Land",
          definition:
            'The barren, shell-torn ground lying between the opposing forward trenches of rival armies.',
        },
        {
          term: 'Artillery',
          definition:
            'Heavy long-range guns and howitzers that inflicted over 60% of all combat casualties in the Great War.',
        },
        {
          term: 'Attrition',
          definition:
            'A military strategy aiming to wear down the enemy through continuous, gradual loss of men and material.',
        },
        {
          term: 'Trench Foot',
          definition:
            'A painful medical condition caused by prolonged exposure to cold mud and water, risking gangrene.',
        },
        {
          term: 'General Haig',
          definition:
            "The Commander-in-Chief of the British forces on the Western Front, controversially dubbed 'The Butcher of the Somme'.",
        },
      ],
      video: [
        {
      ...
      vocab: [
        {
          term: 'Eurocentric',
          definition:
            'Focusing exclusively on European culture and history to the exclusion of other global perspectives.',
        },
        {
          term: 'British West Indies Regiment (BWIR)',
          definition:
            'The military unit composed of volunteers from the Caribbean who faced racism and unequal pay.',
        },
        {
          term: 'Indian Army',
          definition:
            'Over one million soldiers from undivided India who fought in France, Gallipoli, and the Middle East.',
        },
        {
          term: 'Racial Hierarchy',
          definition:
            'The discriminatory imperial belief that white Europeans were superior to colonized Black and Asian peoples.',
        },
        {
          term: 'Historical Amnesia',
          definition:
            'The collective forgetting or omission of crucial historical groups and events from national memory.',
        },
        {
          term: 'Mutiny',
          definition:
            'An open rebellion against the orders of military or naval commanding officers.',
        },
      ],
      flashcards: [
        {
    ...
    },
    {
      ...
      vocab: [
        {
          term: 'Total War',
          definition:
            'A conflict involving the complete mobilization of an entire society, economy, and population, blurring civilian-soldier lines.',
        },
        {
          term: 'Defence of the Realm Act (DORA)',
          definition:
            'Emergency legislation passed in 1914 granting the British government sweeping powers to control daily civilian life.',
        },
        {
          term: 'Censorship',
          definition:
            'The government suppression of newspapers, letters, and reporting to protect military secrets and morale.',
        },
        {
          term: 'Conscientious Objector',
          definition:
            'An individual who refused military service on religious, moral, or political grounds.',
        },
        {
          term: 'Conscription',
          definition:
            'The legal compulsion of citizens to enroll in the armed services during wartime.',
        },
        {
          term: 'Rationing',
          definition:
            'The controlled distribution of scarce food and fuel supplies introduced in Britain in 1918.',
        },
      ],
      narrative_blocks: [
        {
      ...
      vocab_deliberate_error:
        'Under the Defence of the Realm Act (DORA), the British government banned all Conscription and abolished wartime Rationing, allowing Conscientious Objectors to publish anti-war newspapers without any state Censorship.',
    },
    {
      id: 'lesson_5',
      title:
      ...
      vocab: [
        {
          term: 'Armistice',
          definition:
            'An agreement made by opposing sides in a war to stop fighting; specifically 11 November 1918.',
        },
        {
          term: 'Treaty of Versailles',
          definition:
            'The 1919 peace settlement signed in the Hall of Mirrors that imposed harsh penalties on defeated Germany.',
        },
        {
          term: 'War Guilt Clause (Article 231)',
          definition:
            'The controversial article forcing Germany to accept sole moral responsibility for causing the war.',
        },
        {
          term: 'Reparations',
          definition:
            'Massive financial payments demanded by the Allies to compensate for wartime damage and civilian destruction.',
        },
        {
          term: 'Demilitarised Zone',
          definition:
            'An area where military forces, installations, and activities are forbidden, such as the Rhineland.',
        },
        {
          term: 'Diktat',
          definition:
            'The bitter German term for the Versailles treaty, meaning a dictated peace signed under duress.',
        },
      ],
      narrative_blocks: [
        {
      ...
      vocab: [
        {
          ...
          definition:
            'The cohort of young men who died in disproportionate numbers during the First World War.',
        },
        {
          term: 'Commemoration',
          definition:
            'The act of honoring and remembering those who sacrificed their lives in wartime.',
        },
        {
          term: 'War Memorial',
          definition:
            'A physical monument erected in towns and villages bearing the names of local servicemen killed in action.',
        },
        {
          term: 'Armistice Day',
          definition:
            'The annual day of remembrance observed on 11 November to honor the fallen of the armed forces.',
        },
        {
          term: 'Micro-History',
          definition:
            'The historical study of small, localized communities or individuals to illuminate wider national trends.',
        },
        {
          term: 'Historical Empathy',
          definition:
            'The capacity to understand the thoughts, emotions, and decisions of people in the past based on historical evidence.',
        },
      ],
      narrative_blocks: [
        {
      ...
      vocab: [
        {
          term: 'Total War',
          definition:
            'A global conflict requiring the mobilization of all national resources, factories, and civilians.',
        },
        {
          term: 'Trench Warfare',
          definition:
            "Combat conducted from opposing systems of fortified trenches separated by No Man's Land.",
        },
        {
          term: 'Attrition',
          definition:
            'The gradual grinding down of an enemy army through unrelenting combat losses.',
        },
        {
          term: 'Propaganda',
          definition:
            'Government-directed information campaigns designed to mobilize recruits and maintain civilian morale.',
        },
        {
          term: 'Armistice',
          definition:
            'The agreement to cease active combat operations signed on the eleventh hour of 11 November 1918.',
        },
        {
          term: 'Treaty of Versailles',
          definition:
            'The 1919 peace treaty that redrew the borders of Europe and imposed harsh penalties on Germany.',
        },
      ],
      learning_objectives: [
