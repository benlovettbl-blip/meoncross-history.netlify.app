  ...
  lessons: [
    {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Vocabulary in Context: What was royal patronage, and why was it an essential tool for Elizabeth in maintaining political control across England?',
              model:
                "Patronage was the monarch's distribution of prestigious titles, Crown offices, monastic lands, and trading monopolies to powerful nobles. Because Elizabeth possessed neither a standing army nor a national police force, patronage bound influential magnates to the Crown by making their wealth and social status directly dependent on their absolute loyalty to the Queen.",
              model_answer:
                "Patronage was the monarch's distribution of prestigious titles, Crown offices, monastic lands, and trading monopolies to powerful nobles. Because Elizabeth possessed neither a standing army nor a national police force, patronage bound influential magnates to the Crown by making their wealth and social status directly dependent on their absolute loyalty to the Queen.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Diamond Ranking Challenge: Which of Elizabeth's 1558 problems—Gender/Legitimacy, Financial Debt, or Catholic Foreign Powers—posed the most imminent danger to her survival? Justify your judgement.",
              model:
                'The Catholic foreign alliance between France and Scotland was the most imminent danger because it presented an immediate military invasion threat. While debt and gender undermined domestic governance, an armed Franco-Scottish campaign landing in the north to replace Elizabeth with Mary Stuart would have ended Tudor rule permanently before domestic reforms could take effect.',
              model_answer:
                'The Catholic foreign alliance between France and Scotland was the most imminent danger because it presented an immediate military invasion threat. While debt and gender undermined domestic governance, an armed Franco-Scottish campaign landing in the north to replace Elizabeth with Mary Stuart would have ended Tudor rule permanently before domestic reforms could take effect.',
            },
          ],
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Patronage', 'Feudalism', 'The Privy Council', 'Divine Right'],
          answer: 0,
        },
        {
        ...
        },
        {
          ...
          options: ['Robert Dudley', 'Francis Walsingham', 'William Cecil', 'Thomas Cromwell'],
          answer: 2,
        },
        {
          question: "How many times was Parliament called during Elizabeth's entire reign?",
          options: ['Every year', 'Nine times', 'Fifteen times', 'It was never called'],
          answer: 1,
        },
        {
        ...
        },
        {
          ...
          options: ['Queen Consort', 'Queen Regnant', 'Empress', 'Queen Mother'],
          answer: 1,
        },
        {
        ...
        },
        {
          ...
          options: ['£150,000', '£286,667', '£400,000', '£500,000'],
          answer: 1,
        },
        {
        ...
        },
        {
          ...
          options: ['Mary I', 'Mary of Guise', 'Mary, Queen of Scots', 'Catherine of Aragon'],
          answer: 2,
        },
        {
          question:
    ...
    },
    {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "What was the core religious objective of Elizabeth's 'Middle Way' (Via Media) in 1559?",
              model:
                'The Middle Way aimed to establish a broad, inclusive national church that satisfied moderate Protestants through Protestant doctrine (such as an English Book of Common Prayer) while retaining familiar Catholic outward appearances (such as clerical vestments and decorated altars), thereby averting religious civil war.',
              model_answer:
                'The Middle Way aimed to establish a broad, inclusive national church that satisfied moderate Protestants through Protestant doctrine (such as an English Book of Common Prayer) while retaining familiar Catholic outward appearances (such as clerical vestments and decorated altars), thereby averting religious civil war.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Why was the Church of England the Crown's most vital instrument for maintaining political order and national communication?",
              model:
                'In an era before mass printing, telephones, or national police, the parish church was the primary medium through which government proclamations, royal prayers, and moral obedience were delivered to every community each Sunday, ensuring social stability and immediate enforcement of Crown policy.',
              model_answer:
                'In an era before mass printing, telephones, or national police, the parish church was the primary medium through which government proclamations, royal prayers, and moral obedience were delivered to every community each Sunday, ensuring social stability and immediate enforcement of Crown policy.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Who were the Puritans, and why did they fiercely condemn Elizabeth's Middle Way?",
              model:
                "Puritans were radical, zealous Protestants influenced by John Calvin who sought to 'purify' the Church of all unscriptural Catholic survivals. They condemned the Middle Way because retaining clerical vestments, kneeling for communion, and bishoprics smacked of 'papist superstition' and idolatry.",
              model_answer:
                "Puritans were radical, zealous Protestants influenced by John Calvin who sought to 'purify' the Church of all unscriptural Catholic survivals. They condemned the Middle Way because retaining clerical vestments, kneeling for communion, and bishoprics smacked of 'papist superstition' and idolatry.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Why did Elizabeth initially pursue a policy of calculated leniency towards Catholic recusants in the 1560s?',
              model:
                "Elizabeth famously stated she did not wish to 'make windows into men's souls', intentionally avoiding aggressive persecution to prevent creating Catholic martyrs or provoking an armed Catholic rebellion, calculating that without confrontation, traditional Catholicism would quietly die out over time.",
              model_answer:
                "Elizabeth famously stated she did not wish to 'make windows into men's souls', intentionally avoiding aggressive persecution to prevent creating Catholic martyrs or provoking an armed Catholic rebellion, calculating that without confrontation, traditional Catholicism would quietly die out over time.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "The 'But/Because/So' Strategy: Complete the sentence: Elizabeth's 1559 Settlement was a masterpiece of political pragmatism, BUT...",
              model:
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Crucifixes', 'Bibles', 'Altars', 'Stained glass windows'],
          answer: 0,
        },
        {
          question:
    ...
    },
    {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Causal Linkage: How did the 1566 'Vestments Controversy' demonstrate Elizabeth's determination to impose royal uniformity?",
              model:
                "When Puritan clergy refused to wear the required traditional surplice, viewing it as popish, Archbishop Parker issued the 'Book of Advertisements' enforcing conformity. When 37 London priests refused to comply, Elizabeth had them immediately dismissed, demonstrating that royal supremacy took precedence over individual Puritan conscience.",
              model_answer:
                "When Puritan clergy refused to wear the required traditional surplice, viewing it as popish, Archbishop Parker issued the 'Book of Advertisements' enforcing conformity. When 37 London priests refused to comply, Elizabeth had them immediately dismissed, demonstrating that royal supremacy took precedence over individual Puritan conscience.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Why did the domestic Catholic threat escalate into an acute danger by the late 1560s?',
              model:
                "The Catholic threat intensified because the arrival of Mary, Queen of Scots in England in 1568 provided a living, legitimate Catholic alternative to Elizabeth, while Catholic nobility in the North resented their exclusion from royal power by Cecil's southern Protestant faction.",
              model_answer:
                "The Catholic threat intensified because the arrival of Mary, Queen of Scots in England in 1568 provided a living, legitimate Catholic alternative to Elizabeth, while Catholic nobility in the North resented their exclusion from royal power by Cecil's southern Protestant faction.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Constrained Summary: In two precise sentences, explain why Elizabeth was caught between two unyielding religious extremes by 1570.',
              model:
                'Puritan reformers relentlessly pressured Parliament to strip all ceremonial compromise from the Elizabethan Church, challenging royal supremacy from within. Simultaneously, the Papal excommunication and Counter-Reformation branded Elizabeth a heretic to be overthrown, transforming passive Catholic observance into active state treason.',
              model_answer:
                'Puritan reformers relentlessly pressured Parliament to strip all ceremonial compromise from the Elizabethan Church, challenging royal supremacy from within. Simultaneously, the Papal excommunication and Counter-Reformation branded Elizabeth a heretic to be overthrown, transforming passive Catholic observance into active state treason.',
            },
          ],
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Crucifixes', 'Bibles', 'Altars', 'Pews'],
          answer: 0,
        },
        {
        ...
        },
        {
          ...
          options: ['The North / North-West', 'The South-East', 'London', 'Wales'],
          answer: 0,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Douai, in the Netherlands', 'Paris, France', 'Rome, Italy', 'Madrid, Spain'],
          answer: 0,
        },
        {
          question:
    ...
    },
    {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Why was Mary, Queen of Scots' claim to the English throne exceptionally strong and dangerous for Elizabeth?",
              model:
                "As Henry VII's great-granddaughter, Mary had unbroken royal Tudor blood. Because the Catholic Church deemed Henry VIII's marriage to Anne Boleyn illegal, Catholics across Europe and England regarded Mary Stuart as the legitimate reigning Queen of England and Elizabeth as a usurper.",
              model_answer:
                "As Henry VII's great-granddaughter, Mary had unbroken royal Tudor blood. Because the Catholic Church deemed Henry VIII's marriage to Anne Boleyn illegal, Catholics across Europe and England regarded Mary Stuart as the legitimate reigning Queen of England and Elizabeth as a usurper.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "The 'But/Because/So' Strategy: Complete the sentence: Mary fled to England seeking Elizabeth's military protection, BUT...",
              model:
                'Mary fled to England seeking protection, BUT Elizabeth could neither help her nor execute her BECAUSE backing Mary would anger Scottish Protestants while killing a crowned queen would provoke an invasion from Catholic France and Spain, SO Elizabeth kept Mary under house arrest for nineteen years.',
              model_answer:
                'Mary fled to England seeking protection, BUT Elizabeth could neither help her nor execute her BECAUSE backing Mary would anger Scottish Protestants while killing a crowned queen would provoke an invasion from Catholic France and Spain, SO Elizabeth kept Mary under house arrest for nineteen years.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Diamond Ranking Challenge: Which factor made Mary Stuart most dangerous to Elizabeth: (A) Her royal bloodline, (B) Her Catholic religion, or (C) Her physical imprisonment in England? Justify your choice.',
              model:
                "Her physical imprisonment in England was the most dangerous factor. While her lineage and faith provided the ideological pretext, her physical presence on English soil transformed her into an immediate focal point and rallying figure for northern rebels, Jesuit agents, and foreign assassins plotting Elizabeth's murder.",
              model_answer:
                "Her physical imprisonment in England was the most dangerous factor. While her lineage and faith provided the ideological pretext, her physical presence on English soil transformed her into an immediate focal point and rallying figure for northern rebels, Jesuit agents, and foreign assassins plotting Elizabeth's murder.",
            },
          ],
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['King Henry VII', 'King Henry VIII', 'King Edward VI', 'King Richard III'],
          answer: 0,
        },
        {
        ...
        },
        {
          ...
          options: ['France', 'Spain', 'The Netherlands', 'Italy'],
          answer: 0,
        },
        {
    ...
    },
    {
      ...
      video: [
        {
          ...
          model_answer:
            "Causes: Catholic Earls (Northumberland and Westmorland) wanted to restore Catholicism and felt sidelined by Elizabeth's Protestant advisors like Cecil.\nFailure: Lack of widespread support, Elizabeth moved Mary Queen of Scots, and the Earl of Sussex raised a massive royal army.",
        },
        {
          type: 'youtube',
          ...
          model_answer:
            "Walsingham intercepted Mary's letters hidden in beer barrels. He deciphered them and waited until Mary explicitly approved the plot to assassinate Elizabeth, giving him the undeniable treasonous evidence needed to execute her.",
        },
        {
          type: 'era',
          ...
          model_answer:
            'Walsingham used a vast network of informers, double agents, and codebreakers (like Thomas Phelippes). He intercepted letters, used torture to extract confessions, and employed agents provocateurs to draw out conspirators.',
        },
      ],
      teacher_notes: {
        primer:
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'What combination of religious loyalty and political grievance motivated the Northern Earls to rebel in 1569?',
              model:
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "How did the 1570 Papal Bull transform the English government's treatment of Catholic recusants during the 1570s and 1580s?",
              model:
                'Because the Pope explicitly ordered English Catholics to depose Elizabeth, the Crown viewed Catholicism as active treason rather than private conscience. Parliament passed draconian laws in 1581 making conversion to Catholicism high treason, raising recusancy fines to a ruinous £20 a month, and sentencing newly arrived Catholic priests to hanging, drawing, and quartering.',
              model_answer:
                'Because the Pope explicitly ordered English Catholics to depose Elizabeth, the Crown viewed Catholicism as active treason rather than private conscience. Parliament passed draconian laws in 1581 making conversion to Catholicism high treason, raising recusancy fines to a ruinous £20 a month, and sentencing newly arrived Catholic priests to hanging, drawing, and quartering.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Vocabulary in Context: What techniques did Sir Francis Walsingham use as Elizabeth's 'Spymaster' to dismantle Catholic plots?",
              model:
                'Walsingham operated an expansive domestic and European espionage network utilizing double agents, paid informants, cryptanalysts (code-breakers like Thomas Phelippes), and intercepted postal routes, allowing him to decipher encrypted correspondence and gather irrefutable legal evidence before striking.',
              model_answer:
                'Walsingham operated an expansive domestic and European espionage network utilizing double agents, paid informants, cryptanalysts (code-breakers like Thomas Phelippes), and intercepted postal routes, allowing him to decipher encrypted correspondence and gather irrefutable legal evidence before striking.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Causal Linkage: How did Walsingham's handling of the 1586 Babington Plot directly seal Mary Stuart's execution?",
              model:
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Constrained Summary: Summarise how Catholic conspiracies changed between the Ridolfi Plot (1571) and the Babington Plot (1586) in two points.',
              model:
                "- Early plots relied on domestic noble rebellions coordinated with vague promises of Spanish naval support.\n- Later plots evolved into covert, Jesuit-supported assassination attempts directly targeting Elizabeth's life to trigger a foreign invasion.",
              model_answer:
                "- Early plots relied on domestic noble rebellions coordinated with vague promises of Spanish naval support.\n- Later plots evolved into covert, Jesuit-supported assassination attempts directly targeting Elizabeth's life to trigger a foreign invasion.",
            },
          ],
      ...
      quiz: [
        {
          question: 'Which Protestant Bishop of Durham did the Northern Earls strongly resent?',
          options: ['Edmund Grindal', 'James Pilkington', 'Matthew Parker', 'John Whitgift'],
          answer: 1,
        },
        {
        ...
        },
        {
          question:
            'What term is used for spies, like Gilbert Gifford, who secretly encourage others to commit treason?',
          options: ['Pursuivants', 'Double agents', 'Agents provocateurs', 'Informants'],
          answer: 2,
        },
        {
          question:
            "Who was the expert cryptographer that deciphered Mary's letters for Walsingham?",
          options: ['John Dee', 'Francis Bacon', 'Thomas Cromwell', 'Thomas Phelippes'],
          answer: 3,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['De Spes', 'Mendoza', 'Gondomar', 'De Quadra'],
          answer: 1,
        },
      ],
      sources: [
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Identify the three fundamental causes of long-term conflict between Elizabethan England and Philip II's Spanish Empire.",
              model:
                "Conflict was driven by religious ideological hatred (militant Catholicism vs Protestant heresy), commercial piracy (English privateers like Drake plundering Spanish treasure ships in the New World), and geopolitical friction over the Spanish Netherlands on England's Channel doorstep.",
              model_answer:
                "Conflict was driven by religious ideological hatred (militant Catholicism vs Protestant heresy), commercial piracy (English privateers like Drake plundering Spanish treasure ships in the New World), and geopolitical friction over the Spanish Netherlands on England's Channel doorstep.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Why was Spanish control of the Netherlands considered an existential national security threat by Elizabeth's Privy Council?",
              model:
                "The Netherlands sat directly across the narrow English Channel. If Philip II's seasoned general, the Duke of Parma, crushed the Dutch Protestant rebels, his 30,000 veteran Spanish infantry could easily use Dutch deep-water ports to launch an amphibious invasion of southern England.",
              model_answer:
                "The Netherlands sat directly across the narrow English Channel. If Philip II's seasoned general, the Duke of Parma, crushed the Dutch Protestant rebels, his 30,000 veteran Spanish infantry could easily use Dutch deep-water ports to launch an amphibious invasion of southern England.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Causal Linkage: How did the 1587 execution of Mary, Queen of Scots remove Philip II's final diplomatic hesitation to invade England?",
              model:
                'Previously, Philip hesitated to depose Elizabeth because Mary Stuart had strong French family ties (the Guise clan), meaning an invasion would benefit rival France. Once Mary was executed and bequeathed her claim to Philip, the Spanish King could invade England to claim the Crown for himself with full Papal blessing.',
              model_answer:
                'Previously, Philip hesitated to depose Elizabeth because Mary Stuart had strong French family ties (the Guise clan), meaning an invasion would benefit rival France. Once Mary was executed and bequeathed her claim to Philip, the Spanish King could invade England to claim the Crown for himself with full Papal blessing.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "What fatal logistical assumption sat at the core of Philip II's plan for the Spanish Armada in 1588?",
              model:
                "Philip's strategy relied on the Armada sailing up the Channel to rendezvous with the Duke of Parma's army in Flanders, but Parma possessed no deep-water port, the English and Dutch held naval blockades, and coordinating a sea-to-shore link-up with 16th-century communications proved virtually impossible.",
              model_answer:
                "Philip's strategy relied on the Armada sailing up the Channel to rendezvous with the Duke of Parma's army in Flanders, but Parma possessed no deep-water port, the English and Dutch held naval blockades, and coordinating a sea-to-shore link-up with 16th-century communications proved virtually impossible.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "The 'But/Because/So' Strategy: Complete the sentence: Philip II launched the Invincible Armada in 1588, BUT...",
              model:
                "Philip II launched the Invincible Armada in 1588, BUT the campaign was fatally compromised BECAUSE the Spanish lacked a deep-water port to embark Parma's troops and were scattered by English fireships at Calais, SO the Armada was decimated in the North Sea without landing a single soldier.",
              model_answer:
                "Philip II launched the Invincible Armada in 1588, BUT the campaign was fatally compromised BECAUSE the Spanish lacked a deep-water port to embark Parma's troops and were scattered by English fireships at Calais, SO the Armada was decimated in the North Sea without landing a single soldier.",
            },
          ],
      ...
      quiz: [
        {
          ...
          options: ['King Philip II', 'King Charles V', 'King Ferdinand', 'King Francis II'],
          answer: 0,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Sir Francis Drake', 'John Hawkins', 'Sir Walter Raleigh', 'Martin Frobisher'],
          answer: 0,
        },
        {
          question: 'What region did Spain control that Elizabeth sent troops to support in 1585?',
          options: ['The Netherlands', 'France', 'Italy', 'Portugal'],
          answer: 0,
        },
        {
          question:
    ...
    },
    {
      ...
      vocab: [
        ...
        },
        {
          ...
          definition:
            'An agreement in 1585 in which Elizabeth I promised military support to the Dutch rebels fighting against Spain.',
        },
      ],
      narrative_blocks: [
        {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'How did events like the 1568 Genoese Loan incident push England and Spain toward open war?',
              model:
                "When Spanish ships carrying Italian loans to pay Parma's troops sought refuge from storms in English ports, Elizabeth confiscated the bullion. Philip retaliated by seizing English merchants' property in the Netherlands, sparking an economic embargo that permanently poisoned diplomatic relations.",
              model_answer:
                "When Spanish ships carrying Italian loans to pay Parma's troops sought refuge from storms in English ports, Elizabeth confiscated the bullion. Philip retaliated by seizing English merchants' property in the Netherlands, sparking an economic embargo that permanently poisoned diplomatic relations.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Why did the 1585 Treaty of Nonsuch represent a definitive 'point of no return' in Anglo-Spanish relations?",
              model:
                'By signing Nonsuch, Elizabeth abandoned covert proxy warfare and officially allied with the Dutch Protestant rebels, agreeing to finance and send 7,400 English soldiers under the Earl of Leicester. This was a de facto declaration of war against the Spanish Crown.',
              model_answer:
                'By signing Nonsuch, Elizabeth abandoned covert proxy warfare and officially allied with the Dutch Protestant rebels, agreeing to finance and send 7,400 English soldiers under the Earl of Leicester. This was a de facto declaration of war against the Spanish Crown.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Why was Robert Dudley's military expedition to the Netherlands between 1585 and 1587 considered an expensive failure?",
              model:
                "Dudley was hampered by a severe lack of funds and supplies from Elizabeth, suffered from poor military coordination, and deeply offended the Queen by accepting the title of 'Governor-General', which gave the false impression that England was attempting to annex the Dutch provinces.",
              model_answer:
                "Dudley was hampered by a severe lack of funds and supplies from Elizabeth, suffered from poor military coordination, and deeply offended the Queen by accepting the title of 'Governor-General', which gave the false impression that England was attempting to annex the Dutch provinces.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "What was the strategic military significance of Sir Francis Drake's preemptive strike on Cadiz in April 1587?",
              model:
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Constrained Summary: Outline the three major escalations between 1585 and 1588 that made the Spanish Armada inevitable.',
              model:
                "1. The 1585 Treaty of Nonsuch openly committed English troops to fight Spanish armies in the Netherlands.\n2. Drake's Caribbean raids and 1587 attack on Cadiz humiliated Spanish naval prestige and devastated supplies.\n3. The 1587 execution of Mary Stuart provided Philip II with the moral justification to launch a Catholic crusade.",
              model_answer:
                "1. The 1585 Treaty of Nonsuch openly committed English troops to fight Spanish armies in the Netherlands.\n2. Drake's Caribbean raids and 1587 attack on Cadiz humiliated Spanish naval prestige and devastated supplies.\n3. The 1587 execution of Mary Stuart provided Philip II with the moral justification to launch a Catholic crusade.",
            },
          ],
      ...
      quiz: [
        {
          ...
          options: ['Henry VII', 'Henry VIII', 'Mary Tudor', 'Edward VI'],
          answer: 2,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['£800,000', '£100,000', '£400,000', '£1,000,000'],
          answer: 2,
        },
        {
        ...
        },
        {
          ...
          options: ['7,400 troops', '25,000 troops', '2,000 troops', '15,000 troops'],
          answer: 0,
        },
        {
        ...
        },
        {
          ...
          options: ['Rotterdam', 'Calais', 'Ostend', 'Antwerp'],
          answer: 2,
        },
        {
        ...
        },
        {
          ...
          options: ['April 1587', 'October 1587', 'July 1588', 'January 1586'],
          answer: 0,
        },
        {
          question: "What famous phrase was used to describe Drake's raid on Cadiz?",
        ...
        },
        {
          ...
          options: ['By five years', 'By roughly one year', 'By three years', 'By one month'],
          answer: 1,
        },
        {
    ...
    },
    {
      ...
      enquiry:
        "Why did King Philip II launch the 'Invincible' Spanish Armada in 1588, and how did its catastrophic failure shape Elizabeth's legacy and the future of Europe?",
      do_now: {
        type: 'questions',
        title: 'Recall & Retrieval',
        instructions: 'Answer these questions in full sentences.',
      ...
      video: {
        ...
        viewing_task:
          "Watch this cinematic depiction of the Armada's defeat. What tactics and environmental factors are shown destroying the Spanish fleet?",
        model_answer:
          "The English used devastating fireships to scatter the Spanish crescent formation. Following this, the chaotic 'Protestant Wind' and violent storms smashed the fleeing Spanish galleons against the rocky coasts of Scotland and Ireland.",
      },
      teacher_notes: {
        primer:
      ...
      vocab: [
        ...
        },
        {
          term: 'Fireships',
          definition:
            'Ships deliberately set on fire and steered into an enemy fleet to destroy or scatter it.',
        },
      ],
      narrative_blocks: [
        {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'How did the defensive crescent formation used by the Duke of Medina Sidonia in the English Channel reflect Spanish tactical doctrine?',
              model:
                'The tight crescent formation was designed for close-quarters boarding combat, positioning heavily armed galleons on the wings to protect vulnerable transport ships in the center. It prevented English ships from isolating single vessels, but made maneuvering rigid and slow against nimble English warships.',
              model_answer:
                'The tight crescent formation was designed for close-quarters boarding combat, positioning heavily armed galleons on the wings to protect vulnerable transport ships in the center. It prevented English ships from isolating single vessels, but made maneuvering rigid and slow against nimble English warships.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Causal Linkage: How did the absence of a deep-water Flemish port make the Armada's rendezvous with the Duke of Parma impossible?",
              model:
                'Because the Duke of Parma held only shallow-water ports like Dunkirk that were blockaded by Dutch flyboats, and Medina Sidonia could not anchor his deep-draught galleons without coming under fire, the two Spanish forces could not communicate or link up, leaving the invasion force stranded on shore.',
              model_answer:
                'Because the Duke of Parma held only shallow-water ports like Dunkirk that were blockaded by Dutch flyboats, and Medina Sidonia could not anchor his deep-draught galleons without coming under fire, the two Spanish forces could not communicate or link up, leaving the invasion force stranded on shore.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Why was the English deployment of eight fireships at Calais on the night of 7 August 1588 the turning point of the campaign?',
              model:
                'Panicked by drifting fire vessels loaded with gunpowder, Spanish captains severed their anchor cables and broke formation in darkness. At dawn off Gravelines, the disorganized Spanish ships were exposed to relentless English broadsides, where faster English cannons battered Spanish hulls at close range.',
              model_answer:
                'Panicked by drifting fire vessels loaded with gunpowder, Spanish captains severed their anchor cables and broke formation in darkness. At dawn off Gravelines, the disorganized Spanish ships were exposed to relentless English broadsides, where faster English cannons battered Spanish hulls at close range.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'What role did Atlantic geography and severe autumn storms play in the destruction of the fleeing Spanish fleet?',
              model:
                "Deprived of anchors and unable to sail back through the English Channel against the wind, the battered Armada was forced to navigate the uncharted, reef-strewn waters of northern Scotland and western Ireland. Violent gales ('the Protestant Wind') wrecked dozens of ships on the rocks, where survivors were killed by local inhabitants or English garrisons.",
              model_answer:
                "Deprived of anchors and unable to sail back through the English Channel against the wind, the battered Armada was forced to navigate the uncharted, reef-strewn waters of northern Scotland and western Ireland. Violent gales ('the Protestant Wind') wrecked dozens of ships on the rocks, where survivors were killed by local inhabitants or English garrisons.",
            },
          ],
      ...
      quiz: [
        ...
        },
        {
          question:
            'Which Pope gave his blessing to the Armada, turning it into a Catholic crusade?',
          options: ['Pope Sixtus V', 'Pope Paul IV', 'Pope Gregory XIII', 'Pope Pius V'],
          answer: 0,
        },
        {
        ...
        },
        {
          ...
          options: ['Dutch flyboats', 'Spanish galleys', 'French frigates', 'English galleons'],
          answer: 0,
        },
        {
          question:
            'At which port did the Armada mistakenly drop anchor to wait for the land army?',
          options: ['Ostend', 'Rotterdam', 'Antwerp', 'Calais'],
          answer: 3,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Fifteen', 'Eight', 'Three', 'Twenty'],
          answer: 1,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Plymouth', 'Richmond Palace', 'London', 'Tilbury'],
          answer: 3,
        },
        {
          question: 'What famous piece of propaganda was painted to celebrate the victory?',
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'What was the overarching social and political objective of education in Elizabethan England?',
              model:
                "Education was not designed to promote social equality or upward mobility; rather, it was engineered to reinforce the rigid 'Great Chain of Being', teaching children obedience to the Queen and church, and instilling vocational skills strictly appropriate to their inherited social class.",
              model_answer:
                "Education was not designed to promote social equality or upward mobility; rather, it was engineered to reinforce the rigid 'Great Chain of Being', teaching children obedience to the Queen and church, and instilling vocational skills strictly appropriate to their inherited social class.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "The 'But/Because/So' Strategy: Complete the sentence: Grammar schools expanded rapidly under Elizabeth to teach Latin and rhetoric, BUT...",
              model:
                "Grammar schools expanded rapidly to teach Latin and rhetoric, BUT they remained inaccessible to working-class children BECAUSE attendance required fees and poor families relied on children's labour for farm income, SO formal education remained the preserve of the wealthy gentry and prosperous merchants.",
              model_answer:
                "Grammar schools expanded rapidly to teach Latin and rhetoric, BUT they remained inaccessible to working-class children BECAUSE attendance required fees and poor families relied on children's labour for farm income, SO formal education remained the preserve of the wealthy gentry and prosperous merchants.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Constrained Summary: In two precise sentences, explain how education and leisure reflected the contradictory nature of Elizabethan society.',
              model:
                "Humanist education and flourishing theatres fostered intellectual vibrancy, literacy, and a shared national identity during England's cultural Golden Age. Nevertheless, strict access barriers and class-divided leisure preserved the unyielding social hierarchy and deep inequality of the Tudor world.",
              model_answer:
                "Humanist education and flourishing theatres fostered intellectual vibrancy, literacy, and a shared national identity during England's cultural Golden Age. Nevertheless, strict access barriers and class-divided leisure preserved the unyielding social hierarchy and deep inequality of the Tudor world.",
            },
          ],
      ...
      quiz: [
        {
          ...
          options: ['Humanism', 'The Enlightenment', 'Scholasticism', 'Romanticism'],
          answer: 0,
        },
        {
        ...
        },
        {
          ...
          options: ['The printing press', 'The quill pen', 'The telegraph', 'The spinning jenny'],
          answer: 0,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['A parchment scroll', 'A wax tablet', 'A slate', 'A hornbook'],
          answer: 3,
        },
        {
          question:
            'What type of school did the sons of the gentry and merchants attend from age seven?',
          options: ['A Dame School', 'A Grammar School', 'A Chantry School', 'A Petty School'],
          answer: 1,
        },
        {
        ...
        },
        {
          ...
          options: ['Mob football', 'Real tennis', 'Fencing', 'Jousting'],
          answer: 0,
        },
        {
    ...
    },
    {
      ...
      vocab: [
        {
          ...
          definition:
            'A homeless, unemployed person who wandered from town to town looking for work or begging.',
        },
        {
          term: 'Enclosure',
          definition:
            'The deeply controversial practice of wealthy landlords putting fences around large, open fields to graze sheep, leading to mass rural unemployment.',
        },
        {
          term: 'Impotent Poor',
          definition:
            "The 'deserving' poor who genuinely could not work due to old age, severe illness, or because they were too young.",
        },
        {
          term: 'Able-Bodied Poor',
          definition:
            "The 'undeserving' poor who were physically capable of working but were unemployed. Often viewed as lazy criminals.",
        },
        {
          term: 'Poor Rate',
          definition:
            'A compulsory local tax collected by Justices of the Peace (JPs) to fund financial support for the impotent poor.',
        },
      ],
      vocab_cloze_text:
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Identify the primary economic and demographic factors that caused a severe poverty crisis in Elizabethan England.',
              model:
                'A massive population increase from 2.8 to over 4 million caused rapid inflation in food prices and depressed wages. Compounding this, consecutive disastrous harvest failures in the 1590s led to widespread starvation, while the collapse of the European cloth trade left thousands of weavers destitute.',
              model_answer:
                'A massive population increase from 2.8 to over 4 million caused rapid inflation in food prices and depressed wages. Compounding this, consecutive disastrous harvest failures in the 1590s led to widespread starvation, while the collapse of the European cloth trade left thousands of weavers destitute.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Causal Linkage: How did the agricultural practice of 'enclosure' directly fuel the growth of urban vagrancy?",
              model:
                'Landowners fenced off traditional common land and converted labour-intensive arable crop farming into profitable sheep farming for wool. Because sheep farming required far fewer workers, thousands of tenant farmers and agricultural labourers were evicted from their cottages, forcing them to become wandering vagrants seeking work in cities.',
              model_answer:
                'Landowners fenced off traditional common land and converted labour-intensive arable crop farming into profitable sheep farming for wool. Because sheep farming required far fewer workers, thousands of tenant farmers and agricultural labourers were evicted from their cottages, forcing them to become wandering vagrants seeking work in cities.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Why did the Elizabethan ruling class regard wandering 'sturdy beggars' with intense terror?",
              model:
                'The ruling class viewed wandering, masterless men as a grave threat to the social order and Crown security, fearing they carried contagious diseases like the plague, committed highway robberies, and had the potential to ignite large-scale rebellions beyond the reach of local gentry control.',
              model_answer:
                'The ruling class viewed wandering, masterless men as a grave threat to the social order and Crown security, fearing they carried contagious diseases like the plague, committed highway robberies, and had the potential to ignite large-scale rebellions beyond the reach of local gentry control.',
            },
          ],
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Enclosure', 'Strip farming', 'Crop rotation', 'Subsistence farming'],
          answer: 0,
        },
        {
        ...
        },
        {
          ...
          options: ['A peasant', 'A nomad', 'A pilgrim', 'A vagabond or vagrant'],
          answer: 3,
        },
        {
        ...
        },
        {
          ...
          options: ['Francis Bacon', 'William Shakespeare', 'John Foxe', 'Thomas Harman'],
          answer: 3,
        },
        {
          question: "What was a 'Counterfeit Crank'?",
        ...
        },
        {
          ...
          options: ['The Mayor', 'The Sheriff', 'The Parish Priest', 'Justices of the Peace / JPs'],
          answer: 3,
        },
        {
        ...
        },
        {
          ...
          options: ['Monasteries', 'Houses of Correction', "Debtors' Gaols", 'Prisons'],
          answer: 1,
        },
        {
          question:
    ...
    },
    {
      ...
      vocab: [
        {
          ...
          definition:
            'To sail completely around the world. Between 1577 and 1580, Francis Drake became the first Englishman to achieve this.',
        },
        {
          term: 'Astrolabe',
          definition:
            'A navigational instrument used by sailors to determine their latitude by the position of the stars, vastly improving the safety and accuracy of oceanic travel.',
        },
        {
          term: 'Privateer',
          definition:
            'A privately owned ship (or its captain) officially authorised by Elizabeth to attack and capture enemy (Spanish) vessels.',
        },
        {
          term: 'Roanoke',
          definition:
            'An island off the coast of North America (modern-day North Carolina) where Walter Raleigh’s ill-fated colonies were established.',
        },
      ],
      narrative_blocks: [
        {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Why did Elizabethan merchants and navigators suddenly turn their attention to global maritime exploration in the 1570s?',
              model:
                'The collapse of the traditional Antwerp cloth trade forced English merchants to search for lucrative new overseas markets and routes to the Far East (the North-West and North-East Passages), while the immense wealth Spain extracted from the Americas inspired England to challenge Spanish naval dominance.',
              model_answer:
                'The collapse of the traditional Antwerp cloth trade forced English merchants to search for lucrative new overseas markets and routes to the Far East (the North-West and North-East Passages), while the immense wealth Spain extracted from the Americas inspired England to challenge Spanish naval dominance.',
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                'Identify two technological developments that enabled Elizabethan sailors to undertake perilous transoceanic voyages.',
              model:
                "Navigators utilised new navigational instruments like the astrolabe, cross-staff, and magnetic compass to calculate latitude accurately, alongside the development of the Mercator projection map and lighter, faster 'race-built' galleons with superior square and lateen rigging.",
              model_answer:
                "Navigators utilised new navigational instruments like the astrolabe, cross-staff, and magnetic compass to calculate latitude accurately, alongside the development of the Mercator projection map and lighter, faster 'race-built' galleons with superior square and lateen rigging.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "What was the economic and political significance of Sir Francis Drake's voyage aboard the Golden Hind?",
              model:
                "Economically, Drake captured a staggering fortune in Spanish bullion (worth over £400,000, easily exceeding the Crown's annual income) that solved Elizabeth's national debt. Politically, his voyage demonstrated English naval competence, mapped uncharted Pacific territories (claiming Nova Albion in California), and humiliated King Philip II.",
              model_answer:
                "Economically, Drake captured a staggering fortune in Spanish bullion (worth over £400,000, easily exceeding the Crown's annual income) that solved Elizabeth's national debt. Politically, his voyage demonstrated English naval competence, mapped uncharted Pacific territories (claiming Nova Albion in California), and humiliated King Philip II.",
            },
          ],
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "The 'But/Because/So' Strategy: Complete the sentence: England achieved spectacular naval glory through privateering in the 1570s and 1580s, BUT...",
              model:
      ...
      quiz: [
        ...
        },
        {
          question:
            'Which Native American Chief turned against the English and attacked the colony?',
          options: ['Chief Sitting Bull', 'Chief Wingina', 'Chief Manteo', 'Chief Powhatan'],
          answer: 1,
        },
        {
        ...
        },
        {
          ...
          options: ['1584', '1587', '1590', '1585'],
          answer: 1,
        },
        {
          question:
            'Who was the leader of the 1587 expedition who returned to England for supplies?',
          options: ['Thomas Harriot', 'Ralph Lane', 'John White', 'Walter Raleigh'],
          answer: 2,
        },
        {
    ...
    },
    {
      ...
      vocab: [
        {
          term: 'Royal Charter',
          definition:
            'A formal document from the monarch granting a person legal power and rights. Elizabeth gave Raleigh a charter in 1584 to colonise any land not already ruled by a Christian monarch.',
        },
        {
          term: 'Virginia',
          definition:
            "The name given to the newly claimed territory in North America, named in honour of Elizabeth, the 'Virgin Queen'.",
        },
        {
          term: 'Roanoke',
          definition:
            'The specific island off the coast of North America (in modern-day North Carolina) where the colonies were established.',
        },
        {
          term: 'Algonquian',
          definition:
            'The local Native American tribes who initially traded with the English but were later driven to war by English aggression.',
        },
      ],
      vocab_cloze_text:
        "In 1584, Elizabeth I granted Walter Raleigh a [Royal Charter] giving him exclusive rights to explore and colonize any lands not held by a Christian prince. Raleigh organized an ambitious expedition to establish a permanent colony in North America, naming the vast territory [Virginia] in honor of the 'Virgin Queen'. The settlers landed on [Roanoke] Island, but the colony was doomed by poor planning and increasingly hostile relations with the local [Algonquian] Native American tribes, leading to the mysterious disappearance of the colonists.",
      narrative_blocks: [
        {
          ...
          tasks: [
            {
              type: 'comprehension',
              question:
                "Constrained Summary: Outline the three primary reasons why Raleigh's attempts to colonise Virginia failed in the 1580s.",
              model:
                '- Logistical errors: Colonists arrived without adequate food supplies and were dependent on unfamiliar hunting and farming techniques.\n- Hostile relations: Cultural arrogance and violent attacks alienated indigenous tribes whose food and assistance were vital.\n- Geopolitical delays: The outbreak of war with Spain and the Armada prevented vital resupply ships from reaching Roanoke in time.',
              model_answer:
                '- Logistical errors: Colonists arrived without adequate food supplies and were dependent on unfamiliar hunting and farming techniques.\n- Hostile relations: Cultural arrogance and violent attacks alienated indigenous tribes whose food and assistance were vital.\n- Geopolitical delays: The outbreak of war with Spain and the Armada prevented vital resupply ships from reaching Roanoke in time.',
            },
          ],
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Maryland', 'Virginia', 'New England', 'Carolina'],
          answer: 1,
        },
        {
        ...
        },
        {
          ...
          options: ['John White', 'Richard Grenville', 'Walter Raleigh', 'Ralph Lane'],
          answer: 3,
        },
        {
          question: 'Who was the brilliant mathematician and mapmaker on the 1585 expedition?',
          options: ['William Cecil', 'Thomas Harriot', 'John Dee', 'Francis Bacon'],
          answer: 1,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Chief Manteo', 'Chief Powhatan', 'Chief Wingina', 'Chief Wanchese'],
          answer: 2,
        },
        {
        ...
        },
        {
          ...
          options: ['Walter Raleigh', 'John Hawkins', 'Francis Drake', 'Martin Frobisher'],
          answer: 2,
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Ralph Lane', 'Walter Raleigh', 'Thomas Harriot', 'John White'],
          answer: 3,
        },
        {
        ...
        },
        {
          ...
          options: ['Three years / until 1590', 'One year', 'Two years', 'Five years'],
          answer: 0,
        },
        {
