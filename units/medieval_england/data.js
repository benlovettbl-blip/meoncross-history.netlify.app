  ...
  lessons: [
    {
      ...
      vocab: [
        {
          term: 'Witan',
          definition:
            'The powerful council of Anglo-Saxon lords and church leaders who advised the king and helped choose who would rule next.',
        },
        {
          term: 'Claimant',
          definition:
            'A person who believes they have a legal right to take power or own something, such as the throne of a country.',
        },
        {
          term: 'Succession Crisis',
          definition:
            'A dangerous situation that happens when a king dies without a clear heir, leading to arguments and often war over who should rule next.',
        },
        {
          term: 'Feigned Retreat',
          definition:
            'A clever military trick where soldiers pretend to run away in panic, encouraging the enemy to break their formation and chase them.',
        },
        {
          term: 'Shield Wall',
          definition:
            'A defensive military formation where soldiers stand tightly together with their shields overlapping to create a strong, solid barrier against attacks.',
        },
      ],
      do_now: {
        type: 'questions',
      ...
      quiz: [
        ...
        },
        {
          ...
          answer: 'The Anglo-Saxons.',
          a: 'The Anglo-Saxons.',
          options: ['The Anglo-Saxons.', 'The Normans.', 'The Romans.', 'The Vikings.'],
        },
        {
          question: 'What was the most important building in a medieval village?',
          ...
          answer: 'The church.',
          a: 'The church.',
          options: ['The church.', 'The market.', 'The blacksmith.', 'The castle.'],
        },
        {
          question: 'What is an heir to the throne?',
        ...
        },
        {
          ...
          answer: 'The Vikings.',
          a: 'The Vikings.',
          options: ['The Normans.', 'The Vikings.', 'The Romans.', 'The Franks.'],
        },
        {
          question: 'Where is Normandy located?',
        ...
        },
        {
          ...
          a: 'A shield wall',
          options: ['A cavalry charge', 'A trench system', 'A shield wall', 'A ring of fire'],
        },
        {
    ...
    },
    {
      ...
      vocab: [
        {
          term: 'Motte',
          definition:
            "A large, man-made mound of earth on which a castle's wooden keep (tower) was built.",
        },
        {
          term: 'Bailey',
          definition:
            'The fenced lower courtyard of a castle where soldiers lived and horses were kept.',
        },
        {
          term: 'Palisade',
          definition: 'A strong defensive fence made of tall wooden stakes driven into the ground.',
        },
        {
          term: 'Harrying',
          definition:
            'To lay waste, destroy, and plunder an area, as William did to the North of England in 1069-70.',
        },
        {
          term: 'Domesday Book',
          definition:
            'The massively detailed survey of all the land, wealth, and resources in England, ordered by William in 1085.',
        },
        {
          term: 'Shire',
          definition: 'An English county or district, like Hampshire or Yorkshire.',
        },
        {
          term: 'Tenant-in-chief',
          definition:
            'A major nobleman who held land directly from the King in return for providing military service.',
        },
      ],
      do_now: {
        type: 'questions',
      ...
      quiz: [
        ...
        },
        {
          ...
          answer: 'Harald Hardrada.',
          a: 'Harald Hardrada.',
          options: ['Cnut the Great.', 'Ragnar Lothbrok.', 'Harald Hardrada.', 'Sweyn Forkbeard.'],
        },
        {
          question: 'Who claimed the throne because of a broken oath sworn on holy relics?',
        ...
        },
        {
          ...
          answer: 'French',
          a: 'French',
          options: ['Latin', 'Viking Norse', 'French', 'Old English'],
        },
        {
        ...
        },
        {
          ...
          a: 'Military service',
          options: ['Gold coins', 'Religious prayers', 'Military service', 'Farm labor'],
        },
        {
      ...
      vocab: [
        {
          term: 'Common Law',
          definition:
            'A single legal system applied consistently across the whole country, which Henry II expanded through royal courts.',
        },
        {
          term: 'Canon Law',
          definition:
            'The separate legal system used by the Catholic Church to govern the behavior of priests, monks, and other clergy.',
        },
        {
          term: 'Benefit of Clergy',
          definition:
            'The right of anyone in holy orders to be tried in a Church court rather than a royal court, often resulting in lighter punishments.',
        },
        {
          term: 'Constitutions of Clarendon',
          definition:
            'A document issued by Henry II in 1164 listing 16 rules designed to restrict Church independence and increase royal control.',
        },
        {
          term: 'Excommunication',
          definition:
            'The severe religious punishment of officially excluding someone from participating in the sacraments and services of the Christian Church.',
        },
        {
          term: 'Martyr',
          definition:
            'A person who is killed because of their religious or other beliefs, which often elevates them to a heroic or saintly status.',
        },
      ],
      do_now: {
        type: 'questions',
      ...
      quiz: [
        {
          ...
          options: ['Henry II.', 'Harold Godwinson.', 'William the Conqueror.', 'Harald Hardrada.'],
        },
        {
        ...
        },
        {
          ...
          answer: 'Over 100,000.',
          a: 'Over 100,000.',
          options: ['Over 100,000.', 'Nearly 500,000.', 'Around 10,000.', 'About 1,000.'],
        },
        {
        ...
        },
        {
          ...
          answer: 'Six years',
          a: 'Six years',
          options: ['Six months', 'One year', 'Six years', 'Ten years'],
        },
        {
      ...
      vocab: [
        {
          term: 'Angevin Empire',
          definition:
            'A massive collection of territories controlled by the English Crown in the 12th and 13th centuries, covering England and roughly half of modern France.',
        },
        {
          term: 'Scutage',
          definition:
            'A special tax paid by a knight or baron to the king instead of fighting in the royal army. King John abused this tax repeatedly.',
        },
        {
          term: 'Papal Interdict',
          definition:
            'A devastating punishment from the Pope that banned all church services in a country, including marriages and Christian burials.',
        },
        {
          term: 'Magna Carta',
          definition:
            "The 'Great Charter' sealed by King John in 1215, which forced the monarch to agree to legal limits on his power.",
        },
        {
          term: 'Clause 39',
          definition:
            'The most famous section of Magna Carta, guaranteeing that no free man could be imprisoned or punished without a fair trial.',
        },
        {
          term: 'Habeas Corpus',
          definition:
            'The vital legal right ensuring that a person cannot be kept in prison without being charged and brought before a judge.',
        },
      ],
      do_now: {
        type: 'questions',
      ...
      quiz: [
        {
          ...
          answer: 'King Henry II.',
          a: 'King Henry II.',
          options: ['King Henry II.', 'King Edward I.', 'King John.', 'King Richard I.'],
        },
        {
          question: 'Who did Henry II appoint as Archbishop of Canterbury?',
          ...
          answer: 'Thomas Becket.',
          a: 'Thomas Becket.',
          options: ['Thomas Cranmer.', 'Thomas Becket.', 'Stephen Langton.', 'Lanfranc.'],
        },
        {
          question: 'Why did Henry and Becket clash?',
        ...
        },
        {
          ...
          answer: 'William the Conqueror.',
          a: 'William the Conqueror.',
          options: ['Henry II.', 'William the Conqueror.', 'Harald Hardrada.', 'Harold Godwinson.'],
        },
        {
          question: 'What was the Domesday Book?',
        ...
        },
        {
          ...
          answer: 'Runnymede',
          a: 'Runnymede',
          options: ['Runnymede', 'Hastings', 'Canterbury', 'Bosworth Field'],
        },
        {
    ...
    },
    {
      ...
      vocab: [
        {
          term: 'Villein',
          definition:
            "A medieval peasant who was legally tied to the local lord's land and could not leave without permission.",
        },
        {
          term: 'Tithe',
          definition:
            "A compulsory tax paid to the Church, equal to one-tenth of a peasant's annual agricultural produce or income.",
        },
        {
          term: 'Doom Painting',
          definition:
            'A terrifying mural painted on church walls showing souls being judged and sent to Heaven or dragged into Hell.',
        },
        {
          term: 'Purgatory',
          definition:
            'In Catholic belief, a place where souls go after death to be purified through suffering before entering Heaven.',
        },
        {
          term: 'Harvest',
          definition:
            'The most important time of the medieval year when crops were gathered; failure meant starvation for the village.',
        },
      ],
      do_now: {
        type: 'short_answer',
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['The Catholic Church', 'The village elders', 'The local lord', 'The King'],
        },
        {
        ...
        },
        {
          ...
          a: 'The parish church',
          options: ['The manor house', 'The local pub', "The lord's castle", 'The parish church'],
        },
        {
      ...
      vocab: [
        {
          term: 'Bubonic Plague',
          definition:
            'A deadly disease transmitted by flea bites, characterized by high fevers and agonizing, pus-filled swellings called buboes.',
        },
        {
          term: 'Miasma',
          definition:
            "The medieval medical belief that diseases were caused by corrupt, foul-smelling 'bad air' rising from filth or swamps.",
        },
        {
          term: 'Flagellants',
          definition:
            'Religious zealots who publicly whipped themselves to show sorrow for their sins in the hope that God would spare them from the plague.',
        },
        {
          term: 'Statute of Labourers',
          definition:
            'An emergency law passed by Parliament in 1351 attempting to freeze wages at pre-plague levels to stop peasants from demanding more money.',
        },
        {
          term: 'Yeoman',
          definition:
            'A rising class of independent, prosperous tenant farmers who emerged after the Black Death by renting abandoned land.',
        },
        {
          term: 'Danse Macabre',
          definition:
            "The 'Dance of Death'—a popular artistic theme after the Black Death showing skeletons leading people of all social ranks to the grave.",
        },
      ],
      do_now: {
        type: 'questions',
      ...
      quiz: [
        {
          ...
          answer: 'King John.',
          a: 'King John.',
          options: ['King Edward I.', 'King Henry II.', 'King John.', 'King Richard I.'],
        },
        {
          question: 'What mocking nickname was given to King John?',
          ...
          answer: 'Softsword.',
          a: 'Softsword.',
          options: ['Softsword.', 'Lackland.', 'Longshanks.', 'Lionheart.'],
        },
        {
          question: 'Why were the barons angry with King John?',
        ...
        },
        {
          ...
          answer: 'William the Conqueror.',
          a: 'William the Conqueror.',
          options: ['Edward I.', 'William the Conqueror.', 'King John.', 'Henry II.'],
        },
        {
          question: 'What was the Harrying of the North?',
    ...
    },
    {
      ...
      vocabulary: [
        ...
        },
        {
          term: 'Resistance',
          definition:
            "Actions taken to oppose or challenge authority — the Peasants' Revolt was a dramatic act of resistance.",
        },
        {
          term: 'Wat Tyler',
          definition:
      ...
      vocab: [
        {
          term: 'Poll Tax',
          definition:
            'A highly unpopular flat-rate tax introduced in 1380 that demanded 12 pence from every person over fourteen, regardless of wealth.',
        },
        {
          term: 'John Ball',
          definition:
            'A radical priest who travelled the countryside preaching that all men were created equal by God, helping to inspire the revolt.',
        },
        {
          term: 'Wat Tyler',
          definition:
            'The charismatic military leader chosen by the Kentish rebels to lead the march on London during the 1381 uprising.',
        },
        {
          term: 'Simon Sudbury',
          definition:
            'The Archbishop of Canterbury and Chancellor who was dragged from the Tower of London and beheaded by furious rebels.',
        },
        {
          term: 'Smithfield',
          definition:
            'The location in London where King Richard II met the rebels on 15 June 1381, culminating in the death of Wat Tyler.',
        },
        {
          term: 'Manorial Rolls',
          definition:
            'Written records kept by lords that proved which peasants were serfs; these were deliberately targeted and burned by the rebels.',
        },
      ],
      do_now: {
        type: 'questions',
      ...
      quiz: [
        ...
        },
        {
          ...
          answer: 'Roughly one third.',
          a: 'Roughly one third.',
          options: ['About two thirds.', 'Nearly half.', 'Roughly one third.', 'Around one tenth.'],
        },
        {
          question: "What were 'buboes'?",
          q: "What were 'buboes'?",
        ...
        },
        {
          ...
          answer: 'Thomas Becket.',
          a: 'Thomas Becket.',
          options: ['Wat Tyler.', 'Harold Godwinson.', 'Thomas Becket.', 'King John.'],
        },
        {
          question: "Why did King John charge heavy 'scutage' taxes?",
        ...
        },
        {
          ...
          answer: '14 years old',
          a: '14 years old',
          options: ['8 years old', '40 years old', '14 years old', '25 years old'],
        },
        {
          ...
          answer: 'Smithfield',
          a: 'Smithfield',
          options: ['Bosworth', 'Hastings', 'Smithfield', 'Runnymede'],
        },
        {
        ...
        },
        {
          ...
          options: ['A French spy', 'John Ball', 'King Richard II himself', 'The Mayor of London'],
        },
        {
    ...
    },
    {
      ...
      vocabulary: [
        {
          term: 'Monarchy',
          definition:
            'Rule by a king or queen — the Wars of the Roses were a violent struggle between rival claimants to the English monarchy.',
        },
        {
          term: 'Dynasty',
          definition:
        ...
        },
        {
          term: 'Propaganda',
          definition:
            "The use of biased information to shape public opinion — Tudor propaganda deliberately blackened Richard III's reputation.",
        },
        {
          term: 'Usurper',
          definition:
            'A person who seizes power illegally or by force, without a legitimate claim.',
        },
        {
          term: 'Significance',
          definition:
            'Why an event mattered — the Battle of Bosworth (1485) is significant because it ended the medieval era.',
        },
      ],
      ...
      vocab: [
        {
          term: 'Dynasty',
          definition: 'A sequence of rulers from the same family line.',
        },
        {
          term: 'House of Lancaster',
          definition:
            'A branch of the royal family fighting for the throne, symbolized by a red rose.',
        },
        {
          term: 'House of York',
          definition:
            'A rival branch of the royal family fighting for the throne, symbolized by a white rose.',
        },
        {
          term: 'Usurp',
          definition: 'To take a position of power or a throne illegally or by force.',
        },
        {
          term: 'Tudor',
          definition:
            'The new royal dynasty established by Henry VII after the Battle of Bosworth.',
        },
      ],
      do_now: {
        type: 'short_answer',
      ...
      quiz: [
        ...
        },
        {
          ...
          answer: 'A red rose',
          a: 'A red rose',
          options: ['A purple thistle', 'A yellow daffodil', 'A red rose', 'A white rose'],
        },
        {
          ...
          answer: 'A white rose',
          a: 'A white rose',
          options: ['A red rose', 'A white boar', 'A blue lily', 'A white rose'],
        },
        {
        ...
        },
        {
          ...
          options: ['Ireland', "England's lands in France", 'Scotland', 'Wales'],
        },
        {
        ...
        },
        {
          ...
          answer: 'Henry Tudor',
          a: 'Henry Tudor',
          options: ['Henry Tudor', 'William the Conqueror', 'Wat Tyler', 'King Philip of France'],
        },
        {
          question:
        ...
        },
        {
          ...
          answer: 'Henry VII',
          a: 'Henry VII',
          options: ['Henry VII', 'Edward VI', 'Henry VIII', 'Edward V'],
        },
        {
    ...
    },
    {
      ...
      vocabulary: [
        ...
        },
        {
          term: 'Power',
          definition:
            'The ability to control others — the central theme of this entire medieval unit.',
        },
        {
          term: 'Feudalism',
          definition:
            'The social system based on land, loyalty, and obligation that defined medieval English society.',
        },
        {
          term: 'Evidence',
          definition:
        ...
        },
        {
          term: 'Judgement',
          definition:
            'A considered conclusion reached after weighing up different pieces of evidence.',
        },
      ],
      ...
      vocab: [
        ...
        },
        {
          term: 'Magna Carta',
          definition:
            "The 'Great Charter' that limited the King's power and established that no one is above the law.",
        },
        {
          term: 'Pestilence',
