  ...
  lessons: [
    {
      ...
      narrative_blocks: [
        ...
        },
        {
          ...
          source: {
            ...
            source_context:
              'The Anglo-Saxon Chronicle was a year-by-year history of England, written by monks in English monasteries. This account was written shortly after the battle by English monks who supported King Harold. <strong></strong>',
            provenance_clue:
              "Consider who wrote this and whose side they were on. Are they trying to make Harold's defeat seem less embarrassing?",
          },
          ...
          tasks: [
            {
              type: 'short_answer',
              question:
                'Task 3: Source Analysis (Source A)\nAccording to Source A, what was the main reason King Harold lost the battle? \n*Hint: Look at the sentence describing how William arrived at the battlefield.*',
              model_answer:
                "According to Source A, Harold lost because William attacked him 'unawares, before his people were set in order'. This suggests the English army was surprised and not fully prepared for the battle to begin.",
            },
          ],
        },
        {
          ...
          source: {
            ...
            source_context:
              'This famous scene from the tapestry, created shortly after the battle, shows the chaotic final moments of Hastings. It is widely believed to depict King Harold Godwinson (right) being struck in the eye by a Norman arrow, though historians still debate if this figure is actually him or another Saxon warrior.',
          },
        ...
        },
        {
          ...
          source: {
            ...
            source_context:
              'A 19th-century romantic painting depicting the Battle of Hastings (1066). It was created by an artist who lived over 700 years after the events took place. <strong></strong>',
            provenance_clue:
              'Look at the date it was painted. Was the artist actually there? How might this affect its reliability?',
          },
          ...
          tasks: [
            {
              ...
              model_answer:
                'Edward dies -> Harold crowned -> Hardrada invades -> Stamford Bridge -> Wind changes -> Hastings',
            },
          ],
        },
      ],
      vocab: [
        {
          ...
          definition:
            'A political emergency caused by the death of a monarch without a clear, undisputed heir to the throne.',
        },
        {
          term: 'Claimant',
        ...
        },
        {
          term: 'Witan',
          definition:
            'The national council of Anglo-Saxon nobles and senior clergy that advised the king and chose the next monarch.',
        },
        {
          term: 'Housecarl',
          definition:
            "Elite, full-time Anglo-Saxon professional soldiers who served as the king's well-armoured bodyguard.",
        },
        {
          term: 'Shield Wall',
          definition:
            'A tight defensive military formation where infantry locked heavy wooden shields together to repel cavalry and missile attacks.',
        },
        {
          term: 'Feigned Retreat',
          definition:
            'A deceptive tactical manoeuvre where troops pretend to panic and flee, luring defenders out of their strong defensive positions.',
        },
      ],
      do_now: {
        type: 'questions',
      ...
      teacher_notes: {
        primer:
          "The pedagogical goal of this lesson is to immerse students in the succession crisis of 1066. Students should understand that William's victory was not inevitable; it was the result of incredibly lucky timing, Harold's exhaustion, and distinct tactical decisions at Hastings.",
        objectives: [
          {
            objective:
              'Explain why there was a succession crisis in 1066 and evaluate the claims of the three rivals.',
            primer:
              'Focus the students on the fact that Edward died without an heir, leading to a power vacuum. Emphasize that all three claimants had somewhat valid, albeit conflicting, justifications.',
          ...
          },
          {
            ...
            primer:
              'Use a map or timeline to show the geographical challenge Harold faced—having to march north to fight Hardrada and then immediately south to face William.',
          ...
          },
          {
            ...
            primer:
              "Break down the battle into phases. Contrast the Anglo-Saxon shield wall with the Norman cavalry, and highlight William's crucial 'feigned retreat' tactic.",
      ...
      pair_share: {
        prompt:
          'Discuss with your partner: Which of the three claimants do you think had the strongest legal claim to the throne of England, and why?',
    ...
    },
    {
      ...
      teacher_notes: {
        primer:
          'This lesson focuses on the brutal methods William the Conqueror used to secure his control over a hostile England following his victory at Hastings. Students will explore military control through castles, psychological and physical devastation in the Harrying of the North, and administrative dominance via the Domesday Book.',
        objectives: [
          {
            objective:
              'Understand how the motte and bailey castle design allowed Normans to quickly establish military dominance.',
            primer:
              'Direct students to analyze the visual sources (Portchester Castle and the Motte and Bailey diagram). Emphasize the psychological impact of these towering structures.',
            question:
              'Hinge Question: Why was it essential for early Norman castles to be built from wood and earth rather than stone?',
          },
          {
            objective:
              'Evaluate the causes and devastating consequences of the Harrying of the North.',
            primer:
              "Use the Orderic Vitalis source to explore William's ruthlessness. Discuss whether his actions were a military necessity or extreme tyranny.",
            question:
              'Hinge Question: Why might Orderic Vitalis, a monk writing decades later, be a reliable source for the horrors of the Harrying?',
          },
          {
            objective:
              'Analyze the purpose and impact of the Domesday Book using local Hampshire records.',
            primer:
              "Guide students through the Side Quest on Fareham and Stubbington. Make the Domesday Book tangible by showing them their own town's history.",
            question:
              'Hinge Question: How does the Domesday Book demonstrate that the Norman Conquest was a complete takeover of English wealth?',
          },
        ],
      },
      creative_task: {
        ...
        callouts: [
          {
            ...
            prompt:
              'Why did the steep 5–15m artificial slope make horse charges impossible and give archers clear vantage over dead ground?',
          },
          {
            num: '②',
            badge: 'STRONGHOLD',
            ...
            prompt:
              'Why was timber used rather than stone in 1067? How did defenders protect the wooden walls from Saxon fire-arrows?',
          },
          {
            num: '③',
            badge: 'GARRISON',
            ...
            prompt:
              'Name 3 functions housed here (stables, barracks, armoury). Why was keeping Destrier warhorses secure vital?',
          },
          {
            num: '④',
            badge: 'PERIMETER',
            ...
            prompt:
              'How did the deep ditch and sharpened stake palisade stop surprise Saxon night raids? Why fortify the gatehouse most?',
          },
          {
            num: '⑤',
            badge: 'CHOKEPOINT',
            ...
            prompt:
              'If rebels breached the outer bailey, how did this narrow, steep bridge allow defenders to create a deadly bottleneck?',
          },
        ],
        synthesis: {
      ...
      narrative_blocks: [
          ...
          images: [
            {
              ...
              caption:
                'Source A: A modern reconstruction drawing of a typical Norman motte and bailey castle.',
              image_context:
                'The Normans built hundreds of these wooden castles across England in the immediate aftermath of 1066 to establish military dominance over local populations. They were quick to build (often using forced English labour) and psychologically terrifying to the locals.',
              provenance_clue:
                'Although this is a modern reconstruction based on archaeological digs, it reflects the layout described in medieval chronicles and depicted in the Bayeux Tapestry, making it highly reliable for understanding Norman defensive designs.',
            },
            {
              ...
              image_context:
                'A fantastic local example is Portchester Castle. Although originally built as a Roman shore fort, the Normans recognized its strategic coastal importance. They adapted the site and constructed a massive stone keep within the old Roman walls in the late 11th century. This towering fortress would have dominated the local landscape around Fareham and Portsmouth harbour, acting as a terrifying symbol of Norman power and military might.',
              provenance_clue:
                'This is a photograph of the actual structure that survives today. While it was later expanded by subsequent kings, the core square keep is a magnificent example of early Norman monumental stone architecture.',
            },
          ],
          tasks: [
            {
              ...
              lines: 10,
              question:
                'Task 1: Sketch a Motte and Bailey castle and label the key defensive features (Motte, Keep, Bailey, Palisade, Ditch).',
              model_answer:
                'Students should draw a large mound (Motte) with a wooden tower (Keep) on top, connected by a bridge to a lower enclosure (Bailey) surrounded by a wooden fence (Palisade) and a moat (Ditch).',
            },
            {
              type: 'short_answer',
              question:
                'Task: Look at Source B (Portchester Castle). Why would this towering stone keep be absolutely terrifying for the local English peasants who lived in small wooden huts?',
              model_answer:
                'It was huge, permanent, and indestructible to ordinary weapons. It was a physical reminder that the Normans were there to stay and could not be defeated.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          source_context:
            'The Anglo-Saxon Chronicle was a year-by-year record of events in England, maintained by English monks who deeply resented the Norman takeover.',
          provenance_clue:
            "This source was written by Anglo-Saxon monks who lived through the conquest. Their tone is highly hostile and resentful, which reflects the deep anger ordinary English people felt about William's total control and heavy taxation, although the factual details of the survey's thoroughness are accurate.",
          tasks: [
            {
              type: 'flow_diagram',
              question:
                'Task 3: Create a flow diagram tracking how the Domesday survey was carried out from 1085 to 1086.',
              model_answer:
                '[Step 1: In 1085, William faces the threat of a Danish invasion and needs money to pay for a large army.]\n↓\n[Step 2: At Christmas 1085, William orders a complete survey of England to find out the wealth of his kingdom.]\n↓\n[Step 3: Royal commissioners travel to every shire, questioning local people about land ownership, livestock, resources, and values.]\n↓\n[Step 4: The detailed information is compiled and edited down into a single manuscript called the Domesday Book in 1086.]\n↓\n[Step 5: William uses the book to tax his subjects efficiently and confirm that Norman lords hold the land.]',
              lines: 5,
            },
            {
              type: 'short_answer',
              question:
                'Task 3: Look at the visual image of the Domesday Book in the Key Individuals section. Why was having all of this information written down in a permanent book so terrifying for the English population?',
              model_answer:
                'Writing it down permanently meant there was no escape. The King knew exactly who owned what, meaning the English could never avoid his taxes or hide their wealth from the new Norman lords.',
            },
          ],
        },
        {
          ...
          image_context:
            "In 1086, the manor of Fareham (recorded as 'Ferneham') was held by the Bishop of Winchester (Walkelin). The survey recorded valuable local assets, including multiple mills, fisheries along the inlet, woodland for pigs, and dozens of tenant households (villagers and smallholders). Nearby manors around Stubbington and Titchfield show how land was transferred directly into the hands of Norman tenants-in-chief and their sub-tenants.",
          provenance_clue:
            'The Domesday Book is the most famous public record in British history. Because it was an official government tax record compiled under oath, its factual data regarding land ownership and resources is considered incredibly reliable by historians.',
          tasks: [
            {
              type: 'short_answer',
              question:
                'Task 4: Local History Investigation. Look at the Domesday records for our local area. Explain what resources were recorded in Fareham and what this reveals about how Norman control impacted our local community.',
              model_answer:
                'In the Domesday Book of 1086, the manor of Fareham was held by the Bishop of Winchester, just as it had been before the conquest. The survey recorded valuable local assets, including multiple mills, fisheries along the inlet, woodland for pigs, and dozens of tenant households. This local evidence shows that the Domesday Survey reached every corner of Hampshire, ensuring that even small coastal settlements like Fareham and Stubbington were accurately recorded, heavily taxed, and placed firmly under the control of Norman leaders and bishops.',
            },
          ],
        },
        {
          ...
          tasks: [
            {
              type: 'extended_writing',
              question:
                "Task 5: Review the timeline of William's consolidation of power. Which method (Castles, Terror, or the Domesday Book) do you think was the most effective in securing his control? Explain your reasoning.",
              model_answer:
                'I believe terror (the Harrying of the North) was the most effective method because it completely broke the will of the English people to resist. While castles provided defensive bases and the Domesday Book provided administrative control, it was the catastrophic famine and mass death caused by the Harrying that permanently ended the threat of large-scale rebellion.',
            },
          ],
          flashcards: [
            {
            ...
            },
            {
              term: '1069-1070',
              definition:
                'The Harrying of the North crushes northern resistance through starvation and destruction.',
            },
            {
              term: '1071',
            ...
            },
            {
              term: '1085-1086',
              definition:
                'The Domesday Survey is ordered and completed, recording every taxable asset in England.',
            },
            {
              term: '1087',
      ...
      vocab: [
        {
          term: 'Motte',
          definition:
            'A steep, artificial earthen mound constructed to support a fortified wooden or stone keep.',
        },
        {
          term: 'Bailey',
          definition:
            'An enclosed courtyard at the base of the motte, housing barracks, stables, workshops, and kitchens.',
        },
        {
          term: 'Palisade',
          definition:
            'A sturdy wooden defensive wall built from sharpened vertical timbers enclosing the motte and bailey.',
        },
        {
          term: 'Harrying',
          definition:
            'A brutal military campaign to systematically destroy crops, livestock, and homes to starve a population into submission.',
        },
        {
          term: 'Tenant-in-chief',
          definition:
            'A powerful Norman baron or bishop who held land directly from the king in exchange for military service and knights.',
        },
        {
          term: 'Domesday Book',
          definition:
            'The exhaustive 1086 survey of landholding, wealth, and agricultural resources across England ordered by William the Conqueror.',
        },
      ],
      do_now: {
        type: 'questions',
        items: [
          {
            question:
              'Which powerful English Earl claimed the throne because of a deathbed promise?',
            answer: 'Harold Godwinson.',
          },
          {
    ...
    },
    {
      ...
      teacher_notes: {
        primer:
          "This lesson focuses on the dramatic conflict between King Henry II and his former friend Archbishop Thomas Becket over legal jurisdiction and church independence, culminating in Becket's shocking murder.",
        objectives: [
          {
            objective:
              "Understand Henry II's motives for appointing Thomas Becket as Archbishop of Canterbury.",
            primer:
              'Use the visual source to prompt discussion about the intended relationship between Crown and Church versus the reality that unfolded.',
            question:
              "Hinge Question: Why did Henry believe that appointing his best friend would solve the problem of 'criminous clerks'?",
          },
          {
            objective:
              'Evaluate the reasons for the complete breakdown in relations between Henry and Becket.',
            primer:
              "Direct students to analyze Becket's letter. Emphasize the clash between secular law (Constitutions of Clarendon) and spiritual independence.",
            question:
              "Hinge Question: How does Becket's letter reveal that their conflict was fundamentally about who had the higher authority: the King or God?",
          },
          {
            objective: 'Analyze the events of the murder in 1170 and its aftermath.',
            primer:
              "Guide students through the flow diagram of escalating events. Discuss the significance of Henry's public penance.",
            question:
              "Hinge Question: Why might Edward Grim's account of the murder be highly accurate yet also biased?",
          },
        ],
      },
      narrative_blocks: [
        {
          ...
          image_caption:
            'An illuminated manuscript miniature from the early 14th century depicting King Henry II pointing a finger in animated debate with Archbishop Thomas Becket, who is dressed in full episcopal vestments holding a pastoral staff.',
          image_context:
            'This medieval manuscript illustration shows the formal interaction between royal and spiritual authority in twelfth-century England. It captures the political tension between the monarch demanding secular allegiance and the archbishop asserting spiritual independence.',
          provenance_clue:
            'Nature: An illuminated manuscript created over a century after the events. Origin: Produced by medieval English monks who revered Becket as a saint. Purpose: Designed to illustrate the divine moral authority of the Church standing firm against temporal royal power.',
          tasks: [
            {
              type: 'short_answer',
              question:
                'Task 1: Explain why Henry II chose to appoint Thomas Becket as Archbishop of Canterbury in 1162, and explain why this appointment backfired.',
              model_answer:
                "Henry II appointed Thomas Becket because Becket had proven to be a fiercely loyal Chancellor since 1155, dedicated to enforcing royal taxation and expanding crown power. Henry believed that by placing his closest ally at the head of the English Church, he could control ecclesiastical courts, eliminate the benefit of clergy, and bring churchmen under royal law. The plan backfired completely because upon his consecration, Becket underwent a radical spiritual transformation. Becket immediately resigned the Chancellorship against the King's wishes, adopted an austere monastic lifestyle, and declared his absolute devotion to God and the Pope. Instead of subordinating the Church to the Crown, Becket became its most uncompromising defender.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          source: {
            ...
            question:
              'Task 3: Source Inference (Source C)\nLook at Source C. Make two inferences about how the monk who witnessed the murder viewed the knights who killed Thomas Becket. Support each inference with a detail from the source.',
            task_type: 'source_analysis',
          },
          source_context:
            'Edward Grim was a visiting clerk from Cambridge who was present inside Canterbury Cathedral during the attack, sustaining a severe arm injury while attempting to shield Becket from the knights.',
          provenance_clue:
            'Nature: An eyewitness written account from a contemporary clerk. Origin: Written shortly after Becket was canonised as a saint in 1173. Purpose: Valuable for its precise first-hand detail of the murder, but designed specifically to present Becket as a pious, fearless martyr dying for Christ rather than an intransigent political opponent.',
          tasks: [
            {
              type: 'creative_writing',
              instruction:
                "Task 2: Eyewitness Report. Look closely at the manuscript illumination of Becket's murder. Imagine you are a terrified monk hiding behind the pillars of Canterbury Cathedral on 29 December 1170. Write a short eyewitness report describing the horrifying scene as the four knights attack the Archbishop.",
              model_answer:
                'I was hiding in the shadows of the cathedral when the four knights burst in, their swords drawn. The Archbishop stood bravely before the altar. I watched in horror as Reginald FitzUrse struck the first blow. The knights hacked at Becket until his skull was split open, his blood spilling onto the sacred floor. It was a nightmare of screaming and clashing steel.',
            },
          ],
        },
      ],
      vocab: [
        {
          term: 'Common Law',
          definition:
            'A unified system of legal principles and royal court judgements that applied equally across the whole realm of England.',
        },
        {
          term: 'Canon Law',
          definition:
            'The internal ecclesiastical legal code enforced exclusively by Church courts.',
        },
        {
          term: 'Benefit of Clergy',
          definition:
            'The special legal privilege of ordained churchmen to be tried in lenient Church courts rather than royal secular courts.',
        },
        {
          term: 'Constitutions of Clarendon',
          definition:
            'A set of 16 articles issued in 1164 by Henry II seeking to restrict Church privileges and curb papal power in England.',
        },
        {
          term: 'Excommunication',
          definition:
            "A formal decree of exclusion from Catholic Church sacraments and community, cutting off the sinner's hope of salvation.",
        },
        {
          term: 'Martyr',
          definition:
            'A person who is murdered or endures suffering for refusing to renounce their religious principles.',
        },
      ],
      do_now: {
        type: 'questions',
        items: [
          ...
          {
            question:
              'What type of castles did the Normans first build to control England rapidly?',
    ...
    },
    {
      ...
      teacher_notes: {
        primer:
          "This lesson focuses on the reign of King John, examining the cascading failures that led to the Barons' rebellion and the sealing of Magna Carta, while challenging pupils to evaluate its immediate reality versus its long-term mythological legacy.",
        objectives: [
          {
            objective:
              "Understand the multiple reasons for the barons' anger towards King John by 1215.",
            primer:
              "Use the visual source to contrast the ideal of a powerful, divinely-backed monarch with John's humiliating reality of lost lands and excommunication.",
            question:
              "Hinge Question: Why did the combination of military failure and religious crisis make John's financial extortion so unbearable for the barons?",
          },
          {
            objective:
              'Analyze the key clauses of Magna Carta and how they limited absolute royal power.',
            primer:
              "Focus on Clause 39 and Clause 61. Ensure pupils understand that 'free men' was a very exclusive category in 1215.",
            question:
              "Hinge Question: Why is it significant that Clause 39 only protected 'free men' rather than all people in England?",
          },
          {
            objective:
              'Evaluate whether Magna Carta was a triumph of liberty or a selfish baronial power grab.',
            primer:
              'Guide pupils through the historical debate. Highlight the irony that a failed peace treaty designed to protect wealthy nobles inadvertently became the global foundation of democracy.',
            question:
              'Hinge Question: Why did subsequent kings keep re-issuing a document that originally failed to bring peace in 1215?',
          },
        ],
      },
      narrative_blocks: [
        {
          ...
          image_caption:
            'A thirteenth-century manuscript illumination from the Historia Anglorum by Matthew Paris, depicting King John seated upon his throne holding a church building.',
          image_context:
            'This medieval illustration depicts King John attempting to assert his authority over English affairs. Medieval chroniclers often represented monarchs alongside symbols of their political and religious relationships to highlight royal governance.',
          provenance_clue:
            "Nature: A manuscript illumination. Origin: Produced by Matthew Paris, a Benedictine monk writing at St Albans Abbey decades after John's death. Purpose: Consider how a monastic chronicler, influenced by the Church's memory of the Papal Interdict and excommunication, might portray John's character and rule.",
          tasks: [
            {
              type: 'matching',
              ...
              model_answer:
                'Normandy -> Military Failure | Pope -> Religious Dispute | Scutage -> Financial Extortion',
            },
          ],
        },
        {
      ...
      vocab: [
        {
          term: 'Angevin Empire',
          definition:
            'The vast collection of territories ruled by the Plantagenet kings, stretching from the Scottish border to the Pyrenees.',
        },
        {
          term: 'Scutage',
          definition:
            "A tax paid by barons instead of providing personal military knight service to the monarch ('shield money').",
        },
        {
          term: 'Papal Interdict',
          definition:
            'A severe decree by the Pope closing all churches and suspending religious services and burials across an entire country.',
        },
        {
          term: 'Magna Carta',
          definition:
            'The Great Charter of liberties agreed by King John at Runnymede in 1215, legally restraining the tyrannical power of the crown.',
        },
        {
          term: 'Clause 39',
          definition:
            'The celebrated clause in Magna Carta establishing that no free man can be imprisoned or stripped of rights without lawful trial.',
        },
        {
          term: 'Habeas Corpus',
          definition:
            'The fundamental legal principle protecting individuals from arbitrary arrest and detention without fair trial.',
        },
      ],
      do_now: {
        type: 'questions',
      ...
      historical_interpretations: {
        ...
        question:
          'Which interpretation is more convincing? Use your knowledge of medieval society to support your answer.',
        scaffold:
          'I find Interpretation [A/B] more convincing because... For example, I know that...',
      },
      pair_share: {
        prompt:
          'Discuss with your partner: Do you think the Magna Carta was about freedom for all people, or just the barons protecting their own wealth?',
        think: 'Spend 1 minute quietly considering the question and forming your own opinion.',
        pair: 'Discuss your thoughts with your partner. Identify where your ideas agree and where they differ.',
        share: "Share your pair's combined conclusion with the class.",
      },
      vocab_cloze_text:
        'King John faced bankruptcy trying to defend his vast [Angevin Empire] against King Philip Augustus of France. John angered his barons by extorting excessive [Scutage] and provoked Innocent III into placing England under a devastating [Papal Interdict]. Facing open armed rebellion in 1215, John was forced to sign [Magna Carta] at Runnymede. Its most famous guarantee, [Clause 39], laid the foundation for civil liberties and the principle of [Habeas Corpus], ensuring that the king was not above the law.',
      vocab_deliberate_error:
        'In 1215, King John willingly signed Magna Carta to grant universal liberty to all English peasants, abolishing Scutage and establishing modern Habeas Corpus for the Angevin Empire.',
    },
    {
      ...
      vocab: [
        {
          term: 'Villein',
          definition:
            "A medieval peasant legally bonded to the lord's manor, who owed unpaid agricultural labour and could not leave without permission.",
        },
        {
          term: 'Tithe',
          definition:
            'A compulsory annual tax of one-tenth of all farm produce or livestock paid by villagers to the parish church.',
        },
        {
          term: 'Doom Painting',
          definition:
            'A vivid church wall mural depicting the Last Judgement, warning villagers of eternal damnation in Hell.',
        },
        {
          term: 'Purgatory',
          definition:
            'In medieval Catholic belief, a terrifying realm where souls underwent purifying torment before entering Heaven.',
        },
        {
          term: 'Harvest',
          definition:
            'The critical late-summer season when grain was reaped, determining whether a village would eat or starve during winter.',
        },
        {
          term: 'Strip Farming',
          definition:
            'The open-field agricultural system where peasant holdings were divided into scattered narrow strips across large shared fields.',
        },
      ],
      do_now: {
        type: 'short_answer',
        question:
          'Recall: What was the name of the document King John was forced to seal in 1215, and why was it so significant?',
        answer:
          'Magna Carta. It was significant because it established that the King was not above the law.',
      },
      narrative_blocks: [
        {
          ...
          source: {
            ...
            source_context:
              'This image shows the inside of a parish church with villagers gathering, trading, and talking, with no fixed seating in the nave.',
            provenance_clue:
              "This is a modern historical reconstruction based on descriptions from medieval accounts, such as Geoffrey Chaucer's writings, and archaeological evidence of medieval church structures. It is highly useful for showing the diverse social activities that took place inside religious buildings.",
          },
          tasks: [
            {
              type: 'short_answer',
              question:
                'Task 1: Explain why the parish church was the most important building in a medieval village, referencing both its religious and community uses.',
              model_answer:
                'The parish church was the most important building because it served both religious and social purposes. Religiously, it towered over the village as a constant reminder of God, and its bells paced the working day. It was where peasants went for essential life events like baptisms, marriages, and burials. Socially, because there were no pews, the church acted as a weatherproof community centre where villagers held markets, shared news, celebrated feasts, and watched plays, making it the hub of daily life.',
              lines: 5,
            },
            {
              type: 'short_answer',
              question:
                'Task: Look at Source A (The Medieval Church Interior). List three different activities taking place in the church other than praying.',
              model_answer:
                'In Source A, you can see people trading goods, socialising/talking with their neighbours, and walking their dogs.',
            },
            {
              type: 'short_answer',
              question:
                'Task: Look at Source A (the medieval parish church). Identify three different activities taking place inside the church, showing that it was used for more than just praying.',
              model_answer:
                'Students should identify people trading/selling goods, a dog running around, people talking/gossiping, and the priest delivering a sermon.',
            },
          ],
        ...
        },
        {
          ...
          source: {
            ...
            source_context:
              'This text records the specific amounts of grain, wool, and livestock that each household in a local manor was legally required to surrender to the church tithe barn.',
            provenance_clue:
              'This source is an official church taxation ledger from the late fourteenth century. While it is highly reliable for showing the exact quantities of goods extracted from the peasantry, it represents the perspective of the tax-collecting authorities rather than the peasants who actually paid it.',
          },
          tasks: [
            {
              type: 'extended_writing',
              question:
                'Task 2: Describe what a tithe was, how it was collected, and why it caused tension between ordinary medieval peasants and the Church.',
              model_answer:
                "A tithe was a compulsory tax where peasants had to give 10% of their annual harvest or goods produced (such as crops, wool, or livestock) to the Church. It was collected by the parish priest and stored in large tithe barns. This tax caused massive tension because it was a severe economic burden on poor peasants who were already struggling to survive. Seeing the Church amass huge wealth and land—owning one-third of England—while they starved made many peasants resentful of the clergy's luxury and the threat of eternal damnation if they failed to pay.",
              lines: 8,
            },
          ],
        ...
        },
        {
          ...
          source: {
            ...
            source_context:
              'This large wall painting depicts the weighing of souls, a ladder to Heaven, and graphic scenes of sinners being tortured by demons in Hell.',
            provenance_clue:
              'As a genuine medieval artwork painted directly onto a church wall, this source is extremely reliable for showing exactly what medieval peasants saw every Sunday and how the Church used visual terror to control their behaviour.',
          },
          tasks: [
            {
              type: 'creative_writing',
              instruction:
                "Task 3: Design your own modern Doom Painting. Medieval Doom Paintings used demons and hellfire to scare peasants into behaving. If you were painting a 'Doom Painting' for a 21st-century audience, what modern fears (e.g., pollution, technology, war) would you include to warn people about their behavior? Describe your painting.",
              model_answer:
                "In my modern Doom Painting, instead of demons, the sinners would be dragged down by tangled wires and glowing screens representing our obsession with technology. The landscape of 'Hell' would be a wasteland of plastic pollution and smog, warning people that destroying the planet is a terrible sin.",
            },
            {
              type: 'drawing',
              lines: 8,
              question:
                'Task: Sketch your own terrifying Doom Painting monster (Hellmouth or demon) that would have scared medieval peasants into obeying the Church.',
              model_answer:
                'Students should draw a grotesque monster or demon, demonstrating an understanding of how fear of Hell was used to control the peasant population.',
            },
          ],
    ...
    },
    {
      ...
      teacher_notes: {
        primer:
          'This lesson explains how the devastating biological shock of the Black Death fundamentally shattered the rigid feudal hierarchy by changing the economic balance of power between lords and peasants.',
        objectives: [
          {
            objective:
              'Understand why the medieval population was medically and socially defenseless against the Black Death in 1348.',
            primer:
              'Use the mass burial visual source to convey the sheer scale of the death toll. Discuss the absence of germ theory.',
            question:
              'Hinge Question: Why did the medieval belief that the plague was a punishment from God actually make the outbreak spread faster?',
          },
          {
            objective:
              'Explain how the severe labor shortage shifted economic power from the nobility to the peasantry.',
            primer:
              'Direct pupils to the extract from the Statute of Labourers. Highlight the panicked reaction of the landowning elite.',
            question:
              'Hinge Question: Why did the Statute of Labourers ultimately fail to stop peasants from demanding higher wages?',
          },
          {
            objective:
              'Analyze the long-term structural and psychological breakdown of the feudal system.',
            primer:
              'Guide pupils through the flow diagram to show cause and effect. Discuss the Danse Macabre as a reflection of societal trauma.',
            question:
              'Hinge Question: How did the Danse Macabre art style reflect the new reality that the traditional feudal hierarchy had lost its power?',
          },
        ],
      },
      narrative_blocks: [
        {
          ...
          image_caption:
            'A medieval miniature illumination from the fourteenth century depicting priests and citizens burying dozens of plague victims in mass graves outside the city walls.',
          image_context:
            'Medieval artists frequently illustrated scenes of communal burial to convey the overwhelming scale of death that inundated towns and villages during 1348 and 1349.',
          provenance_clue:
            'Nature: A contemporary medieval artwork. Origin: Created by a chronicler recording the disaster. Purpose: Consider how visual depictions of chaotic mass burials reveal the total breakdown of ordinary religious funeral rites and municipal order during the crisis.',
          tasks: [
            {
              type: 'physician_game',
              text: 'Task 1: The Plague Doctor. Play the role of a medieval physician and try to cure the infected patients.',
              model_answer:
                'Students play the interactive game to learn about the ineffective medieval cures based on the Four Humours.',
            },
          ],
        },
        {
          ...
          source_context:
            'This legislation was enacted by King Edward III and the English Parliament, a governing body composed entirely of wealthy noble landlords, bishops, and knights who depended on cheap peasant labor to maintain their estates.',
          provenance_clue:
        ...
        },
        {
          ...
          image_caption:
            'A woodcut illustration depicting the Danse Macabre (Dance of Death), showing skeletal figures leading individuals of every social hierarchy—including an emperor, a bishop, a merchant, and a peasant laborer—toward the grave.',
          image_context:
            'The Danse Macabre became a dominant artistic and literary theme across late medieval Europe in the decades following the Black Death, illustrating the inescapable reality of mortality across all social classes.',
          provenance_clue:
            'Nature: A popular woodcut illustration. Origin: The decades following the Black Death. Purpose: This artwork represents a widespread cultural response to the trauma of 1348. Consider how the image reflects a changing social mentality where the rigid feudal hierarchy is shown to be completely meaningless in the face of universal death.',
          tasks: [
            {
              type: 'extended_writing',
              question:
                "Task 3: The Plague Doctor's Diary (Empathetic Writing)\nWrite a diary entry as a physician in 1348. Explain the horrifying symptoms you are witnessing in your patients, the 'cures' you are attempting to use (such as bloodletting or carrying sweet-smelling herbs), and why you believe they are failing due to your lack of germ theory.",
              model_answer:
                'Diary Entry, August 1348: The pestilence has arrived and it is terrifying. My patients are developing agonizing, dark buboes in their armpits and coughing up blood. I have tried bleeding them to balance their humours, and I carry sweet herbs to ward off the miasma, but nothing works because we do not understand the invisible poison causing this tragedy.',
              lines: 10,
            },
          ],
        },
      ...
      vocab: [
        {
          term: 'Bubonic Plague',
          definition:
            'A bacterial pandemic spread by infected black rat fleas, causing high fever and painful swellings called buboes.',
        },
        {
          term: 'Miasma',
          definition:
            "The widespread medieval belief that diseases were generated and spread through noxious, foul-smelling 'bad air'.",
        },
        {
          term: 'Flagellants',
          definition:
            "Religious radicals who whipped themselves publicly in penance to appease God's anger and halt the plague.",
        },
        {
          term: 'Statute of Labourers',
          definition:
            'A parliamentary law passed in 1351 attempting to cap wages and prevent surviving peasants from demanding higher pay.',
        },
        {
          term: 'Yeoman',
          definition:
            'A prosperous, independent peasant farmer who acquired substantial landholdings and social mobility after the plague.',
        },
        {
          term: 'Danse Macabre',
          definition:
            "The 'Dance of Death' artistic motif showing skeletons leading monarchs, bishops, and peasants equally to the grave.",
        },
      ],
      do_now: {
        type: 'questions',
    ...
    },
    {
      ...
      teacher_notes: {
        primer:
          "This lesson explores the explosive climax of decades of social tension following the Black Death. It examines the short and long-term causes of the 1381 Peasants' Revolt, the shocking breach of royal security in London, and the ambiguous legacy of the uprising.",
        objectives: [
          {
            objective:
              "Identify the long-term economic and short-term political causes of the Peasants' Revolt.",
            primer:
              "Focus on the transition from the anger over the Statute of Labourers to the immediate spark of the 1380 Poll Tax. Highlight John Ball's radical preaching.",
            question:
              'Hinge Question: Why was the 1380 Poll Tax considered far more unfair than traditional medieval taxes?',
          },
          {
            objective:
              'Analyze the extent of the threat posed by the rebels when they captured London.',
            primer:
              "Use the visual source of Archbishop Sudbury's execution to discuss the total collapse of royal security. Emphasize that the rebels targeted advisors, not the young King.",
            question:
              "Hinge Question: What does the rebels' treatment of Archbishop Sudbury reveal about who they blamed for their problems?",
          },
          {
            objective: 'Evaluate the immediate outcome and long-term consequences of the revolt.',
            primer:
              "Guide pupils through the events at Smithfield using the flow diagram. Discuss how Richard II's broken promises compared to the long-term decline of serfdom.",
            question:
              "Hinge Question: Despite the rebels being defeated and executed, why can the Peasants' Revolt still be seen as a long-term victory for the lower classes?",
          },
        ],
      },
      narrative_blocks: [
        {
          ...
          source_context:
            'John Ball was a radical priest who travelled the countryside preaching equality before the revolt, despite being banned by the Church and imprisoned three times by the Archbishop of Canterbury.',
          provenance_clue:
            'Nature: A quote recorded in a historical chronicle. Origin: Written by Jean Froissart, an aristocratic chronicler who wrote for wealthy patrons and regarded Ball as a "foolish" extremist. Purpose: Consider why upper-class writers would portray Ball\'s calls for social equality as dangerous and sinful madness.',
          tasks: [
            {
              type: 'creative_writing',
              instruction:
                'Task 2: Speechwriting. You are the radical priest John Ball. Write a short, rousing speech to deliver to the peasant army before they march on London. Make sure you mention your anger about the Poll Tax, the unfairness of serfdom, and the greed of the Archbishop of Canterbury.',
              model_answer:
                'Brothers and sisters! When Adam delved and Eve span, who was then the gentleman? God created us all equal, yet we are treated like beasts of burden! They crush us with this wicked Poll Tax while the fat Archbishop of Canterbury hoards gold in his palaces. We march on London not as rebels, but as free men, to demand our rights from the King! Tear up the tax rolls!',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          image_caption:
            "A manuscript illumination from Jean Froissart's Chronicles showing the confrontation at Smithfield, depicting Mayor William Walworth striking down Wat Tyler while King Richard II rallies the surrounding peasant crowd.",
          image_context:
            'Medieval chronicles and art created for the royal court universally framed the King and Mayor Walworth as heroic defenders of peace against chaotic rebellion.',
          provenance_clue:
            "Nature: Royal manuscript illumination. Origin: Produced for the aristocracy. Purpose: Look closely at how Wat Tyler is positioned: medieval illustrators often framed him with a drawn dagger or aggressive posture to justify the Mayor's lethal violence as self-defence on behalf of the monarch.",
          tasks: [
            {
              type: 'flow_diagram',
              question:
                "Task 3: Create a 5-step chronological flow diagram showing the key events of the Peasants' Revolt from the initial march on London to the execution of the rebel leaders.",
              model_answer:
                "[Step 1: Wat Tyler and rebel bands from Kent and Essex march on London, burning manorial rolls and tax records along the route.]\n↓\n[Step 2: The rebels enter London, destroy John of Gaunt's Savoy Palace, and storm the Tower of London to execute Archbishop Simon Sudbury.]\n↓\n[Step 3: King Richard II meets Wat Tyler at Smithfield, where Tyler is attacked and mortally wounded by the Mayor of London, William Walworth.]\n↓\n[Step 4: Richard II boldly defuses the furious crowd by promising to be their leader and granting charters ending serfdom, convincing the peasants to go home.]\n↓\n[Step 5: Richard II revokes all charters, sends troops into the countryside to crush resistance, and executes Wat Tyler, John Ball, and other rebel leaders.]",
              lines: 5,
            },
          ],
        },
      ...
      vocab: [
        {
          term: 'Poll Tax',
          definition:
            'A deeply unpopular flat-rate tax of 12 pence levied in 1380 on every English person aged 14 and over, regardless of wealth.',
        },
        {
          term: 'John Ball',
          definition:
            "A radical hedge priest who preached social equality, famously asking: 'When Adam delved and Eve span, who was then the gentleman?'",
        },
        {
          term: 'Wat Tyler',
          definition:
            'The charismatic rebel leader from Kent who directed the 1381 uprising and led thousands of peasants into London.',
        },
        {
          term: 'Simon Sudbury',
          definition:
            'The Archbishop of Canterbury and Chancellor who was dragged from the Tower of London and executed by the rebels.',
        },
        {
          term: 'Smithfield',
          definition:
            "The open field outside London's walls where Richard II confronted Wat Tyler and the rebel host on 15 June 1381.",
        },
        {
          term: 'Manorial Rolls',
          definition:
            'Official parchment ledgers recording peasant servile obligations, which were systematically burned during the uprising.',
        },
      ],
      do_now: {
        type: 'questions',
    ...
    },
    {
      ...
      teacher_notes: {
        primer:
          "This lesson closes the 100-year gap between the Peasants' Revolt and the Tudor period. It explores the chaotic 30-year civil war between the Houses of Lancaster and York, the mystery of the Princes in the Tower, and the climactic Battle of Bosworth where Henry Tudor seized the throne.",
        objectives: [
          {
            objective:
              'Explain the causes of the Wars of the Roses and the division between Lancaster and York.',
            primer:
              'Use the symbolism of the red and white roses to explain the dynastic struggle.',
            question:
              'Hinge Question: Look at Source A. Why is it dangerous for historians to rely on this painting for factual evidence?',
          },
          {
            objective:
      ...
      vocab: [
        {
          term: 'Dynasty',
          definition:
            'A continuous hereditary succession of rulers from the same royal family or bloodline.',
        },
        {
          term: 'House of Lancaster',
          definition:
            'The royal branch of the Plantagenet dynasty represented by a red rose, claiming the throne through John of Gaunt.',
        },
        {
          term: 'House of York',
          definition:
            'The rival royal branch represented by a white rose, claiming descent from Lionel of Antwerp and the Duke of York.',
        },
        {
          term: 'Usurp',
          definition:
            'To seize royal authority or the throne unlawfully, unjustly, or by armed force.',
        },
        {
          term: 'Battle of Bosworth',
          definition:
            'The decisive 1485 engagement where Richard III was killed and Henry Tudor triumphed to claim the English crown.',
        },
        {
          term: 'Tudor',
          definition:
            'The Welsh-English royal dynasty established by Henry VII that united York and Lancaster, ending the Wars of the Roses.',
        },
      ],
      do_now: {
        type: 'short_answer',
        question:
          "Recall: In what year did the Peasants' Revolt take place, and who was its main leader?",
      ...
      narrative_blocks: [
          ...
          tasks: [
            {
              type: 'short_answer',
              question:
                'Task 1: Explain what caused the Wars of the Roses to break out in 1455, and describe how this instability affected the English monarchy over the next thirty years.',
              model_answer:
                'The Wars of the Roses broke out in 1455 primarily because of the weakness of the Lancastrian King, Henry VI, who was unfit to rule effectively. This created a power vacuum that allowed the wealthy and powerful House of York to challenge his right to the throne, claiming a stronger hereditary bloodline. Over the next thirty years, this instability caused extreme chaos, resulting in the crown changing hands six times as rival noble factions fought, betrayed one another, and executed their opponents to seize power.',
              lines: 6,
            },
            {
              type: 'short_answer',
              question:
                'Task: Look at Sources A and B. Why was it important for rival noble houses to have simple, recognizable badges like the Red and White Roses during a chaotic civil war?',
              model_answer:
                "In the chaos of a medieval battlefield, where many soldiers couldn't read and armour made it hard to recognize people, simple visual badges were essential for soldiers to know who was friend and who was foe.",
            },
          ],
        ...
        },
        {
          ...
          source: {
            ...
            provenance_clue:
              "Mancini was an independent Italian observer with no personal political stake in the English royal succession, making his contemporary observations about public panic and the princes' confinement highly reliable, although he could only report on rumours of their deaths rather than direct proof.",
          },
      ...
      vocab_cloze_text:
        'The Wars of the Roses was a thirty-year civil conflict between two rival branches of the Plantagenet [Dynasty]. The struggle pitted the red rose of the [House of Lancaster] against the white rose of the [House of York]. Both sides repeatedly sought to [Usurp] the crown through bloody coups and assassinations. The devastating war concluded in 1485 at the [Battle of Bosworth], where the last Plantagenet king fell and Henry VII founded the enduring [Tudor] dynasty.',
      vocab_deliberate_error:
        'The Wars of the Roses concluded in 1485 when the House of York decisively crushed Henry Tudor at the Battle of Bosworth, allowing Richard III to secure an enduring Yorkist Dynasty.',
    },
    {
      ...
      teacher_notes: {
        primer:
          "This is a capstone assessment lesson. Rather than regurgitating previous narratives, it tests students' ability to synthesize knowledge from the entire unit. The lesson involves chronological retrieval practice, evaluation of differing historical interpretations, and scaffolding for a 12-mark essay.",
        objectives: [
          {
            objective: 'To accurately sequence the key events of the medieval period.',
            primer:
              'Instruct students to complete the Domino Flowchart timeline, focusing on chronological and causal links between events.',
            question:
              "Which event directly caused the severe labour shortage that eventually led to the Peasants' Revolt?",
          },
          {
            objective: 'To evaluate differing historical interpretations of medieval royal power.',
            primer:
              'Read Interpretations A and B with the class. Discuss why historians might have such different views depending on which century they focus on.',
            question:
              'Why might a historian focusing on King John have a very different view of royal power than one focusing on William the Conqueror?',
          },
          {
            objective: 'To write a structured essay explaining the decline of royal power.',
            primer:
              'Use the essay planning block to outline the PEEL structure. Encourage students to use evidence from at least three different centuries.',
      ...
      vocab: [
        {
          term: 'Feudalism',
          definition:
            'The hierarchical medieval social and political system based on land tenure in exchange for military service and loyalty.',
        },
        {
          term: 'Harrying',
          definition:
            'Systematic military devastation and scorched-earth warfare used by Norman kings to crush rebellion through famine.',
        },
        {
          term: 'Excommunication',
          definition:
            'The most severe spiritual weapon of the Church, expelling a person from the sacraments and threatening damnation.',
        },
        {
          term: 'Magna Carta',
          definition:
            'The foundational 1215 legal charter establishing the principle that even the monarch is accountable to the law.',
        },
        {
          term: 'Pestilence',
          definition:
            'A virulent, widespread contagious disease, such as the catastrophic Black Death of 1348.',
        },
        {
          term: 'Revolt',
          definition:
            'An armed insurrection or mass uprising of subjects against their governing ruler or oppressive social order.',
        },
      ],
      narrative_blocks: [
        {
        ...
        },
        {
          ...
          source: {
            ...
            source_context:
              'Focuses entirely on the strength of William I and the immediate aftermath of 1066.',
          },
        },
        {
          ...
          source: {
            ...
            source_context:
              "Focuses on how the crown's authority weakened due to baronial rebellions and social changes.",
          },
        },
        {
