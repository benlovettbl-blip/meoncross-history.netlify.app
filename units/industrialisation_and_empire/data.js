          ...
          tasks: [
            {
              ...
              scaffolding: {
                structure_strip: [
                  'PEE Paragraph 1 (Geography): Argue that location near Portsmouth Dockyard provided the vital customer, naval testing facilities, and Solent water transport.',
                  "PEE Paragraph 2 (Innovation): Counter-argue that Cort's technological genius (puddling furnace and rolling mill) solved the chemical crisis that geography alone could never fix.",
                  'Historiographical Verdict: Reach a balanced conclusion weighing whether geography provided the opportunity, but innovation provided the national transformation.',
                ],
                connective_bank: [
                  ...
                  'Conversely, technological innovation was the decisive catalyst because...',
                  'As demonstrated in paragraph [2.3] and Source B...',
                  'Ultimately, it is clear that while geography provided the strategic opportunity...',
                ],
              },
              model_answer:
                "On one hand, geographical proximity to Portsmouth Dockyard was an indispensable condition for the success of Funtley Ironworks. In the late eighteenth century, transporting heavy materials overland was extraordinarily slow and costly; Funtley's position along the River Meon with tidal access to Fareham Creek allowed coal and iron to be barged directly into Portsmouth Harbour [2.2]. Furthermore, Portsmouth Dockyard was the largest industrial consumer of wrought iron on the planet, possessing the specialized master smiths, testing rigs, and naval capital necessary to conduct the decisive 1787 trials (Source C). Without this guaranteed military market on his doorstep, Cort would have lacked both the customer base and the institutional validation required to transform his experiments into national policy.<br><br>Conversely, it would be deeply mistaken to view location as the primary cause of his success. Hundreds of forge sites dotted the English coast, yet British iron remained universally despised as brittle \"pig iron\" for decades. The Royal Navy's problem was chemical, not logistical: pit coal contaminated iron with sulphur, and manual forge hammers were far too slow to meet wartime demand [1.3]. Only Henry Cort's technological genius in inventing the reverberatory puddling furnace (chemically burning off impurities with reflected heat) and the grooved rolling mill (automating the shaping process fifteen-fold) overcame this fundamental scientific barrier (Source B) [2.3]. Portsmouth Dockyard could not buy iron that did not exist; Cort's metallurgical innovation created the product that satisfied their needs.<br><br>Ultimately, while proximity to Portsmouth provided the strategic catalyst and guaranteed customer, technological innovation was the decisive factor. Location offered the economic opportunity, but it was Cort's metallurgical brilliance in mastering the chemistry of puddling that conquered the iron crisis, powered British naval supremacy at Trafalgar, and laid the foundations of the global Industrial Revolution.",
            },
          ],
        },
      ],
