  ...
  lessons: [
    {
        ...
        },
        {
          ...
          tasks: [
            ...
            },
            {
              ...
              model_answer:
                "The cross-section in Source A shows that the burning coal is kept separate from the melting iron. This prevented the carbon in the coal from mixing with the iron, allowing workers to 'puddle' (stir) the iron and burn off the remaining impurities, creating strong wrought iron.",
            },
          ],
        },
        {
      ...
      primary_source_dossier: {
        title: 'Henry Cort & Funtley Ironworks: Primary Source Archival Dossier',
        pdf: '/pdfs/henry_cort_funtley_primary_source_pack.pdf',
        description:
          'Downloadable 1-page archival research pack featuring Cort’s 1784 patent drawings, River Meon survey maps, and Admiralty Portsmouth Dockyard trial minutes to support enquiry and competition entries.',
      },
      sources: [
        {
        ...
        {
          title: 'Source B: Hampshire Administrative Map & River Meon (1832)',
          caption:
            'An authentic 1832 map showing the county of Hampshire, highlighting the River Meon watercourse connecting Funtley to Fareham Quay and Portsmouth Harbour.',
          src: '/images/map_hampshire_1832.png',
          question:
            'Why was the natural watercourse of the River Meon essential to Henry Cort’s rolling mills before steam power was widely adopted in Hampshire?',
          model_answer:
            'Before steam engines were universally installed, Cort relied on the powerful flow of the River Meon to turn heavy waterwheels, which provided the mechanical force needed to drive his massive grooved iron-rolling cylinders.',
          qNum: 3,
          hinge_question:
            'How does the geography of Hampshire, particularly its access to the coast and rivers, help explain why industrial sites like Funtley Ironworks were so successful?',
        },
        {
          title: 'Source C: Admiralty Navy Board Portsmouth Dockyard Trial Report (March 1784)',
          caption:
            'Official Navy Board trials conducted at Portsmouth Dockyard testing Cort’s Funtley iron against imported Swedish Orgrounds iron.',
          content:
          ...
          model_answer:
            'The Royal Navy was the most demanding iron customer in the world. Proving that Funtley iron was equal to superior Swedish imports meant Britain could become self-sufficient in wartime naval shipbuilding without relying on foreign trade.',
          qNum: 4,
        },
      ],
      exam_practice: {
