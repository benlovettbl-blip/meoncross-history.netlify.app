  ...
  lessons: [
    {
      ...
      teacher_notes: {
        ...
        delivery_plan: {
          ...
          lesson_1: {
            title: 'Lesson 1: Immersion, Shared Reading & Hampshire Archaeology (50 mins)',
            phases: [
              {
                time: '00–10m',
                label: 'Hook & Prior Retrieval',
                instruction:
                  'Display Source A (Coalbrookdale by Night). Connect the shift to concentrated coal power with prior recall of the domestic system and waterwheels.',
              },
              {
                time: '10–30m',
                label: 'Modelled Shared Reading',
                instruction:
                  'Read Acts 1 & 2 together (or project web app with natural UK audio at 1.0x). Pause at Act 1 to interrogate the Baltic naval import crisis.',
              },
              {
                time: '30–45m',
                label: 'Archival & Fieldwork Analysis',
                instruction:
                  'Study Source B and the Funtley Fieldwork Dossier. Contrast the 1784 watercolour with surviving River Meon weir and Hampshire’s only puddling slag wall.',
              },
              {
                time: '45–50m',
                label: 'Formative Hinge Plenary',
                instruction:
                  'Conduct check for understanding on Hinge Question 2: How does an iron slag dry-stone wall prove Cort’s chemical puddling process succeeded?',
              },
            ],
          },
          lesson_2: {
            title: 'Lesson 2: The Portsmouth Trials, Historiography & Extended Writing (50 mins)',
            phases: [
              {
                time: '00–10m',
                label: 'Spaced Retrieval & Vocab Anchor',
                instruction:
                  'Complete retrieval check in printed workbook. Review crucial distinction: Brittle Pig Iron vs. Tough Naval Wrought Iron.',
              },
              {
                time: '10–25m',
                label: 'Shared Reading & Historiographical Debate',
                instruction:
                  'Read Acts 3 & 4. Debate competing historical verdicts: Was Cort’s triumph driven by geographical proximity to Portsmouth Dockyard or metallurgical genius?',
              },
              {
                time: '25–45m',
                label: 'Workbook Application (Pages 4–5)',
                instruction:
                  'Pupils complete the reverberatory furnace annotation, Admiralty trial evaluation, and 18-line PEEL extended writing using the Gold Criteria Strip.',
              },
              {
                time: '45–50m',
                label: 'Live Exemplar Debrief',
                instruction:
                  'Peer assessment or live visualiser critique of high-level student responses against the departmental evaluative criteria.',
              },
            ],
          },
        },
      ...
      timeline_anchor: [
        {
          ...
          desc: 'James Watt patents the separate condenser, transforming coal into rotative mechanical power and triggering an insatiable demand for machinery iron.',
        },
        {
          date: '1775–1780',
          title: 'The "Pig Iron" Crisis',
          desc: 'British blast furnaces produce brittle, sulphur-choked iron; the Royal Navy dangerously depends on Baltic imports from Sweden and Russia.',
        },
        {
          date: '1783–1784',
          title: "Cort's Funtley Breakthrough",
          desc: 'Henry Cort masters the reverberatory puddling furnace and grooved rolling mill on the River Meon, securing domestic self-sufficiency.',
        },
        {
          date: 'March 1787',
          title: 'Portsmouth Dockyard Triumph',
          desc: "Admiralty hammer trials prove Funtley iron equals the world's finest Swedish Orgrounds, securing British naval supremacy.",
        },
      ],
      narrative_blocks: [
        {
          title: 'Act 1: The Rotten Secret: Britain\'s "Pig Iron" Nightmare (1750–1780)',
          text: '<span class="para-ref">[1.1]</span> Before the mid-eighteenth century, Britain was an agrarian realm shackled to the slow rhythms of the seasons and the limits of human muscle. In cramped stone cottages across Hampshire, Yorkshire, and the Cotswolds, families spun wool and hammered metal under the <strong>domestic system</strong>. Machines were crude wooden contraptions enslaved to the weather: waterwheels ground to a halt during parched summer droughts or froze solid in winter frosts, windmills depended on fickle gusts, and draft horses consumed costly oats. Production was painfully slow, exhausting, and strictly limited in scale.<br><br><span class="para-ref">[1.2]</span> The fire that shattered this ancient ceiling was <strong>coal</strong>. Buried deep beneath the British landscape lay vast, concentrated seams of fossilized sunlight, packed with far greater thermal energy than all the timber forests of Europe. In 1769, Scottish mathematical instrument maker <strong>James Watt</strong> patented his separate condenser for the steam engine, transforming coal into smooth, relentless rotative power. Watt\'s invention severed manufacturing from geography: factories no longer had to cling to remote rushing rivers. Steam engines could roar anywhere coal could be carted, driving multi-storey textile mills, deep mine pumps, and colossal iron machinery.<br><br><span class="para-ref">[1.3]</span> But as factory chimneys multiplied, Britain\'s industrial miracle collided with a terrifying, humiliating bottleneck: <strong>iron</strong>. To build high-pressure boilers, piston rods, factory gears, and bridges, engineers needed tough, bendable <strong>wrought iron</strong>. British blast furnaces, however, could only produce crude <strong>"pig iron"</strong>. The molten metal earned this peculiar name because when it poured from the blast furnace down a central sand trench into dozens of smaller side-moulds, it looked uncannily like a litter of squealing piglets suckling from a mother sow. Worse still, British pit coal was choked with foul, yellow sulphur. When smelted, the sulphur poisoned the molten metal, leaving pig iron as brittle as glass. Strike a bar of British pig iron with a blacksmith\'s hammer, or subject it to high-pressure steam, and it shattered into lethal flying shrapnel.<br><br><span class="para-ref">[1.4]</span> This chemical flaw threatened national survival. The <strong>Royal Navy</strong>—Britain\'s wooden wall of defense—depended on thousands of tons of flawless, flexible wrought iron for hull bolts, rudder irons, mast hoops, and multi-ton anchors for colossal 100-gun battleships like <em>HMS Victory</em>. If an anchor bolt snapped in an Atlantic gale, a warship was doomed. Because British iron was useless, Britain was forced to import over 50,000 tons of premium wrought iron every single year from Sweden and Russia across the stormy Baltic Sea. If the Baltic froze over, or if enemy French and Spanish fleets blockaded the sound, the Royal Navy would rot in harbour. On the eve of global war, the mighty British Empire was held hostage by foreign iron.',
          ...
          source: {
            ...
            hinge_question:
              'Why did the shift from water power to coal-fired blast furnaces transform both Britain’s physical landscape and the daily autonomy of its workers?',
        ...
        {
          title: 'Act 2: The Obsessive Gambler at Funtley Ironworks (1775–1784)',
          text: '<span class="para-ref">[2.1]</span> The crisis was felt nowhere more acutely than along the Hampshire coastline. Just fifteen miles down the Solent lay <strong>Portsmouth Royal Navy Dockyard</strong>—the largest industrial complex on Earth and the beating military heart of the British Empire. Royal Navy shipwrights were desperate for iron. An energetic former naval supply agent named <strong>Henry Cort</strong> recognized a once-in-a-lifetime opportunity: whoever could unlock a way to turn cheap, brittle British pig iron into naval-grade wrought iron would secure an immense fortune from the Admiralty.<br><br><span class="para-ref">[2.2]</span> In 1775, Cort bet his life savings. He leased the old corn mill at <strong>Funtley</strong> along the quiet River Meon, just north of Fareham. Funtley was an inspired gamble: the rushing river supplied continuous water power to turn heavy mill wheels, while Fareham Creek gave him direct tidal water transport down Portsmouth Harbour straight into the Royal Dockyard.<br><br><span class="para-ref">[2.3]</span> Between 1783 and 1784, working amid blistering heat and flying sparks, Cort patented two epoch-making breakthroughs that fundamentally transformed modern metallurgy:<br>1. <strong>The Reverberatory Puddling Furnace (1783):</strong> Cort designed a furnace with an arched brick roof that kept the coal fire physically separate from the iron. The coal burned in a side chamber, and the curved masonry bounced (reverberated) pure, radiant heat down onto the shallow hearth like a giant oven. The dirty coal smoke and sulphur never touched the metal! In front of this blistering 1,200°C inferno stood the "puddler"—a skilled artisan who slid a 10-foot iron paddle through a porthole, stirring the bubbling liquid metal like a witch\'s cauldron. As he stirred, oxygen reacted with the molten soup, burning away carbon until the iron thickened into glowing, pasty balls of pure wrought iron.<br>2. <strong>The Grooved Rolling Mill (1784):</strong> Instead of having teams of exhausted blacksmiths slowly hammer the hot iron blooms by hand for hours, Cort fed the glowing metal directly through pairs of water-driven, grooved iron rollers. In seconds, the rollers squeezed out remaining liquid slag and compressed the metal into uniform naval bolts, bars, and rails at <strong>fifteen times the speed</strong> of traditional forge hammers.<br><br><span class="para-ref">[2.4]</span> <strong>Fieldwork Archaeology: The Surviving Hydraulic Footprint:</strong> Although Cort\'s ironworks were later dismantled, the physical anatomy of this industrial breakthrough remains etched into the Hampshire landscape along the River Meon at Funtley. When historians compare the 1784 framed contemporary watercolour of Fontley Iron Mills against modern fieldwork photographs, the site\'s industrial layout becomes clear. The 1784 painting depicts an active, smoking forge: dense black plumes rise from the reverberatory puddling furnace chimney, workers maneuver glowing metal, and water surges into the mill race. Today, the River Meon still plunges over the surviving 18th-century stone weir and sluice gate that directed hydraulic energy into the works. Directly beside the waterfall, the curved circular brick housing marks the exact position of Cort\'s massive waterwheel, which supplied the horsepower needed to drive his patented grooved rolling mill.<br><br><span class="para-ref">[2.5]</span> <strong>Forensic Metallurgy: Puddling Slag & Hampshire\'s Only Slag Wall:</strong> The chemical reality of Cort\'s puddling process left an indestructible archaeological fingerprint: <strong>iron slag</strong> (clinker). As molten iron was stirred and squeezed through rollers, glassy silicate impurities were separated and discarded in massive mounds around the forge. Over two centuries later, the owner of the surviving mill property excavated tons of this heavy, dark, pitted clinker from the soil and built a dry-stone perimeter wall bordering the lawn—creating the <strong>only iron slag wall in Hampshire</strong>. Nearby stands <strong>Fontley House</strong>, the Georgian red-brick residence of Cort\'s business partner Samuel Jellicoe. Crowning its roofline are authentic 18th-century chimney pots known as <strong>Fareham "Tallboys"</strong>, crafted from the region\'s famous vibrant red terracotta clay with distinctive crimped white-slip collars. Together, these landscape relics prove how local Hampshire geography, natural hydraulics, and innovative metallurgy combined to create a world-changing industrial powerhouse.',
          image_alt:
          ...
          source: {
            ...
            hinge_question:
              'How did separating coal fuel from refining metal in an arched air furnace solve the Royal Navy’s materials crisis?',
            image: '/images/funtley_ironworks.jpg',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'How does this trial report demonstrate that the Industrial Revolution was driven as much by naval military necessity as commercial profit?',
          ...
          tasks: [
            {
              ...
              scaffolding: {
                guidance:
                  'Write a structured 3-paragraph historical evaluation using the structure strip below. Use specific facts and vocabulary from Acts 1–4.',
                structure_strip: [
                  {
                    col: '1. Immediate Impact',
                    prompt:
                      'Explain how Cort’s puddling furnace and grooved rollers boosted British iron production 15 times and stopped Britain relying on foreign Baltic iron [1.3, 2.3, 3.2].',
                    starter:
                      'The immediate significance of Henry Cort’s puddling process was that it solved Britain’s dangerous dependence on...',
                  },
                  {
                    col: '2. Long-Term Changes',
                    prompt:
                      'Explain how cheap, strong wrought iron transformed Victorian Britain over time—making it possible to build steam engines, railways, and iron warships [1.2, 3.2, 4.1].',
                    starter:
                      'Over time, Cort’s mass-produced wrought iron transformed Victorian Britain by...',
                  },
                  {
                    col: '3. Overall Evaluative Judgment',
                    prompt:
                      'Weigh whether Cort’s metallurgical breakthrough was the primary catalyst for British industrial supremacy, or whether coal and Watt’s steam engine were more foundational [1.2, 4.2].',
                    starter:
                      'Ultimately, I judge that Cort’s puddling process was [exceptionally / partly] significant because...',
                  },
                  {
                    col: '★ Scholar’s Edge (Extension)',
                    prompt:
                      'Evaluate how Dr Jenny Bulstrode’s (2023) research into 76 enslaved Black metallurgists at Morant Bay, Jamaica challenges the traditional narrative of industrial innovation [4.3].',
                    starter:
                      'Furthermore, recent historiographical research by Dr Jenny Bulstrode reveals that this traditional narrative must be re-evaluated because...',
                  },
                ],
                sentence_starters: [
                  'The immediate breakthrough of Henry Cort’s puddling furnace (1783) at Funtley was...',
                  'Prior to Cort’s patents, British blast furnaces produced brittle pig iron, which meant...',
                  'As certified in the official 1787 Portsmouth Dockyard trials (Source C), Funtley iron was...',
                  'Over time, mass-produced wrought iron transformed Britain’s infrastructure because...',
                  'Without tough, malleable iron, key innovations such as Watt’s steam engines and railways would have...',
                  'Ultimately, I judge that Cort was decisive because while coal and steam provided the power, iron provided the...',
                  '★ Furthermore, research by Dr Jenny Bulstrode (2023) complicates this narrative by showing that...',
                ],
                connective_bank: [
                  ...
                  'Crucially, this acted as an industrial catalyst for...',
                  'Weighing these factors, it is evident that...',
                  'Ultimately, the decisive reason was...',
                ],
                word_bank: [
                  'Domestic System',
                  'James Watt',
                  'Rotative Steam Engine',
                  'Pig Iron (Brittle, high-sulphur)',
                  'Wrought Iron (Malleable, naval-grade)',
    ...
    },
    {
      ...
      narrative_blocks: [
        {
          ...
          source: {
            ...
            hinge_question:
              'How does the physical danger of child labour in steam factories illustrate the human cost of industrial mechanization?',
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'How does the construction of the Royal Albert Hall prove that Victorian imperial architecture relied directly on local Hampshire industrial manufacturing?',
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did firsthand testimonies before the Sadler Committee shock the British public into demanding parliamentary factory legislation?',
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'Why were visual depictions of child labour often more politically powerful in shifting public opinion than dry statistical reports?',
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Rickets', 'Cholera', 'Byssinosis (brown lung)', 'Scurvy'],
      ...
      narrative_blocks: [
        {
          ...
          source: {
            ...
            hinge_question:
              'Does Doré portray the railway as a triumph of modern engineering or as an intrusive monster dominating the lives of the working poor?',
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'How did satirical magazines like Punch use dark visual humor to pressure politicians into taking public health reform seriously?',
            image: '/images/court_for_king_cholera.png',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did Chadwick use a direct comparison to wartime casualties to shock Victorian MPs out of their laissez-faire complacency?',
            text: '“The charcoal-burners, the brick-makers, and the miners are all exposed to severe atmospheric changes and filth. In the town districts, the crowded back-to-back dwellings are built with no ventilation, and the refuse of the houses is thrown into open streets. The annual loss of life from filth and bad ventilation is greater than the loss from death or wounds in any wars in which the country has been engaged in modern times.”',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'What does local archival evidence in Hampshire reveal about the universal reach of 19th-century sanitary failure?',
      ...
      narrative_blocks: [
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did Victorian cartographers place Britain at the physical center of world maps, and how did this shape British imperial identity?',
            image: '/images/map_empire_1886.jpg',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'How did industrial iron and steam technology convert the Royal Navy from an armed sailing fleet into an invincible instrument of global coercion?',
            image: '/images/hms_warrior.jpg',
            caption:
      ...
      narrative_blocks: [
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did the annexation of Awadh directly threaten the prestige and economic security of high-caste sepoy soldiers?',
            image: '/images/sepoy_mutiny_1857.png',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              "How did Rani Lakshmibai’s martyrdom transform the 1857 uprising from a soldier's revolt into a powerful national legend?",
            image: '/images/indian_rebellion_1857.jpg',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'What evidence does Source C provide that the 1857 Rebellion was motivated by economic destruction as well as religious grievance?',
            text: '“It is well known that in these days all the English are entertaining a design to destroy the religion and faith of both the Hindoos and Muslims. Under the Badshahi (Mughal) government, the artisans were employed in the service of the King and nobles, but the British Government has ruined the native artisans by introducing English manufactured goods into India. We call upon all Zemindars, merchants, and soldiers to unite and root out this treacherous race.”',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did the British Crown publicly pledge religious neutrality in 1858, and did this truly change the reality of imperial rule?',
    ...
    },
    {
      ...
      narrative_blocks: [
        {
          ...
          source: {
            ...
            hinge_question:
              "How does Cruikshank's satirical caption connect parliamentary disenfranchisement to economic class oppression?",
            text: '“Down with ’em! Chop ’em down, my brave boys! Give them no quarter! Remember, the more you kill, the less poor rates you will have to pay!”\n— Caption to Cruikshank’s satirical engraving, capturing the public outrage over the cavalry assault at St Peter’s Field.',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did the British government treat the formation of a peaceful agricultural trade union as an act of treason?',
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did the sheer scale and discipline of this working-class crowd terrify the aristocratic government?',
            image: '/images/chartist_demo.jpg',
            caption:
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Robert Owen', 'William Lovett', "Feargus O'Connor", "Henry 'Orator' Hunt"],
        ...
        },
        {
          ...
          options: ['William Lovett', 'Arthur Wellesley', 'Edwin Chadwick', 'George Loveless'],
        ...
        },
        {
          ...
          options: ['The Suffragettes', 'The Luddites', 'The Trade Union Congress', 'Chartism'],
          answer: 'Chartism',
        },
        {
          question:
      ...
      narrative_blocks: [
        {
          ...
          source: {
            ...
            hinge_question:
              'Why did the geography of parliamentary representation fail to reflect the economic reality of the Industrial Revolution?',
            image: '/images/map_rotten_boroughs.jpg',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'How does Source B illustrate that the 1832 Reform Act was designed to prune the corrupt branches of Parliament rather than uproot the aristocracy?',
            image: '/images/old_rotten_tree.jpg',
            caption:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'Why was the introduction of the secret ballot box the decisive turning point that allowed the working class to vote freely?',
            image: '/images/secret_ballot.jpg',
            caption:
    ...
    },
    {
      ...
      narrative_blocks: [
        ...
        },
        {
          ...
          source: {
            letter: 'B',
            title:
              'Source B: Friedrich Engels, The Condition of the Working Class in England (1845)',
            context:
        ...
        },
        {
          ...
          source: {
            ...
            hinge_question:
              'How does Leech use visual contrast in Source D to challenge the Victorian narrative of universal industrial progress?',
            image: '/images/capital_labour.jpg',
            caption:
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Pug boys', 'Piecers', 'Trappers', 'Chimney sweeps'],
          answer: 'Pug boys',
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Cholera', 'Typhoid', 'Tuberculosis', 'Smallpox'],
          answer: 'Cholera',
        },
        {
          question:
            'Who published an 1842 report proving that slums were deadlier than modern wars?',
          options: ['Lord Shaftesbury', 'Edwin Chadwick', 'Charles Dickens', 'Henry Cort'],
          answer: 'Edwin Chadwick',
        },
        {
          question:
        ...
        },
        {
          ...
          options: ['Chartism', 'The Swing Rioters', 'Trade Unionism', 'Suffragettes'],
          answer: 'Chartism',
        },
        {
          question:
