      ...
      narrative_blocks: [
        {
          ...
          tasks: [
            {
              type: 'causal_domino',
              title: 'Causal Chain: From Continental Isolation to Existential Crisis (1348–1453)',
              instruction:
                'Using paragraphs [1.1]–[1.3], analyze the chain of catalysts that locked Western Europe into rural isolation before 1450.',
              steps: [
                {
                  stage: 'Stage 1',
                  year: '1348–50',
                  title: 'Demographic Devastation',
                  desc: 'The Black Death wipes out 30–50% of the European population, shattering rural labour markets.',
                },
                {
                  stage: 'Stage 2',
                  year: '1337–1453',
                  title: 'Dynastic Exhaustion',
                  desc: "The Hundred Years' War drains the treasuries of England and France in destructive continental conflict.",
                },
                {
                  stage: 'Stage 3',
                  year: 'c. 1450',
                  title: 'Commercial Impoverishment',
                  desc: 'Explain why European kingdoms could not directly buy Asian goods with domestic agricultural produce:',
                  blank: true,
                  prompt: 'Explain the export deficit:',
                },
                {
                  stage: 'Stage 4',
                  year: '1453',
                  title: 'The Outer Periphery',
                  desc: 'Europe remains an isolated fringe, producing no manufactured exports desired by Asian merchants.',
                },
              ],
            },
          ],
          ...
          tasks: [
            {
              ...
              title: 'Priority Diamond: Decisive Factors Behind Europe’s Forced Oceanic Turn',
              instruction:
                'Using paragraphs [2.1]–[2.3], evaluate and rank the four decisive drivers that forced European monarchs into the Atlantic.',
              factors: [
                {
                  id: 'ottoman_blockade',
                  label:
                    'Ottoman Control of Constantinople (1453 siege severing Christian overland access to the Silk Roads)',
                },
                {
                  id: 'elite_spice_demand',
                  label:
                    'Insatiable Aristocratic Demand (Desperate elite need for Asian pepper, silk, and spices to preserve status)',
                },
                {
                  id: 'bronze_cannon_technology',
                  label:
                    "Ottoman Military Superiority (Mehmed II's siege artillery proving European land armies could not retake the Levant)",
                },
                {
                  id: 'monopoly_tariffs',
                  label:
                    'Crushing Venetian & Ottoman Customs Duties (Extravagant transit taxes making overland Asian imports unaffordable)',
                },
              ],
              justification_prompt:
                'Justify your Rank 1 selection: Why was this factor the primary catalyst for Europe turning to the Atlantic?',
              starter:
                'The Ottoman conquest of Constantinople was the decisive catalyst because without...',
            },
          ],
        },
        {
          ...
          tasks: [
            {
              type: 'ledger_audit',
              title: 'Forensic Ledger: The Global Balance of Power in 1450',
              instruction:
                'Using Source C, Source D, and paragraphs [3.1]–[3.3], contrast European economic marginality with Afro-Asian imperial wealth.',
              left_title: 'Western European Realities (The Periphery)',
              right_title: 'Afro-Asian Imperial Realities (The Core)',
              left_points: [
                'Over 90% of population bound to rural subsistence farming eating bland oat pottage [1.2].',
                "Demographic collapse from the Black Death and devastation from the Hundred Years' War [1.1].",
                'Virtually zero gold reserves and no manufactured exports desired by Asian merchants [1.3].',
                'Completely severed from overland Silk Road transit routes following the 1453 Ottoman conquest [2.3].',
              ],
              right_points: [
                'Mansa Musa of Mali commanding vast gold reserves, depressing Cairo gold value for a decade [3.1, Source C].',
                'Kingdom of Benin building 10,000 miles of earthwork walls and sophisticated bronze metallurgy [3.2, Source D].',
                'Ming Dynasty China commanding 100m people with compass, gunpowder, and printing monopolies [3.3].',
                'Admiral Zheng He sailing 400ft multi-deck Treasure Fleets across the Indian Ocean [3.3].',
              ],
              synthesis_prompt:
                'Historical Audit: Why does comparing primary evidence from Benin, Mali, and China decisively shatter the Eurocentric myth of 1450?',
              starter:
                'Primary evidence shatters the Eurocentric myth because it demonstrates that in 1450, Europe was not...',
            },
          ],
        },
        {
          ...
          tasks: [
            {
              ...
              question:
                'Enquiry Essay: "To what extent is it historically accurate to describe Western Europe in 1450 as an impoverished, powerless periphery compared to the great empires of Asia and Africa?"',
              scaffolding: {
                structure_strip: [
                  'PEE Paragraph 1 (European Periphery & Poverty): Argue that Europe was weak and impoverished, citing peasant living conditions, demographic collapse, and the Ottoman blockade of Constantinople [1.1–1.3, 2.3].',
                  "PEE Paragraph 2 (Afro-Asian Superpowers): Demonstrate that real wealth and technology lay in Asia and Africa, citing Mansa Musa's Malian gold, Benin bronze engineering, and Zheng He's Chinese Treasure Fleets [3.1–3.3, Sources C & D].",
                  "Historiographical Verdict: Evaluate Pomeranz's thesis: Was Europe's later oceanic voyage driven by civilizational superiority or desperate geographic and commercial weakness?",
                ],
                connective_bank: [
                  'From an archival perspective, describing Western Europe in 1450 as an impoverished periphery is highly accurate because...',
                  'As demonstrated in paragraph [1.2] and Source A, the vast majority of Europeans...',
                  'Furthermore, the 1453 Ottoman conquest of Constantinople proved that...',
                  'Conversely, the great imperial centers of Africa and Asia commanded unmatched wealth, as evidenced by...',
                  'In China, the technological sophistication of the Ming Dynasty was demonstrated by...',
                  'Ultimately, in evaluating the balance of global power in 1450, modern historians like Pomeranz argue that...',
                ],
              },
              model_answer:
                "From an archival perspective, it is entirely historically accurate to describe Western Europe in 1450 as an impoverished, powerless periphery compared to the colossal empires of Asia and Africa. As documented in paragraphs [1.1]–[1.3], mid-fifteenth-century Europe was reeling from the catastrophic mortality of the Black Death and the economic exhaustion of the Hundred Years’ War. Over ninety percent of Europeans were subsistence agricultural peasants enduring dark wattle-and-daub huts, sleeping beside livestock, and consuming bland pottage (Source A). Europe produced no manufactured commodities desired in foreign markets, possessed minimal precious metals, and was commercially marginalized. The total military dominance of the Islamic world was underscored in May 1453, when Sultan Mehmed II's Ottoman armies deployed 26-foot bronze super-cannons to shatter Constantinople, closing the overland Silk Road and turning the Mediterranean into a fortified Muslim lake [2.2, 2.3].<br><br>In stark contrast, global wealth, urbanism, and technological innovation were anchored firmly in Africa and Asia. As evidenced in paragraphs [3.1]–[3.3], the Empire of Mali commanded the trans-Saharan gold trade, with Emperor Mansa Musa distributing so much bullion on his 1324 pilgrimage that he collapsed the value of gold across Cairo, earning him the title of the world’s wealthiest monarch on the 1375 Catalan Atlas (Source C). In the rainforests of Nigeria, the Kingdom of Benin constructed over 10,000 miles of defensive earthwork ramparts and cast magnificent lost-wax bronze relief plaques that rivalled the finest European art (Source D). Most decisively, Ming Dynasty China was an industrial and maritime titan of 100 million citizens that had pioneered gunpowder, printing, and the compass centuries ahead of the West. Between 1405 and 1433, Admiral Zheng He commanded seven multi-deck Treasure Fleets with 400-foot vessels that sailed unchallenged across the Indian Ocean to East Africa, dwarfing the tiny 60-foot caravels Columbus would sail decades later.<br><br>Ultimately, modern global historians such as Kenneth Pomeranz and Peter Frankopan demonstrate that Europe's subsequent expansion into the Atlantic was born not of civilizational superiority, but of desperate weakness. Locked out of the lucrative Mediterranean and Asian trade networks by Ottoman tariffs, European monarchs had no choice but to take existential oceanic gambles using borrowed Asian compasses and Arab navigational sails. Therefore, in 1450, Western Europe was undeniably an isolated, impoverished periphery in a world whose wealth and power were defined by the Islamic, African, and Asian civilizations.",
            },
          ],
        },
      ],
