  ...
  lessons: [
    {
      ...
      primary_source: {
        ...
        shelfmark: 'Königlich Preußische Landesaufnahme / Cartographic Record 1871',
        citation:
          'Königlich Preußische Landesaufnahme (Berlin, 1871); Comparative Historical Atlas of Europe',
        context:
      ...
      sources: [
        {
          ...
          shelfmark: 'Reichsamt für Landesaufnahme, 1871',
          citation:
            'Treaty of Frankfurt Boundary Commission / Reichsland Elsaß-Lothringen Geodetic Survey (1871)',
        },
        {
      ...
      sources: [
        {
          ...
          caption:
            'Official 1914 cartographic survey illustrating the complete division of the African continent following thirty years of imperial expansion under the Berlin Act of 1885.',
          shelfmark: 'War Office Geographical Section, General Staff No. 2639',
          citation:
            'British General Staff, Geographical Section No. 2639 (London: War Office, 1914)',
          context:
    ...
    },
    {
      ...
      sources: [
        {
          title: 'Map A: The North Sea & Naval Chokepoints (Hydrographic Survey)',
          src: '/units/great_war/assets/map_lesson3.png',
          caption:
            'Strategic hydrographic chart of the North Sea showing the shallow German Bight, the English Channel bottleneck, and the northern naval blockade patrol lines between Scotland and Norway.',
          shelfmark: 'Admiralty Hydrographic Office Chart No. 2182',
          citation: 'British Admiralty Hydrographic Office, General Chart of the North Sea, 1914',
          context:
      ...
      sources: [
        {
          ...
          caption:
            'Analytical matrix diagram mapping the interlocking bilateral and multilateral mutual defence pacts dividing Europe into the Triple Alliance and Triple Entente.',
          shelfmark: 'Foreign Office Historical Section Cartography FO 899/4',
          citation:
            'Historical Cartography Archive, Meoncross Educational Foundation (Based on British Foreign Office State Papers, 1879–1914)',
          context:
        ...
        },
        {
          ...
          caption:
            'Geopolitical map of Europe in 1914 showing the central bloc of the Central Powers (brown) surrounded by the Triple Entente (green), highlighting the volatile ethnic fault lines within Austria-Hungary.',
          question:
          ...
          shelfmark: "Bartholomew's Comparative Map of Europe, Geodetic Survey 1914",
          citation: 'John Bartholomew & Co., The Edinburgh Geographical Institute (1914 Edition)',
          context:
    ...
    },
    {
      ...
      sources: [
        {
          title: 'Diagram A: The July Crisis Domino Effect (28 June – 4 August 1914)',
          src: '/units/great_war/assets/july_crisis.svg',
          caption:
            'Chronological causal diagram illustrating the thirty-seven days of escalating ultimatums and mobilisations following the assassination of Archduke Franz Ferdinand.',
          shelfmark: 'Austro-Hungarian July Ultimatum & Diplomatic Dispatch Archive',
          citation:
            'Diplomatic History Archive, Meoncross Educational Foundation (Based on British Blue Book & German White Book Dispatches, 1914)',
          context:
        ...
        },
        {
          ...
          src: '/units/great_war/assets/balkans_1914_simple_map.png',
          caption:
            'Cartographic diagram showing the expansion of Serbia and the Balkan states following the Balkan Wars of 1912–13, bordering the Austro-Hungarian provinces of Bosnia and Herzegovina.',
          shelfmark: 'Austro-Hungarian Militärgeographisches Institut 1913 / General Staff Chart',
          citation:
            'Militärgeographisches Institut Wien, Balkankarte 1913 (Historical Military Survey)',
          context:
        ...
        },
        {
          ...
          caption:
            "Official contemporary police sketch map of the Franz Josef Street intersection along the Appel Quay, marking the exact positions of the assassins and the fateful wrong turn taken by the Archduke's chauffeur.",
          shelfmark: 'Sarajevo Police & Court Archive Acc. 1914-FJ-6',
          citation:
            'Landesgericht Sarajevo, Untersuchungsakten zum Attentat vom 28. Juni 1914, Akte Nr. 1914-FJ-6',
          context:
