const great_war = {
  ...
  quizPack: [
    ...
    },
    {
      ...
      a: 'Realpolitik',
      options: ['Realpolitik', 'Pan-Slavism', 'Weltpolitik (World Policy)', 'Mitteleuropa'],
      id: 'gw_q10',
    },
    {
    ...
    },
    {
      ...
      a: 'Gunboat Diplomacy',
      options: ['Appeasement', 'Gunboat Diplomacy', 'Dollar Diplomacy', 'Risk Theory'],
      id: 'gw_q14',
    },
    {
      q: 'What was the name of the German gunboat sent to Agadir in 1911?',
      a: 'SMS Panther',
      options: ['HMS Dreadnought', 'SMS Bismarck', 'SMS Panther', 'SMS Emden'],
      id: 'gw_q15',
    },
    {
    ...
    },
    {
      ...
      a: 'The Balkans',
      options: ['The Middle East', 'The Balkans', 'The Rhineland', 'The Caucasus'],
      id: 'gw_q21',
    },
    {
    ...
    },
    {
      ...
      a: 'Bosnia',
      options: ['Bosnia', 'Albania', 'Romania', 'Serbia'],
      id: 'gw_q25',
    },
    {
    ...
    },
    {
      ...
      a: 'June 28, 1914',
      options: ['June 28, 1914', 'August 4, 1914', 'November 11, 1918', 'July 23, 1914'],
      id: 'gw_q29',
    },
    {
      q: 'Who assassinated the Archduke?',
      a: 'Gavrilo Princip',
      options: ['Nedeljko Čabrinović', 'Leon Trotsky', 'Dragutin Dimitrijević', 'Gavrilo Princip'],
      id: 'gw_q30',
    },
    {
    ...
    },
    {
      ...
      a: 'Belgium',
      options: ['Belgium', 'Russia', 'Serbia', 'France'],
      id: 'gw_q50',
    },
  ],
  glossary: [
