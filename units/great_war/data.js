const great_war = {
  ...
  lessons: [
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          a: '18 January 1871',
          options: ['18 January 1871', '1 September 1870', '28 June 1914', '11 November 1918'],
        },
        {
          q: 'Which valuable French territory did Germany seize in 1871?',
          a: 'Alsace-Lorraine',
          options: ['Alsace-Lorraine', 'Normandy', 'Brittany', 'Burgundy'],
        },
        {
          q: 'What was the economic union created by Prussia in 1834 called?',
          a: 'Zollverein',
          options: ['Reichstag', 'Zollverein', 'Wehrmacht', 'Kaiserreich'],
        },
        {
          q: 'Which major German-speaking power was deliberately excluded from the Zollverein?',
          a: 'Austria',
          options: ['Hanover', 'Saxony', 'Bavaria', 'Austria'],
        },
        {
          q: 'What was the German term for the new German Empire?',
          a: 'Kaiserreich',
          options: ['Blitzkrieg', 'Lebensraum', 'Reichstag', 'Kaiserreich'],
        },
        {
        ...
        },
        {
          ...
          a: 'Wilhelm I',
          options: ['Wilhelm I', 'Frederick III', 'Wilhelm II', 'Otto von Bismarck'],
        },
        {
        ...
        },
        {
          ...
          a: 'Napoleon III',
          options: ['Charles de Gaulle', 'Louis XIV', 'Napoleon III', 'Napoleon Bonaparte'],
        },
        {
          q: 'What natural resources was Alsace-Lorraine rich in?',
          a: 'Coal and iron',
          options: ['Coal and iron', 'Gold and silver', 'Oil and gas', 'Timber and wheat'],
        },
        {
    ...
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          a: 'Ems Telegram',
          options: ['Zimmermann Telegram', 'Versailles Dispatch', 'Blank Cheque', 'Ems Telegram'],
        },
        {
          q: 'In what year did the Franco-Prussian War break out?',
          a: '1870',
          options: ['1870', '1871', '1890', '1914'],
        },
        {
        ...
        },
        {
          ...
          a: 'Palace of Versailles',
          options: ['Reichstag Building', 'Palace of Versailles', 'Berlin Palace', 'Notre Dame'],
        },
        {
        ...
        },
        {
          ...
          a: 'Kaiser Wilhelm II',
          options: ['Kaiser Wilhelm I', 'Kaiser Wilhelm II', 'Tsar Nicholas II', 'Franz Joseph'],
        },
        {
        ...
        },
        {
          ...
          a: 'Schlieffen Plan',
          options: ['Schlieffen Plan', 'Plan XVII', 'Bismarck Plan', 'Moltke Offensive'],
        },
        {
          q: 'Which French leader was captured at the Battle of Sedan?',
          a: 'Napoleon III',
          options: ['Napoleon III', 'Georges Clemenceau', 'Louis XVI', 'Charles de Gaulle'],
        },
        {
        ...
        },
        {
          ...
          a: 'Alsace-Lorraine',
          options: ['The Rhineland', 'Alsace-Lorraine', 'Burgundy', 'Normandy'],
        },
        {
          q: 'Who was the Prussian King that was crowned German Emperor?',
          a: 'Wilhelm I',
          options: ['Wilhelm I', 'Frederick the Great', 'Bismarck', 'Wilhelm II'],
        },
        {
    ...
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          a: 'Britain',
          options: ['Belgium', 'Germany', 'France', 'Britain'],
        },
        {
      ...
      quiz: [
        {
          ...
          a: 'HMS Dreadnought',
          options: ['HMS Belfast', 'HMS Dreadnought', 'HMS Victory', 'HMS Invincible'],
        },
        {
          q: 'Which German Admiral was in charge of expanding the German Navy?',
          a: 'Admiral von Tirpitz',
          options: ['Admiral von Tirpitz', 'Admiral Scheer', 'Admiral Hipper', 'Kaiser Wilhelm II'],
        },
        {
    ...
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          a: 'Italy',
          options: ['Romania', 'Italy', 'Bulgaria', 'Ottoman Empire'],
        },
        {
        ...
        },
        {
          ...
          a: 'Italy',
          options: ['Austria-Hungary', 'Britain', 'Italy', 'Germany'],
        },
      ],
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          a: 'The Black Hand',
          options: ['Young Bosnia', 'The White Rose', 'The Black Hand', 'The Red Guards'],
        },
        {
        ...
        },
        {
          ...
          a: 'Austria-Hungary',
          options: ['Germany', 'The Ottoman Empire', 'Austria-Hungary', 'Russia'],
        },
        {
        ...
        },
        {
          ...
          a: 'The Black Hand',
          options: ['The Black Hand', 'Young Bosnia', 'The Red Army', 'The Serbian Guard'],
        },
        {
  ...
  quizPack: [
    ...
    },
    {
      ...
      a: 'Realpolitik',
      options: ['Mitteleuropa', 'Realpolitik', 'Weltpolitik (World Policy)', 'Pan-Slavism'],
      id: 'gw_q10',
    },
    {
    ...
    },
    {
      ...
      a: 'Gunboat Diplomacy',
      options: ['Gunboat Diplomacy', 'Appeasement', 'Risk Theory', 'Dollar Diplomacy'],
      id: 'gw_q14',
    },
    {
      q: 'What was the name of the German gunboat sent to Agadir in 1911?',
      a: 'SMS Panther',
      options: ['SMS Emden', 'SMS Panther', 'HMS Dreadnought', 'SMS Bismarck'],
      id: 'gw_q15',
    },
    {
    ...
    },
    {
      q: 'What revolutionary British battleship was launched in 1906?',
      a: 'HMS Dreadnought',
      options: ['HMS Invincible', 'HMS Dreadnought', 'HMS Victory', 'HMS Iron Duke'],
      id: 'gw_q17',
    },
    {
    ...
    },
    {
      ...
      a: 'The Balkans',
      options: ['The Balkans', 'The Caucasus', 'The Rhineland', 'The Middle East'],
      id: 'gw_q21',
    },
    {
    ...
    },
    {
      ...
      a: 'Bosnia',
      options: ['Bosnia', 'Romania', 'Albania', 'Serbia'],
      id: 'gw_q25',
    },
    {
      q: 'Which major power considered itself the protector of the Slavic people?',
      a: 'Russia',
      options: ['France', 'Russia', 'Germany', 'Britain'],
      id: 'gw_q26',
    },
    {
    ...
    },
    {
      ...
      a: 'June 28, 1914',
      options: ['November 11, 1918', 'August 4, 1914', 'July 23, 1914', 'June 28, 1914'],
      id: 'gw_q29',
    },
    {
      q: 'Who assassinated the Archduke?',
      a: 'Gavrilo Princip',
      options: ['Leon Trotsky', 'Dragutin Dimitrijević', 'Nedeljko Čabrinović', 'Gavrilo Princip'],
      id: 'gw_q30',
    },
    {
    ...
    },
    {
      ...
      a: 'Belgium',
      options: ['Serbia', 'Belgium', 'Russia', 'France'],
      id: 'gw_q50',
    },
  ],
  glossary: [
