const great_war = {
  ...
  lessons: [
    {
      ...
      vocabulary: [
        {
          term: 'Empire',
          definition:
            'A large political unit where one powerful state controls many different peoples and territories.',
        },
        {
          term: 'Nationalism',
          definition:
            "Extreme pride in one's country, often accompanied by a belief in its superiority over others.",
        },
        {
          term: 'Unification',
          definition:
            'The process of bringing separate states together into one nation — Bismarck unified Germany by 1871.',
        },
        {
          term: 'Power',
          definition:
            'The ability of a nation to influence or control others through military, economic, or political strength.',
        },
        {
          term: 'Significance',
          definition:
            'The importance of an event — why German unification mattered for the future of Europe.',
        },
      ],
      ...
      quiz: [
        ...
        },
        {
          ...
          a: '18 January 1871',
          options: ['11 November 1918', '28 June 1914', '1 September 1870', '18 January 1871'],
        },
        {
        ...
        },
        {
          ...
          a: 'Napoleon III',
          options: ['Napoleon Bonaparte', 'Louis XIV', 'Charles de Gaulle', 'Napoleon III'],
        },
        {
          q: 'What natural resources was Alsace-Lorraine rich in?',
          a: 'Coal and iron',
          options: ['Oil and gas', 'Timber and wheat', 'Coal and iron', 'Gold and silver'],
        },
        {
    ...
    },
    {
      ...
      vocabulary: [
        {
          ...
          definition:
            'The border region taken from France by Germany in 1871, creating a lasting source of bitterness.',
        },
        {
          term: 'Revanchism',
          definition:
            "A policy of seeking revenge — France's desire to reclaim Alsace-Lorraine drove its foreign policy.",
        },
        {
          term: 'Humiliation',
          definition: 'The deep sense of national shame felt by France after its defeat in 1871.',
        },
        {
          term: 'Treaty of Frankfurt',
          definition:
            'The 1871 peace treaty that ended the Franco-Prussian War and imposed harsh terms on France.',
        },
        {
          term: 'Long-term cause',
          definition:
            'A factor that built up over many years and contributed to the outbreak of the Great War.',
        },
      ],
      sources: [
        {
      ...
      primary_source: {
        title:
          'Source A: A painting by Anton von Werner from 1885 showing the Proclamation of the German Empire at Versailles.',
      ...
      quiz: [
        ...
        },
        {
          ...
          a: 'Ems Telegram',
          options: ['Versailles Dispatch', 'Ems Telegram', 'Blank Cheque', 'Zimmermann Telegram'],
        },
        {
          q: 'In what year did the Franco-Prussian War break out?',
          a: '1870',
          options: ['1870', '1871', '1914', '1890'],
        },
        {
        ...
        },
        {
          ...
          a: 'Palace of Versailles',
          options: ['Notre Dame', 'Berlin Palace', 'Reichstag Building', 'Palace of Versailles'],
        },
        {
        ...
        },
        {
          ...
          a: 'Kaiser Wilhelm II',
          options: ['Tsar Nicholas II', 'Franz Joseph', 'Kaiser Wilhelm II', 'Kaiser Wilhelm I'],
        },
        {
        ...
        },
        {
          ...
          a: 'France',
          options: ['Austria-Hungary', 'Britain', 'France', 'Italy'],
        },
        {
        ...
        },
        {
          ...
          a: 'Schlieffen Plan',
          options: ['Moltke Offensive', 'Bismarck Plan', 'Plan XVII', 'Schlieffen Plan'],
        },
        {
          q: 'Which French leader was captured at the Battle of Sedan?',
          a: 'Napoleon III',
          options: ['Charles de Gaulle', 'Louis XVI', 'Georges Clemenceau', 'Napoleon III'],
        },
        {
        ...
        },
        {
          ...
          a: 'Alsace-Lorraine',
          options: ['Normandy', 'The Rhineland', 'Burgundy', 'Alsace-Lorraine'],
        },
        {
          q: 'Who was the Prussian King that was crowned German Emperor?',
          a: 'Wilhelm I',
          options: ['Wilhelm I', 'Bismarck', 'Wilhelm II', 'Frederick the Great'],
        },
        {
    ...
    },
    {
      ...
      vocabulary: [
        {
          term: 'Imperialism',
          definition:
            "The policy of extending a country's power through colonisation, trade, or military force.",
        },
        {
          term: 'Colony',
          definition:
            'A territory controlled and settled by a foreign power, often exploited for resources and labour.',
        },
        {
          term: 'Scramble for Africa',
          definition:
            'The rapid division of the African continent among European empires in the late 19th century.',
        },
        {
          term: 'Rivalry',
          definition:
            'Competition and hostility between nations, especially over colonies and global influence.',
        },
        {
          term: 'Trade',
          definition:
            'The exchange of goods and resources — controlling trade routes was a key goal of imperial competition.',
        },
      ],
      sources: [
        {
      ...
      quiz: [
        ...
        },
        {
          ...
          a: 'Britain',
          options: ['Germany', 'Britain', 'Belgium', 'France'],
        },
        {
      ...
      vocabulary: [
        {
          term: 'Arms race',
          definition:
            'A competition between nations to build up military strength, especially between Britain and Germany.',
        },
        {
          term: 'Dreadnought',
          definition:
            'A revolutionary battleship launched by Britain in 1906, triggering an intense naval arms race.',
        },
        {
          term: 'Militarism',
          definition:
        ...
        },
        {
          ...
          definition:
            "Dominance of the seas — Britain's Royal Navy was the cornerstone of its imperial power.",
        },
        {
          term: 'Propaganda',
          definition:
            'Information used to shape public opinion — both sides used it to justify military spending.',
        },
      ],
      sources: [
        {
      ...
      quiz: [
        {
          ...
          a: 'HMS Dreadnought',
          options: ['HMS Victory', 'HMS Belfast', 'HMS Dreadnought', 'HMS Invincible'],
        },
        {
          q: 'Which German Admiral was in charge of expanding the German Navy?',
          a: 'Admiral von Tirpitz',
          options: ['Admiral von Tirpitz', 'Admiral Scheer', 'Kaiser Wilhelm II', 'Admiral Hipper'],
        },
        {
    ...
    },
    {
      ...
      vocabulary: [
        {
          term: 'Alliance',
          definition:
            'A formal agreement between countries to support each other, especially in wartime.',
        },
        {
          term: 'Triple Alliance',
          definition:
            'The military alliance of Germany, Austria-Hungary, and Italy, formed in 1882.',
        },
        {
          term: 'Triple Entente',
          definition: 'The alliance of Britain, France, and Russia, formed by 1907.',
        },
        {
          term: 'Escalation',
          definition:
            'The process of a conflict becoming larger or more serious, drawing in more countries.',
        },
        {
          term: 'Obligation',
          definition:
            'A duty or commitment — alliance obligations meant countries were dragged into war.',
        },
      ],
      sources: [
        {
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['Continental Commitment', 'Weltpolitik', 'Appeasement', 'Splendid Isolation'],
        },
        {
        ...
        },
        {
          ...
          a: 'Italy',
          options: ['Germany', 'Austria-Hungary', 'Britain', 'Italy'],
        },
      ],
    },
    {
      ...
      vocabulary: [
        {
          term: 'Balkans',
          definition:
            'A region in southeastern Europe that was a hotbed of nationalist tensions before 1914.',
        },
        {
          term: 'Assassination',
          definition:
            'The deliberate killing of a political figure — the assassination of Franz Ferdinand triggered the war.',
        },
        {
          term: 'Ottoman Empire',
          definition:
            'The Turkish empire that controlled much of the Balkans but was declining by 1900.',
        },
        {
          term: 'Catalyst',
          definition:
            'An event that triggers a much larger process — the Sarajevo assassination was the catalyst for war.',
        },
        {
          term: 'Powder keg',
          definition: 'A metaphor for a dangerous, volatile situation ready to explode.',
        },
      ],
      sources: [
        {
      ...
      quiz: [
        ...
        },
        {
          ...
          a: 'The Black Hand',
          options: ['The Red Guards', 'The White Rose', 'Young Bosnia', 'The Black Hand'],
        },
        {
          q: 'On what exact date was the Archduke assassinated?',
          a: '28 June 1914',
          options: ['11 November 1918', '4 August 1914', '28 June 1914', '28 July 1914'],
        },
        {
          q: 'Which empire had annexed Bosnia in 1908, angering Serbian nationalists?',
          a: 'Austria-Hungary',
          options: ['Russia', 'The Ottoman Empire', 'Germany', 'Austria-Hungary'],
        },
        {
        ...
        },
        {
          ...
          a: 'The Black Hand',
          options: ['The Serbian Guard', 'The Red Army', 'Young Bosnia', 'The Black Hand'],
        },
        {
  ...
  quizPack: [
    ...
    },
    {
      ...
      a: 'Revanche',
      options: ['Encirclement', 'Pan-Slavism', 'Revanche', 'Weltpolitik'],
      id: 'gw_q3',
    },
    {
    ...
    },
    {
      ...
      options: ['Realpolitik', 'Weltpolitik (World Policy)', 'Lebensraum', 'Splendid Isolation'],
      id: 'gw_q9',
    },
    {
      q: "What previous policy of Bismarck's focused on European peace?",
      a: 'Realpolitik',
      options: ['Weltpolitik (World Policy)', 'Mitteleuropa', 'Realpolitik', 'Pan-Slavism'],
      id: 'gw_q10',
    },
    {
    ...
    },
    {
      ...
      a: 'Morocco',
      options: ['South Africa', 'Morocco', 'Egypt', 'Sudan'],
      id: 'gw_q12',
    },
    {
    ...
    },
    {
      ...
      a: 'Gunboat Diplomacy',
      options: ['Gunboat Diplomacy', 'Risk Theory', 'Dollar Diplomacy', 'Appeasement'],
      id: 'gw_q14',
    },
    {
    ...
    },
    {
      q: 'What revolutionary British battleship was launched in 1906?',
      a: 'HMS Dreadnought',
      options: ['HMS Victory', 'HMS Invincible', 'HMS Dreadnought', 'HMS Iron Duke'],
      id: 'gw_q17',
    },
    {
    ...
    },
    {
      ...
      a: 'The Balkans',
      options: ['The Balkans', 'The Middle East', 'The Caucasus', 'The Rhineland'],
      id: 'gw_q21',
    },
    {
    ...
    },
    {
      ...
      a: 'Bosnia',
      options: ['Bosnia', 'Albania', 'Serbia', 'Romania'],
      id: 'gw_q25',
    },
    {
    ...
    },
    {
      ...
      a: 'Sarajevo',
      options: ['Sarajevo', 'Belgrade', 'Berlin', 'Vienna'],
      id: 'gw_q28',
    },
    {
      q: 'On what date was the Archduke assassinated?',
      a: 'June 28, 1914',
      options: ['July 23, 1914', 'November 11, 1918', 'June 28, 1914', 'August 4, 1914'],
      id: 'gw_q29',
    },
    {
      q: 'Who assassinated the Archduke?',
      a: 'Gavrilo Princip',
      options: ['Nedeljko Čabrinović', 'Leon Trotsky', 'Gavrilo Princip', 'Dragutin Dimitrijević'],
      id: 'gw_q30',
    },
    {
    ...
    },
    {
      ...
      options: ['Plan XVII', 'The Schlieffen Plan', 'The Risk Theory', 'The Bismarck Strategy'],
      id: 'gw_q36',
    },
    {
      q: 'Which neutral country did Germany invade to attack France?',
      a: 'Belgium',
      options: ['The Netherlands', 'Luxembourg', 'Belgium', 'Switzerland'],
      id: 'gw_q37',
    },
    {
      q: 'Which country declared war on Germany due to the invasion of Belgium?',
      a: 'Britain',
      options: ['Italy', 'The United States', 'Britain', 'Russia'],
      id: 'gw_q38',
    },
    {
    ...
    },
    {
      ...
      a: 'Preventative War',
      options: ['War of Attrition', 'Proxy War', 'Preventative War', 'Total War'],
      id: 'gw_q43',
    },
    {
    ...
    },
    {
      ...
      options: ['Richard Evans', 'Fritz Fischer', 'Ian Kershaw', 'Margaret MacMillan'],
      id: 'gw_q45',
    },
    {
      q: "What was the 'quarantine line' of new states created after WWI called?",
      a: 'Cordon Sanitaire',
      options: ['The Iron Curtain', 'Cordon Sanitaire', 'The Maginot Line', 'Mitteleuropa'],
      id: 'gw_q46',
    },
    {
      q: 'Name one new state created by the Treaty of Versailles.',
      a: 'Poland',
      options: ['Bulgaria', 'Romania', 'Poland', 'Serbia'],
      id: 'gw_q47',
    },
    {
    ...
    },
    {
      ...
      a: 'Soviet Communism',
      options: ['Soviet Communism', 'Imperialism', 'Anarchism', 'Fascism'],
      id: 'gw_q49',
    },
    {
      q: 'Which country did Germany invade on 3 August 1914?',
      a: 'Belgium',
      options: ['France', 'Serbia', 'Russia', 'Belgium'],
      id: 'gw_q50',
    },
  ],
  glossary: [
